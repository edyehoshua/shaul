...
sources:
  ...
  - "docs/scriptures/oe/json/genesis/18.json"
...
Génesis 18–22 presenta a Abraham como alguien que recibe una aparición, intercede ante el juicio y finalmente es probado en su obediencia. El título público de la clase de Eric, «Y fue visible», orienta hacia la aparición de Génesis 18; esta nota sigue el recorrido más amplio de Vayerá y no atribuye a la clase palabras que no pueden verificarse aquí. El texto sí permite afirmar que la visibilidad de יהוה no es curiosidad separada de la vida: conduce a hospitalidad, justicia, rescate, promesa y escucha.
...
En 18:2 aparecen **(אנשים)**, _anashim_, «hombres» en sentido normal. El relato no obliga a borrar la tensión entre la apariencia humana y la identificación divina del versículo anterior. Abraham responde con hospitalidad concreta: corre, se inclina, ofrece agua, descanso y alimento. La recepción de los visitantes no es una técnica para controlar la bendición; es la forma narrativa en que la promesa entra en una casa abierta.
...
Abraham permanece delante de יהוה y pregunta si el Juez de toda la tierra no hará justicia. Eric puede haber presentado esta escena desde el eje de la justicia divina —eso es lo que el título y la perícopa hacen razonable, no una cita comprobada—; el texto confirma que interceder no significa negar el juicio. Abraham apela al carácter del Juez, y יהוה escucha la reducción progresiva de la petición.
...
| ---------------- | ------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------- |
| Génesis 18:1–2   | El título público «Y fue visible» destaca la aparición.       | Apoyo textual: se explica _vayerá_ y se sigue la hospitalidad.                                           |
| Génesis 18:14–19 | El título de la fuente sitúa la clase en Vayerá y la promesa. | Inferencia calificada: se cotejan promesa, _pala_, justicia y juicio sin atribuir frases no verificadas. |
| Génesis 18:22–33 | La perícopa incluye la intercesión ante Sedom.                | Apoyo textual: la justicia se lee junto con la misericordia, no como cancelación del juicio.             |
| Génesis 22:1–19  | La clase cubre hasta 22:24.                                   | Pendiente de verificar la exposición oral; el texto se trata como prueba, escucha y visión de יהוה.      |
...
En 19:16 la misericordia se vuelve rescate: los mensajeros toman a Lot y a su familia de la mano «porque יהוה tuvo misericordia de él». **(חמל)**, _jamal_, significa compadecerse, apiadarse o perdonar; «aprobar» es una equivalencia **inexacta**. En 19:17, **(המלט)**, _himalet_, significa escapar o ponerse a salvo; «evitar toda dificultad» es **pedagógica e ilegítima**, porque el mandato responde a un juicio anunciado. En 19:19 Lot llama **(חסד)**, _jesed_, «misericordia, bondad leal o fidelidad activa». «Gracia» es **pedagógica**, no exhaustiva. Así, la justicia de Sedom y el rescate de Lot no se confunden: la misericordia sostiene al vulnerable sin declarar inocente a la ciudad.

Los capítulos 20–21 devuelven la promesa a la vida concreta. En 20:6 Elohim dice a Avimelej: «Yo también te detuve de pecar contra mí»; **(חטא)**, _jata_, significa errar o pecar, y aquí identifica una transgresión impedida antes de consumarse. En 21:1, יהוה «visitó» a Sarah. **(פקד)**, _paqad_, significa visitar, atender o intervenir; su fuerza contextual es actuar eficazmente conforme a la palabra, no simplemente pasar a ver. En 21:33 Abraham planta un tamarisco e invoca el Nombre. **(קרא)**, _qara_, significa llamar, proclamar o invocar; «controlar el resultado» es una equivalencia **inexacta**. La aparición conduce a promesa cumplida, memoria y culto, no a manipulación.

Finalmente, 22:1–19 lleva la respuesta hasta la prueba. «Elohim probó a Abraham» usa **(נסה)**, _nasah_, probar o poner a prueba; «tentar» es **aproximada**, porque puede sugerir seducción al mal. Abraham contesta **(הנני)**, _hineni_, «heme aquí»; es una fórmula de disponibilidad, no una definición automática de perfección. En 22:8 dice: «Elohim verá para sí el cordero», y en 22:14: **יהוה יראה**, _YHWH yireh_, «יהוה verá». **(ראה)**, _raah_, conserva primero el sentido de ver; «proveerá» es una equivalencia **contextual y pedagógica**, explicada por el carnero que aparece y por la mano detenida, no una sustitución léxica obligatoria. **(אחז)**, _ajaz_, agarrar, asir o quedar prendido, describe cómo el carnero está atrapado en el matorral. La escena detiene el sacrificio del hijo y reafirma la promesa; no autoriza una doctrina de sacrificio humano ni una fórmula de provisión automática.

El cierre de 22:18 dice que las naciones serán bendecidas «porque escuchaste mi voz». **(שמע)**, _shama_, significa oír, escuchar y obedecer; «entender» es **pedagógica e insuficiente**. El recorrido completo permite evaluar con precisión el foco público de Eric: יהוה se hace visible, Abraham recibe, hospeda, enseña justicia, intercede, escucha y obedece. Esa síntesis está apoyada por el orden de los capítulos; cualquier detalle adicional de la exposición permanece sin atribución específica mientras no haya transcripción verificable.

## Recorrido textual: aparición, intercesión y escucha

El capítulo no presenta la aparición como una escena aislada. En 18:1–8, Abraham ve a los visitantes, corre hacia ellos, se inclina y ordena preparar agua, pan, mantequilla y un becerro. **(נצב)**, _natsav_, significa estar de pie, mantenerse o presentarse; en la llegada de los visitantes su fuerza narrativa ayuda a percibir una presencia que se hace concreta ante Abraham, pero no convierte cada gesto de hospitalidad en una prueba automática de divinidad. La clase de Eric se acredita por el foco público «Y fue visible»; la evaluación textual conserva la tensión entre «יהוה se apareció» y «tres hombres».

La promesa a Sarah y la intercesión de Abraham están unidas por una misma pregunta: ¿qué puede hacer la palabra de יהוה y cómo actúa el Juez? **(צחק)**, _tsajaq_, significa reír; en 18:12–15 el contexto pasa de la risa de Sarah a la confrontación de su duda, mientras en 21:6 el mismo campo puede nombrar la alegría. «Incredulidad» es una equivalencia contextual posible, no el sentido único de la raíz. Después, **(ירד)**, _yarad_, significa descender; en 18:21 la forma describe la investigación narrativa sobre Sedom y no una limitación espacial de יהוה. La intercesión, por tanto, no corrige a Elohim: apela a que su juicio sea coherente con su justicia.

El centro ético aparece en 18:19 y se verifica en los capítulos siguientes. Abraham debe mandar a su casa guardar el camino de יהוה y hacer **(צדקה)**, _tsedaqah_, y **(משפט)**, _mishpat_. _Tsedaqah_ nombra justicia o rectitud relacional; _mishpat_ nombra juicio, decisión o administración del derecho. «Moralidad» puede resumirlos pedagógicamente, pero no reemplaza ninguno. El juicio de Sedom y el rescate de Lot mantienen esta distinción: la compasión de 19:16 no declara justa a la ciudad, y el **(חסד)**, _jesed_, de 19:19 es bondad leal o misericordia activa, no indulgencia sin discernimiento.

La prueba de Moriah lleva la escucha hasta una acción que el texto detiene y redefine. **(עקד)**, _aqad_, significa atar; en 22:9 describe que Abraham ata a Isaac sobre el altar, mientras el mandato posterior detiene la mano. «Sacrificio humano» sería una equivalencia inexacta para el desenlace del pasaje: la narración presenta la prueba, la obediencia y la sustitución por un carnero. En 22:14, **(ראה)**, _raah_, significa ver; «proveer» interpreta pedagógicamente el resultado contextual de que יהוה ve y aparece el carnero, pero no debe borrar el verbo hebreo. La promesa termina vinculada a «porque escuchaste mi voz»: **(שמע)**, _shama_, significa oír, escuchar y obedecer, y aquí su fuerza incluye respuesta practicada.
...
- Video: [Parashat Vayerá' - Parasháh "Y fue visible" Gn 18:1-22:24](https://www.youtube.com/watch?v=iw2v71qC7lk) (`source_id`: `youtube:iw2v71qC7lk`).
