---
title: "Tehilim 12: palabras dobles y el amparo de יהוה"
description: "Lectura ordenada de Tehilim 12 a partir de una enseñanza de Eric, contrastada con el texto hebreo local."
date: 2026-07-27
tags:
  - tehilim
  - tehilim_12
...
Tehilim 12 avanza desde la súplica por la desaparición de personas fieles hasta la respuesta de יהוה frente a una sociedad de palabras falsas y autosuficientes. La clase del hermano Eric propone leer ese conflicto como discernimiento contra discursos que aparentan fidelidad mientras vacían la obediencia; la nota conserva esa observación concreta, pero distingue la poesía del salmo de sus extensiones históricas, textuales y mesiánicas que requieren comprobación.

## Alcance de la nota

Esta nota organiza la enseñanza «Tehillim/Psalms/Psalm Ch. 12» en el orden de sus unidades textuales. No reproduce la transcripción automática como cita literal. El texto hebreo de la hoja procede del corpus OE local y ha sido normalizado para quitar sus barras de segmentación. Cuando Eric propone una variante del aparato crítico, una identificación histórica o una conexión con el Mesías, se registra como propuesta de la clase y no como resultado ya demostrado.
...
En el v. 2, la clase se detiene en **(הושיעה)**, *hoshia*, el imperativo «salva / da amparo», y lo presenta como refugio ante una catástrofe, no como una petición abstracta. El verso le da base a la urgencia de la oración: «se acabó el **(חסיד)**, *hasid*» y «han desaparecido los **(אמונים)**, *emunim*, de entre los seres humanos». *Hasid* nombra al fiel o leal; *emunim* se relaciona con firmeza y fidelidad. La equivalencia de *emunim* con «personas portadoras de emunah» es una explicación pedagógica aproximada, no una definición exclusiva del término.
...
La clase propone que *halaqot* no es mera lisonja: lo relaciona con una «atenuación» de las demandas de la Torah y menciona un uso de Qumrán aplicado a fariseos. Como lectura pastoral, alerta contra normas humanas que desplazan la obediencia y también contra un «amor» usado para invalidar mandamientos. Sin embargo, la identificación qumránica, su forma exacta y la conclusión sobre fariseos o judaísmo rabínico son afirmaciones históricas y léxicas que no se verificaron aquí. El sentido contextual seguro es que el salmo condena habla suave, engañosa y presuntuosa.
...
Eric además discute una lectura alternativa para la última frase del v. 6 y la relaciona con una manifestación «por medio de él». El texto OE local impreso dice **(יפיח לו)**, *yafiach lo*. No se adopta una enmienda textual en esta nota sin citar y revisar los testigos y el aparato crítico correspondientes.
...
El v. 9 no elimina la tensión: los malvados siguen rondando cuando lo vil es exaltado. Eric lo enlaza con 1 Pedro 5 y 2 Corintios 11 para advertir contra voces que extravían mediante apariencia de luz. Es una aplicación de discernimiento coherente con el contraste verbal del salmo, aunque los textos apostólicos no se citan como si fueran la explicación histórica original de Tehilim 12.

## Hoja léxica

| Término | Transliteración | Sentido en la nota | Correspondencia y cautela |
| --- | --- | --- | --- |
| **(הושיעה)** | hoshia | salva, da socorro | Imperativo hebreo; «amparo» es una aplicación contextual aproximada. |
| **(חסיד)** | hasid | fiel, leal | Describe al que es objeto de la queja del v. 2; no prueba por sí mismo una categoría escatológica. |
| **(אמונים)** | emunim | fieles, firmes | Relacionado con fidelidad; «portadores de emunah» es pedagogía, no equivalencia exacta. |
| **(חלקות)** | halaqot | lisuras, halagos | La conexión con una relajación de la Torah y Qumrán requiere verificación externa. |
| **(בלב ולב)** | belev valev | con corazón y corazón | Expresión hebrea que comunica doblez; «doble intención» es una traducción aproximada. |
| **(אמרות)** | imrot | dichos, palabras | En el v. 7 son las palabras puras de יהוה; no equivale automáticamente a una persona. |
...
- [ ] Documentar con referencias primarias el uso de **(חלקות)** o expresión afín en Qumrán y su supuesta aplicación a fariseos.
- [ ] Revisar el aparato crítico, la Septuaginta y las versiones siríacas citadas por Eric para Tehilim 12:6 y 12:8 antes de adoptar variantes.
- [ ] Verificar la propuesta de que el encabezado **(השמינית)** remite al «día octavo» en este salmo.
- [ ] Cotejar las afirmaciones sobre Roma, el sumo sacerdocio y el período previo a Yehoshua con fuentes históricas independientes.
- [ ] Evaluar separadamente las conexiones de Tehilim 12 con Yeshayahu 60, Tehilim 102, Mattityahu 1:21, 1 Pedro 5 y 2 Corintios 11.

## Conclusión

La secuencia del salmo no permite separar la piedad de las palabras: la escasez de fidelidad aparece en el habla engañosa, la presunción recibe respuesta divina y las palabras puras de יהוה dan el contraste. La enseñanza de Eric aporta una advertencia concreta contra la doblez vestida de piedad; la lectura responsable conserva esa advertencia sin convertir sus asociaciones históricas, textuales o mesiánicas en conclusiones sin cotejo.
...
- Video: [Tehillim/Psalms/Psalm Ch. 12](https://www.youtube.com/watch?v=MYDQJFr4uRA) (`source_id`: `youtube:MYDQJFr4uRA`).
