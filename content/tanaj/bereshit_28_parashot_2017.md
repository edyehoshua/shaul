---
title: "Bereshit 28: Promesa, presencia y respuesta de Jacob"
description: "Nota canónica de Bereshit 28, organizada a partir de una clase de la serie Parashot 2016-2017."
date: 2026-07-27
tags:
  - parashot
  - bereshit
...
Bereshit 28 abre un tramo que sitúa la vida del pueblo delante de יהוה. La clase de la serie _Parashot 2016-2017_ ofrece una lectura temática del pasaje; esta nota conserva como ancla el texto bíblico y distingue sus aplicaciones del sentido explícito del capítulo.

## Alcance de la nota

Esta es la nota canónica para Bereshit 28 dentro de esta incorporación. La transcripción automática de la clase se usa para identificar su tema y su pasaje de partida, no como cita literal verificable. El título de la sesión —«Parashat Vayétze' (2016) Hama'aser: What is tithing and how does it work?»— orienta la selección temática, pero las afirmaciones doctrinales, históricas o léxicas que excedan el texto requieren cotejo adicional.

## Hoja de comparación

| Referencia     | Hebreo local (OE, sin nikud)                                           | Observación                                                                                           |
| -------------- | ---------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------- |
| #genesis_28_1 | **ויקרא יצחק אל יעקב ויברך אתו ויצוהו ויאמר לו לא תקח אשה מבנות כנען** | Versículo de apertura del capítulo; debe leerse en su unidad literaria antes de derivar aplicaciones. |

## Lectura inicial

El comienzo de Bereshit 28 establece el marco inmediato de la sección. La clase vincula este tramo con «promesa, presencia y respuesta de jacob»; esa relación puede servir como guía de lectura, siempre que no sustituya el desarrollo concreto del texto ni convierta una formulación de la exposición en una cita bíblica.
...
## Recorrido textual: salir, encontrar y responder

La fuente pública `youtube:X0hILB8r8N8` se titula «Parashat Vayetzé' - “y salió” Gn 28:10 - 32:3 - La Escalera». La fuente anterior de la nota trata el diezmo; esta incorporación conserva ambos énfasis porque el capítulo mismo une la salida de Yaakov, la visión, el voto y la posterior marcha. El título «La Escalera» es una guía temática visible, no una cita literal de la exposición.

El movimiento comienza en #genesis_28_10: «Y salió Yaakov de Beersheva, y fue a Jarán». **(יצא)**, _yatsa_, es la forma verbal que significa salir o partir; aquí marca una salida geográfica concreta bajo la tensión de la bendición recibida y el conflicto familiar. **(הלך)**, _halaj_, significa ir o caminar; no equivale por sí solo a «peregrinar espiritualmente», aunque el contexto permite observar que el viaje se convierte en una experiencia de promesa.

En #genesis_28_12, el OE describe «una escalera colocada en la tierra, y su parte superior llegaba al cielo; y los ángeles de Elohim subían y bajaban por ella». El TTH conserva «escalera» y los movimientos de ascenso y descenso. **(סלם)**, _sulam_, es el sustantivo «escalera»; su forma no obliga a convertir la visión en un diagrama de técnicas para alcanzar el cielo. **(מלאך)**, _malaj_, significa mensajero; «ángel» es una equivalencia tradicional, mientras «mensajero» hace visible su función normal. **(עלה)**, _alah_, subir, y **(ירד)**, _yarad_, bajar, describen el tránsito de los mensajeros en la visión. La iniciativa narrativa no es que Yaakov construya el acceso: el cielo se muestra sobre el lugar donde él duerme.

La promesa de #genesis_28_13-15 interpreta la visión. יהוה se identifica como el Elohim de Abraham e Yitzjak, promete la tierra, descendencia y acompañamiento: «He aquí, Yo estoy contigo, y te guardaré dondequiera que vayas». **(שמר)**, _shamar_, significa guardar, custodiar u observar; en este contexto expresa protección durante el desplazamiento, no una garantía de que el camino será cómodo. **(עזב)**, _azav_, dejar o abandonar, aparece en la negación «no te abandonaré»; «no te fallaré» es una equivalencia interpretativa adecuada, pero no el sentido único del verbo.

Cuando despierta, Yaakov dice: «Verdaderamente la existencia de יהוה está en este lugar y yo no lo sabía» (#genesis_28_16). **(ידע)**, _yada_, conocer o reconocer, tiene aquí fuerza de percepción consciente: la presencia no empieza cuando Yaakov la descubre; cambia su comprensión del lugar. En 28:17 afirma: «¡Cuán impresionante es este lugar! ¡No es esto sino la casa de Elohim, y esta es la puerta del cielo!». **(ירא)**, _yare_, puede significar temer o reverenciar; en esta escena «temor reverente» es más exacto que pánico. **(נורא)**, _nora_, impresionante o temible, califica el lugar por la experiencia de la presencia.

Yaakov levanta la piedra como pilar y vierte aceite (#genesis_28_18). Luego hace un voto: «Si está Elohim conmigo y me guarda... y me da un pan para comer y ropa para vestir» (#genesis_28_20). **(נדר)**, _nadar_, significa hacer un voto; «negociar» es una lectura popular, no exacta. El «si» introduce la forma verbal de su compromiso desde su situación vulnerable, pero el relato no autoriza a reducir la promesa divina a una transacción comercial. En 28:21–22, Yaakov habla de volver «en shalom» y de dar una décima parte. **(שלום)**, _shalom_, significa integridad, bienestar o paz; aquí señala retorno seguro y relación ordenada, no solo ausencia de guerra. **(עשר)**, _asar_, significa diezmar o dar una décima parte; su equivalencia es exacta en ese acto, pero el capítulo no presenta todavía un reglamento general para toda práctica posterior del diezmo.

### La continuidad de la promesa en el camino

El orden de los versículos importa. Primero Yitzjak bendice y envía a Yaakov (#genesis_28_1-5); después Yaakov sale (#genesis_28_10), duerme con una piedra y recibe la palabra divina. La visión no cancela la vulnerabilidad del viaje. **(מקום)**, _maqom_, es «lugar» o «sitio»; la repetición de «aquel lugar» en 28:11 y la declaración «este lugar» en 28:16 hacen que la experiencia tenga un anclaje concreto. «Santuario permanente» sería pedagógico, no exacto: Yaakov todavía está de paso.

La palabra de יהוה reúne tres promesas: tierra y descendencia (#genesis_28_13-14), presencia y custodia (#genesis_28_15), y retorno. **(זרע)**, _zera_, significa semilla o descendencia; en este contexto apunta a una posteridad numerosa y no solamente a una metáfora interior. **(גוי)**, _goy_, significa nación o pueblo; la promesa de que se bendecirán las familias de la tierra conserva un horizonte comunitario. La lectura de Eric sobre un camino acompañado concuerda con la secuencia, mientras que afirmar que cada dificultad demuestra una protección visible sería una aplicación aproximada, no una equivalencia del texto.
...
| Unidad textual     | Observación visible de las fuentes públicas                          | Evaluación desde el capítulo                                                                |
| ------------------ | -------------------------------------------------------------------- | ------------------------------------------------------------------------------------------- |
| #genesis_28_10-15 | «Y salió» y la escalera orientan la lectura de un camino acompañado. | El relato une partida, visión y promesa de presencia.                                       |
| #genesis_28_16-17 | El lugar se reconoce como casa de Elohim y puerta del cielo.         | La revelación transforma la percepción de Yaakov, no una técnica humana de ascenso.         |
| #genesis_28_18-22 | El tema del diezmo aparece dentro de un voto.                        | La nota conserva el acto sin convertirlo en un reglamento universal desligado del contexto. |

## Léxico ampliado

| Forma      | Transliteración | Sentido normal     | Fuerza contextual                               | Equivalencia             |
| ---------- | --------------- | ------------------ | ----------------------------------------------- | ------------------------ |
| **(יצא)**  | _yatsa_         | salir, partir      | Salida concreta de Beersheva                    | «Emigrar» es pedagógica  |
| **(סלם)**  | _sulam_         | escalera           | Imagen de conexión visible entre tierra y cielo | «Puente» es inexacta     |
| **(מלאך)** | _malaj_         | mensajero          | Agente que sube y baja en la visión             | «Ángel» es tradicional   |
| **(שמר)**  | _shamar_        | guardar, custodiar | Promesa de cuidado durante el camino            | «Controlar» es inexacta  |
| **(נדר)**  | _nadar_         | hacer un voto      | Compromiso pronunciado por Yaakov               | «Negociar» es pedagógica |
| **(עשר)**  | _asar_          | diezmar            | Dar la décima parte en el voto                  | «Impuesto» es inexacta   |
...
Bereshit 28 llama a atender el texto en su propio marco. La sesión aporta una vía temática para su estudio; esta nota mantiene esa vía bajo la autoridad del pasaje y deja las inferencias amplias abiertas a verificación.

## La promesa no elimina el camino concreto

La exposición de Eric sobre un camino acompañado queda mejor delimitada al observar la repetición de **בדרך הזה אשר אנכי הולך**, _baderekh hazeh asher anokhi holekh_, «en este camino que yo voy» (#genesis_28_20). **(דרך)**, _derekh_, significa camino, vía o conducta; aquí nombra primero la ruta real de Yaakov. **(הלך)**, _halakh_, significa ir o caminar; su fuerza contextual es la marcha hacia Jarán, no una ascensión interior producida por la escalera. «Proceso espiritual» es una equivalencia pedagógica, no exacta. El texto permite una aplicación al discipulado solo después de reconocer la vulnerabilidad, el alimento, el vestido y el regreso que el voto enumera.

El OE y el TTH también mantienen el orden de la iniciativa: «Yo estoy contigo, y te guardaré dondequiera que vayas, y te haré volver» (#genesis_28_15), y solo después: «si Elohim está conmigo» (#genesis_28_20). **(נתן)**, _natan_, significa dar o poner; en **ונתן לי לחם**, _venatan li lejem_, introduce la petición de pan que Yaakov espera recibir. La forma no significa «financiar una visión»; su fuerza contextual es provisión concreta para el viajero. La lectura de Eric sobre el diezmo como respuesta tiene apoyo en **עשר אעשרנו**, _aser asrenu_, «diezmar diezmaré», pero «diezmo como precio de la presencia» sería una equivalencia inexacta, porque la presencia ya fue prometida.

Delitzsch retoma el motivo de acceso en Yohanan 1:51: «verán los cielos abiertos y los mensajeros de Elohim subiendo y bajando sobre el Hijo del Hombre». La relación es canónica y aproximada. **(פתח)**, _pataj_, significa abrir; en la frase de Yohanan nombra la apertura de los cielos, no el sentido normal de **(סלם)**, _sulam_, «escalera». La conexión puede mostrar cómo la tradición apostólica relee la visión, pero no borra que en Bereshit 28 Yaakov recibe una promesa de tierra, descendencia, custodia y retorno. La escalera es imagen recibida; el voto es respuesta situada.

## «Y salió»: vulnerabilidad antes de la visión

La fuente de Eric insiste en que el título de la parashá nace de **ויצא**, _vayetse_, «y salió» (#genesis_28_10), y describe la salida como traumática después de la amenaza de Esav. El capítulo 27:41–28:5 aporta ese contexto: Yaakov huye, pero también recibe de Yitzjak la orden y la bendición de no tomar mujer de las hijas de Kenaan. «Salida traumática» es una síntesis **interpretativa**, no una traducción de _vayetse_; el verbo mismo significa salir o partir. Aun así, la lectura de Eric ayuda a no convertir la escalera en una escena abstracta: el soñador está en tránsito, duerme con una piedra y necesita la palabra de protección.

El OE conserva **ויפגע במקום**, _vayifga ba-maqom_, «llegó o encontró un lugar», y **וישם מראשתיו**, _vayasem meraashotav_, «la puso por sus cabeceras» (#genesis_28_11). **פגע**, _paga_, puede significar encontrar, alcanzar o encontrarse; aquí su fuerza narrativa es la llegada al sitio donde ocurre el sueño. **מקום**, _maqom_, significa lugar o sitio; «punto de conexión espiritual» es una equivalencia **pedagógica**, no el sentido léxico. La piedra no construye una ruta al cielo: el texto presenta primero una visión recibida y después una interpretación reverente de Yaakov.

Eric relaciona la escalera con el camino posterior y con la presencia constante de יהוה. La observación recibe apoyo en la promesa: **והנה אנכי עמך**, _vehine anokhi imkha_, «he aquí, yo estoy contigo», seguida de **ושמרתיך**, _ushmartikha_, «te guardaré», y **והשבתיך**, _vahashivotikha_, «te haré volver» (#genesis_28_15). **שמר**, _shamar_, normalmente guardar, custodiar u observar, expresa protección; **שוב**, _shuv_, volver o hacer volver, orienta la promesa hacia el regreso. «Prosperidad automática» sería una inferencia inexacta: la compañía prometida no elimina el trabajo, el engaño de Labán ni los conflictos que narran los capítulos siguientes.

La lectura de Eric sobre el diezmo también necesita el orden del pasaje. Yaakov no ofrece la décima parte antes de oír la promesa: formula su voto después de despertar, reconocer el temor del lugar y recordar la palabra recibida. **וידר**, _vayidor_, es la forma narrativa de נדר, «hacer un voto»; **עשר אעשרנו**, _aser asrenu_, repite la raíz de diezmar y refuerza el compromiso. «Pagar para activar la presencia» no es equivalente al texto. El capítulo permite hablar de una respuesta agradecida y responsable, pero la promesa de presencia precede al voto y tiene la iniciativa de יהוה.

## Precisiones finales sobre presencia y voto

El OE conserva la palabra de יהוה: «Y he aquí, Yo estoy contigo, y te guardaré en todo lo que vayas, y te volveré a esta tierra» (#genesis_28_15); el TTH traduce «dondequiera que vayas» y «te haré volver». **(הלך)**, _halaj_, significa ir o caminar; en esta promesa su fuerza contextual abarca el trayecto real de Yaakov, no una promesa de avance sin conflicto. **(שוב)**, _shuv_, significa volver o hacer volver; aquí señala el regreso prometido como parte del cuidado divino. La observación de Eric sobre un camino acompañado está, por tanto, bien apoyada, mientras que convertir «acompañamiento» en prosperidad automática excedería el pasaje.

La respuesta de Yaakov debe mantenerse en su propio orden. El OE dice: «Y Jacob hizo un voto, diciendo: Si Elohim está conmigo, y me guarda en este camino que yo voy» (#genesis_28_20); el TTH conserva la condición y el lenguaje de custodia. **(נדר)**, _nadar_, significa hacer un voto; su fuerza contextual es una promesa pronunciada por el viajero vulnerable. **(דרך)**, _derej_, significa camino, vía o conducta; aquí designa primero la ruta que Yaakov recorre, aunque su sentido puede abrir una aplicación moral posterior. La clase puede leer el diezmo como respuesta agradecida, pero el «si» no convierte la presencia de יהוה en una mercancía: la compañía fue prometida antes, en 28:15.

El cierre dice: «Y esta piedra que he puesto por columna será casa de Elohim; y de todo lo que me des, diezmar diezmaré para Ti» (#genesis_28_22). **(מצבה)**, _matsevah_, significa columna o estela; aquí funciona como señal memorial del encuentro. **(עשר)**, _asar_, significa diezmar o entregar una décima parte; la repetición refuerza el compromiso de Yaakov, pero no transforma automáticamente su voto en una legislación completa. Así se conserva la observación central de Eric y se evalúa con precisión: el diezmo es respuesta dentro de una escena de promesa, viaje y retorno, no el precio de una escalera ni de la presencia divina.

## Cierre textual: presencia que precede a la respuesta

La comparación local permite precisar el movimiento final. OE registra **והנה אנכי עמך ושמרתיך בכל אשר תלך** («he aquí, Yo estoy contigo y te guardaré en todo lo que vayas») en #genesis_28_15, mientras TTH traduce: «Y he aquí, Yo estoy contigo, y te guardaré dondequiera que vayas». La diferencia de formulación no cambia el argumento: la presencia y la custodia son promesa de יהוה antes de que Yaakov formule su voto. **עמך**, _imkha_, combina la preposición «con» y el sufijo «contigo»; su fuerza contextual es compañía relacional, no una garantía abstracta de prosperidad.

En #genesis_28_20-22, OE dice **וידר יעקב נדר לאמר אם יהיה אלהים עמדי** («Y Yaakov hizo un voto diciendo: si Elohim está conmigo») y TTH conserva: «Y Yaakov hizo un voto, diciendo: Si Elohim está conmigo». **וידר**, _vayidor_, es una forma de נדר, «hacer un voto»; aquí introduce una respuesta verbal concreta. La palabra **ונתן לי לחם לאכל ובגד ללבש**, _venatan li lejem leejol uveged lilbosh_, pide alimento y vestido; la equivalencia «necesidades básicas» es pedagógica pero fiel al alcance inmediato. Eric acentúa el diezmo como respuesta de Yaakov; el texto lo apoya como cláusula final del voto, pero el orden impide presentarlo como precio que compra la presencia ya prometida.
