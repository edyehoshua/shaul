---
title: "Majar jódesh: bien, verdad y justicia en la amistad de David y Yehonatán"
description: "Estudio de 1 Shemuel 20:18-42 sobre la señal de las flechas, la verdad ante el poder y el pacto de amistad, a partir de la enseñanza de Eric de Jesús Rodríguez Mendoza."
date: 2026-07-28
tags:
  - haftarah
  - majar-jodesh
...
En 1 Shemuel 20:18-42, la amistad entre David y Yehonatán no es una sentimentalidad que ignore el peligro. Se prueba mediante una señal pública, una palabra verdadera y una decisión costosa frente a Shaúl. La enseñanza del hermano Eric de Jesús Rodríguez Mendoza lee esta haftaráh de _Majar jódesh_ como una formación de carácter: el bien no puede separarse de la verdad, y la justicia no puede construirse sobre verdades a medias. El relato termina con distancia física, pero también con un pacto puesto delante de יהוה y de las generaciones.

## Alcance de la nota

Esta nota sigue el perícopa en el orden de 1 Shemuel 20:18-42. Organiza las observaciones atribuibles a Eric y las contrasta con el texto hebreo OE local. La transcripción automática contiene errores de reconocimiento; no se presenta como cita literal. Las aplicaciones sobre procesos de reparación, divisiones religiosas o conflictos contemporáneos se conservan como extensión pastoral de la clase, no como el significado único del capítulo.
...
La respuesta de Shaúl no busca aclarar un hecho: insulta a su propio hijo y presenta a David como una amenaza para el reino. El argumento es posesivo: mientras viva el hijo de Ishai, “no se afirmará tu reino”. Eric subraya que la autoridad puede llamar “vergüenza” a la defensa del inocente cuando su propia seguridad está amenazada. Sin embargo, Yehonatán no acepta la acusación sin examen. Pregunta: “¿Por qué ha de morir? ¿Qué ha hecho?”. Esa pregunta breve es el centro judicial de la escena. Antes de castigar, hay que identificar la acción y demostrar la culpa.
...
Yehonatán dice “ve en paz” y recuerda el juramento hecho en el nombre de יהוה. La paz aquí no significa que el conflicto ya terminó, sino que el amigo puede caminar bajo una palabra firme. El pacto incluye a sus descendientes: יהוה queda como testigo entre ellos y entre su simiente. Así, el bien que Eric identifica no es mera amabilidad; es una lealtad que busca la vida, resiste la mentira del poder y confía el futuro a יהוה.

## Hoja léxica

| Forma      | Transliteración | Sentido en la nota         | Tratamiento                                                                                                           |
| ---------- | --------------- | -------------------------- | --------------------------------------------------------------------------------------------------------------------- |
| **(חדש)**  | _jódesh_        | luna nueva, inicio de mes  | Correspondencia contextual; _Majar jódesh_ es una designación litúrgica, no una traducción de todo el pasaje.         |
| **(חץ)**   | _jéts_          | flecha                     | Símbolo narrativo de una señal acordada; no se convierte en código universal fuera del relato.                        |
| **(שלום)** | _shalom_        | paz, bienestar, integridad | Aproximación contextual: “ve en paz” incluye despedida segura, no afirma ausencia inmediata de conflicto.             |
| **(רעה)**  | _raá_           | mal, daño                  | El contraste entre bien y mal se observa en la intención de proteger o matar; no se reduce a una emoción.             |
| **(אמת)**  | _emet_          | verdad, firmeza            | La clase usa “verdad” como condición de justicia; la equivalencia es temática y debe probarse en los hechos narrados. |
...
- [ ] Cotejar la designación litúrgica exacta de _Majar jódesh_ y su uso en las distintas costumbres de lectura.
- [ ] Revisar con un léxico hebreo el matiz de **(אמת)** en 1 Shemuel 20 y en los pasajes de pacto relacionados.
- [ ] Localizar las referencias exactas de las alusiones de la clase a procesos contemporáneos de justicia y reparación; no se presentan como fuentes históricas.

## Conclusión

1 Shemuel 20 muestra una amistad que no se desentiende de la verdad. Yehonatán establece una señal, escucha la acusación, pide evidencia y actúa cuando Shaúl confirma su intención homicida. David, por su parte, recibe la advertencia y acepta que la fidelidad puede requerir distancia. La enseñanza de Eric conserva una lección precisa: no hay justicia donde la verdad se oculta, y el bien no consiste en mantener la apariencia de paz, sino en proteger la vida y caminar bajo la presencia de יהוה.
...
- [[yeshayahu_11_raiz_gobierno_reunion_y_descanso|Ieshaiáhu 11: raíz, gobierno y reunión]]

## Créditos

- Expositor: **hermano Eric de Jesús Rodríguez Mendoza**.
- Video: [Haftaráh Majar jódesh 1 Sm. 20:18-42: El bien, la verdad y la justicia](https://www.youtube.com/watch?v=ylAeMhup8o0) (`source_id`: `youtube:ylAeMhup8o0`).
