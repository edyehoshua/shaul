---
title: "Ieshaiáhu 11: la raíz de Ishai, el gobierno justo y la reunión del remanente"
description: "Estudio de la haftaráh de Se'udat Mashíaj sobre el brote de Ishai, el Rúaj, el juicio justo, la paz, la reunión de Israel y el cántico de salvación."
date: 2026-07-28
tags:
  - haftarah
  - yeshayahu
...
La exposición de Eric lee Ieshaiáhu 11 como una profecía mesiánica en la que la caída de los poderes altivos prepara la aparición de un brote desde la raíz de Ishai. El gobernante no se reconoce por una etiqueta aislada, sino por el Rúaj de יהוה que descansa sobre él, por su justicia hacia los débiles y por la reunión que realiza entre los dispersos. La clase relaciona ese estandarte para las naciones con la palabra de Yehoshua: “os atraeré a mí mismo”. Esta nota conserva la conexión como lectura canónica y pedagógica, sin presentarla como si Ieshaiáhu citara literalmente a Yojanan.

## Alcance de la nota

La nota organiza **HAFTARÁH DE SE'UDAT MASHÍAJ 2018: Os atraeré a mí mismo**. La transcripción automática tiene errores de nombres, términos hebreos y referencias; por eso se reconstruye el argumento desde el pasaje local y se atribuyen a Eric las observaciones que la clase desarrolla. El tratamiento sigue Ieshaiáhu 11:1–16 y responde con el cántico de 12:1–6. Las afirmaciones sobre tradición litúrgica y las propuestas filológicas más específicas quedan diferenciadas de lo que el texto permite afirmar directamente.

## Hoja de comparación

| Referencia          | Texto TTH local                                                                                                                                                                                                                        | Función en la enseñanza                                                      |
| ------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------- |
| #ieshaiahu_11_1-2   | “Y saldrá una rama del tronco de Ishai, y un brote de sus raíces dará fruto. Y descansará sobre Él el Rúaj de יהוה, espíritu de sabiduría y discernimiento, espíritu de consejo y poder, espíritu de conocimiento y de temor de יהוה.” | El brote mesiánico conserva la raíz davídica y recibe el Rúaj para gobernar. |
| #ieshaiahu_11_3-5   | “No hará el proceso legal por la vista de sus ojos… hará el proceso legal en justicia a los débiles… la justicia será el cinto de sus caderas, y la emunah el cinto de su cintura.”                                                    | El gobierno se mide por justicia y fidelidad, no por apariencia.             |
| #ieshaiahu_11_6-10  | “No harán maldad y no destruirán… porque llena estará la tierra del conocimiento a יהוה… la raíz de Ishai… será su descanso gloria.”                                                                                                   | La paz se vincula con el conocimiento de יהוה y con el descanso glorioso.    |
...
La clase conecta _nétsér_ con Nazaret y con las expresiones griegas que el evangelio distingue al hablar del habitante de la ciudad y del título relacionado con el retoño. Eric vuelve varias veces sobre esa distinción y reconoce que la traducción castellana suele ocultarla. La observación es relevante como pista intertextual, pero no debe presentarse como una prueba filológica cerrada: la relación entre Ieshaiáhu 11:1, el nombre de la localidad y el uso de Mateo requiere cotejar las formas hebreas, arameas y griegas en sus contextos.
...
| -------------- | --------------- | -------------------------------------- | ----------------------------------------------------------------------------------------------- |
| **(חטר)**      | _jéter_         | rama o vara                            | Correspondencia contextual con la imagen del tronco.                                            |
| **(נצר)**      | _nétsér_        | brote o retoño                         | Correspondencia exacta en Ieshaiáhu 11:1; vínculo con Nazaret, inferencia filológica pendiente. |
| **(רוח יהוה)** | _Rúaj יהוה_     | presencia y capacidad recibida de יהוה | El texto enumera sus efectos; no se reduce a una sola traducción de “espíritu”.                 |
| **(צדק)**      | _tsédeq_        | justicia, rectitud                     | Describe el criterio y el cinturón del gobernante.                                              |
| **(אמונה)**    | _emunah_        | fidelidad, firmeza                     | Aproximación contextual; no equivale automáticamente a “fe” en sentido moderno.                 |
| **(מנוחה)**    | _menújah_       | descanso, reposo                       | En 11:10 aparece calificado por gloria; la conexión con otros reposos es pedagógica.            |
| **(נס)**       | _nes_           | estandarte o señal levantada           | En 11:10 y 11:12 concentra la búsqueda de las naciones y la reunión del remanente.              |

## Mapa de la enseñanza de Eric

| Unidad textual      | Observación concreta de la clase                                                                                          | Tratamiento en esta nota                                                                                           |
| ------------------- | ------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------ |
| #ieshaiahu_11_1     | El tronco puede ser cortado, pero de la raíz de Ishai brotan dos imágenes de retoño; Eric relaciona _nétsér_ con Nazaret. | Texto local y hoja léxica; vínculo con Nazaret marcado como inferencia pendiente, no como equivalencia automática. |
| #ieshaiahu_11_2-5   | El Mashíaj recibe el Rúaj, juzga sin depender de apariencia y lleva justicia y fidelidad como cinturones.                 | Apoyo textual y aclaración léxica de Rúaj, _tsédeq_ y _emunah_.                                                    |
| #ieshaiahu_11_6-10  | La paz universal nace del conocimiento de יהוה; el estandarte atrae a las naciones y su descanso es gloria.               | Desarrollo ordenado del pasaje; conexión con Yojanan 12:32 tratada como lectura canónica/pedagógica.               |
| #ieshaiahu_11_11-16 | El estandarte reúne a los dispersos, separa “desnaturalizados” y dispersos, y sana la rivalidad entre Efráim y Yehudáh.   | Apoyo textual; la imagen del injerto se conserva como aplicación atribuida y calificada.                           |
| #ieshaiahu_12_1-6   | La reunión desemboca en confianza, aguas de salvación, canto y anuncio público de las obras de יהוה.                      | Síntesis textual del cántico y tratamiento de la aplicación mesiánica sin reemplazar el sentido del capítulo.      |

## Pendiente de verificar

- [ ] Cotejar las formas hebreas, arameas y griegas que sostienen la relación entre _nétsér_, Nazaret y los gentilicios del evangelio.
- [ ] Verificar la referencia exacta al targum que la clase recuerda al traducir la rama de Ishai como rey o Mesías.
- [ ] Revisar el trasfondo histórico y litúrgico de Se'udat Mashíaj y de la lectura de Ieshaiáhu 11.
- [ ] Cotejar en fuentes judías e históricas la terminología de “desnaturalizados” y “dispersos” en 11:12 antes de convertir la distinción de la clase en una categoría técnica.

## Conexiones principales

- [[yeshayahu_10_12_mashiaj_descanso|Ieshaiáhu 10–12: el Mashíaj, el remanente y el descanso glorioso]]: estudio complementario de la misma haftaráh y de su secuencia completa.
...
Ieshaiáhu 11 presenta una esperanza concreta: después de la caída de los poderes altivos, יהוה hace brotar desde Ishai un gobernante sobre quien descansa su Rúaj. Su justicia alcanza a los débiles, su palabra enfrenta el mal, su gobierno llena la tierra de conocimiento y su estandarte reúne a Israel, Yehudáh y las naciones. La clase de Eric lee ese estandarte junto con el Mesías levantado que atrae hacia sí; la nota conserva esa línea como conexión apostólica y pedagógica. El cántico de Ieshaiáhu 12 muestra el resultado: confianza sin temor, aguas de salvación, anuncio público y gozo porque el Santo de Israel está en medio de su pueblo.

## Créditos

- Expositor: **hermano Eric de Jesús Rodríguez Mendoza**.
- Video: [HAFTARÁH DE SE'UDAT MASHÍAJ 2018: Os atraeré a mí mismo](https://www.youtube.com/watch?v=Kiq69SwJqEE) (`source_id`: `youtube:Kiq69SwJqEE`).
