---
title: "Bereshit 25–28: Toldot, promesa, elección y bendición"
description: "Lectura canónica de Toldot: la promesa recibida por Rivqah, el conflicto entre Yaakov y Esav y la bendición que no debe quedar nublada por intereses humanos."
date: 2026-07-28
tags:
  - bereshit
  - toldot
...
sources:
  ...
  - "docs/scriptures/oe/json/genesis/26.json"
  - "docs/scriptures/oe/json/genesis/27.json"
...
Toldot sigue la promesa a través de una familia dividida. Rivqah consulta a יהוה cuando los hijos se agitan en su vientre; la respuesta anuncia que el mayor servirá al menor. Después, el apetito de Esav, la preferencia de Yitsjaq y Rivqah, la venta de la primogenitura y la bendición disputada muestran cómo los afectos y los intereses pueden oscurecer una palabra recibida. Eric conserva ese eje: la elección divina no debe ser reemplazada por apariencia, ventaja o transacción humana.

## Alcance de la nota

Se recorre el bloque de Bereshit 25:19–28:9 en orden. La exposición de Eric comenta _toldot_, el movimiento de los hijos en el vientre, el sentido de «mayor» y «servir», el favoritismo familiar y el intento de Yitsjaq de bendecir conforme a su propio juicio. Se preservan esas observaciones y se evalúan ante OE y TTH. Las lecturas apostólicas de Romanos 9 se citan como conexión canónica posterior, no como sustitución del relato de Bereshit.
...
El texto no dice que Rivqah inventara la elección. Ella recibe la palabra antes del nacimiento, mientras que las características físicas y los gustos llegan después. Por eso la observación de Eric sobre no dejar que el afecto humano gobierne la determinación divina encuentra apoyo en la secuencia, aunque el relato también muestra decisiones ambiguas de todos los miembros de la familia.
...
| ------------ | --------------- | ---------------------------------------------- | -------------------------------------------------- | ------------------------------------------------------ |
| **(תולדות)** | _toldot_        | Plural: generaciones, descendencia, resultados | Encabeza la historia de la casa de Yitsjaq         | «Nacimientos» es pedagógica; «generaciones» aproximada |
| **(דרש)**    | _darash_        | Buscar, investigar, consultar                  | Rivqah consulta a יהוה por su embarazo             | «Preguntar» es aproximada                              |
| **(רב)**     | _rav_           | Grande, abundante, numeroso                    | Designa al mayor/grande frente al menor            | «Abundante» es pedagógica                              |
| **(עבד)**    | _avad_          | Trabajar, servir                               | Anuncia la subordinación futura del mayor al menor | «Trabajar para» es aproximada                          |
| **(תם)**     | _tam_           | Completo, íntegro, sencillo                    | Describe a Yaakov como habitante de tiendas        | «Quieto» es contextual                                 |
...
## La bendición también se prueba en la tierra: Gerar, pozos y contienda — Bereshit 26:12–33
...
Yitsjaq vuelve a abrir los pozos que habían cavado los siervos de Avraham y les da los nombres antiguos. **(באר)**, _be'er_, es pozo; como sustantivo nombra una fuente de agua, mientras que en la cadena verbal **ויחפרו** (_yajperu_) «cavaron» se trata de recuperar una provisión enterrada. **(סתם)**, _satam_, significa obstruir, cerrar o tapar; aquí describe la acción de los filisteos que bloquea los pozos después de la muerte de Avraham. La memoria de los nombres no es nostalgia decorativa: conserva la continuidad de la casa y de la provisión recibida.
...
## Reparación focal: los pozos muestran la promesa bajo presión — Bereshit 26:12-33

La exposición de Eric no debe reducir la bendición a una prosperidad sin resistencia. El capítulo intermedio conserva el mismo orden que el resto de Toldot: יהוה bendice, los vecinos reaccionan, Yitsjaq se aparta y la promesa se vuelve habitable mediante límites. OE dice **ויגדל האיש וילך הלוך וגדל עד כי גדל מאד**, «y el hombre creció, y fue creciendo hasta que creció mucho» (#bereshit_26_13). **(גדל)**, _gadal_, significa crecer, hacerse grande o engrandecer; su repetición intensifica el aumento visible de Yitsjaq. «Éxito integral» es una equivalencia **pedagógica**, no el sentido único del verbo. La fuerza contextual es una prosperidad que provoca envidia, no una garantía de ausencia de conflicto.
...
El primer pozo se llama **עשק**, _eseq_, «contienda» o «disputa», y el segundo **שטנה**, _sitnah_, «hostilidad» o «acusación». **(ריב)**, _riv_, significa contender o disputar; **(שטן)**, _satan_, significa adversario u oposición. En este contexto ambos nombres registran conflictos concretos entre pastores y no prueban por sí solos una doctrina sobre un ser personal. «Guerra espiritual» sería una equivalencia **pedagógica** demasiado amplia. El tercer pozo, **רחבות**, _Rejovot_, procede de **(רחב)**, _rajav_, «ser ancho o espacioso»: la amplitud llega cuando cesa la disputa suficiente para habitar, no cuando la familia convierte la promesa en dominio.

Así se precisa la observación de Eric sobre elección y bendición. La bendición de Yitsjaq se ve en la cosecha, los rebaños y los pozos, pero también en su capacidad de no responder a cada obstrucción con violencia. Cuando Avimelej vuelve, el pacto de Beer Sheva incluye comida, juramento, altar e invocación del Nombre. La prosperidad se vuelve testimonio público solo cuando permanece bajo límites, memoria y paz pactada; no cuando se usa como prueba automática de superioridad.

## La bendición pronunciada y la bendición recibida

El cierre de Toldot debe distinguir entre la palabra que Yitsjaq pronuncia bajo engaño y la transmisión que realiza deliberadamente después. En 27:33 el OE dice **גם ברוך יהיה**, «también bendito será», y el TTH mantiene la conmoción del padre y la irrevocabilidad reconocida. **(ברך)**, _barakh_, significa bendecir o declarar favorecido; en esta forma su fuerza contextual es una proclamación que Yitsjaq no retira, no una certificación moral del disfraz. «Dios aprobó el engaño» es una equivalencia **inexacta**: el narrador conserva el temblor de Yitsjaq, el llanto de Esav y la amenaza de muerte.

La escena cambia en 28:3–4: **ואל שדי יברך אתך ויפרך וירבך והיית לקהל עמים ויתן לך את ברכת אברהם**, «El Shaddai te bendiga, te haga fructificar y te multiplique ... y te dé la bendición de Avraham». **(פרה)**, _parah_, significa dar fruto o fructificar; aquí describe crecimiento de descendencia, no prosperidad individual desligada del pacto. **(קהל)**, _qahal_, significa asamblea o comunidad convocada; su fuerza contextual es una descendencia reunida, no una audiencia para el prestigio de Yaakov. Eric acierta al subrayar que la elección no depende de la apariencia, pero el texto añade que la promesa se transmite con una orden familiar concreta y con una salida de Kenaan.

Delitzsch resume el contraste desde la lectura canónica: **בָּאֱמוּנָה בֵּרַךְ יִצְחָק אֶת־יַעֲקֹב וְאֶת־עֵשָׂו גַּם לְעָתִיד**, «por fe Yitsjaq bendijo a Yaakov y a Esav también acerca de lo futuro» (Ivrim 11:20). Esta cita no borra el engaño narrado en Bereshit ni convierte el juicio apostólico en una explicación etimológica de **ברכה**. **(עתיד)**, _atid_, significa futuro o lo que está por venir; en Delitzsch señala el horizonte futuro de la palabra patriarcal. La equivalencia «bendición automática» es pedagógica e inexacta: la fe mira al futuro prometido, mientras Toldot muestra responsabilidad, conflicto y consecuencias dentro de la casa.
...
La respuesta no es una bendición abstracta: Rivqah concibe y los hijos se agitan en su interior. Cuando consulta, **(דרש)**, _darash_, significa buscar, consultar o investigar; su fuerza aquí es llevar la crisis a יהוה. El oráculo de dos pueblos precede a la venta de la primogenitura, a los pozos y al disfraz. Así, la elección que la exposición subraya no nace del apetito de Esav ni del método de Rivqah: la palabra antecede a las maniobras. Pero esa prioridad tampoco convierte la oración, el engaño o la preferencia en detalles irrelevantes; el relato sigue mostrando sus consecuencias.
...
## El hambre no redefine la palabra — Bereshit 25:24-34
...
Cuando Esav vuelve del campo, el narrador dice **עיף**, _ayef_, «cansado» o «agotado». La forma describe una necesidad corporal concreta; no demuestra por sí sola que Esav estuviera literalmente a punto de morir. Su afirmación **הנה אנכי הולך למות**, «he aquí que voy a morir», es una valoración extrema de su situación. Eric puede usar la escena para advertir contra sacrificar lo recibido por alivio inmediato, pero «adicción al apetito» es una aplicación aproximada: el texto prueba con seguridad que Esav cambia la primogenitura por una comida y que después la desprecia.

Yaakov exige: **מכרה כיום את בכרתך לי**, «véndeme hoy tu primogenitura». **(מכר)**, _makhar_, significa vender o entregar mediante una venta; aquí convierte la **(בכרה)**, _bekhorah_, en objeto de una transacción familiar. La primogenitura no es solamente una emoción de superioridad: implica la condición del primogénito y un lugar dentro de la casa. «Derecho hereditario» es una equivalencia aproximada, porque resume una institución cuyo alcance completo se ve en la historia posterior. El relato no llama virtuosa la presión de Yaakov; registra la responsabilidad de ambos hermanos.

La secuencia de verbos es deliberadamente seca: Esav jura, vende, come, bebe, se levanta y se va. **(בזה)**, _bazah_, significa despreciar, considerar ligero o tratar como sin valor; en **ויבז עשו את הבכרה** el narrador mismo evalúa el desenlace. «Despreciar la promesa» sería una aplicación canónica posible, pero la equivalencia inmediata es despreciar la primogenitura. La exposición de Eric queda bien sostenida cuando contrapone abundancia y pequeñez; queda mal sostenida si convierte el guiso en una explicación total de la elección, pues el oráculo y la respuesta de יהוה preceden al negocio.

## Evaluación consolidada de la exposición de Eric

El título público «El abundante trabajará pequeño» conserva el núcleo de **ורב יעבד צעיר**. **(צעיר)**, _tsa'ir_, significa pequeño, joven o menor; aquí designa al hermano que queda en la posición subordinada según el orden humano, pero que el oráculo coloca en la relación inversa. «El pequeño gobernará» sería una paráfrasis pedagógica más fuerte que el texto: **(עבד)**, _avad_, significa trabajar o servir, y la forma no debe convertirse automáticamente en «ser derrotado» o «ser condenado». La equivalencia «el mayor servirá al menor» es aproximada y tradicional; la formulación hebrea permanece como evidencia exacta.

El mapa canónico también requiere límites. La oración de Yitsjaq, la consulta de Rivqah y el oráculo muestran que la promesa no nace del hambre de Esav ni de la astucia de Yaakov. Pero el capítulo narra favoritismo, presión y desprecio; no permite usar la elección para borrar responsabilidad. En 28:3-4 Yitsjaq vuelve a bendecir a Yaakov conscientemente y vincula el don con **ברכת אברהם**, _birkat Avraham_, «la bendición de Avraham». **(ברכה)**, _berakhah_, significa bendición o beneficio pronunciado; aquí su fuerza incluye descendencia, pueblo y tierra. «Prosperidad individual» es una equivalencia pedagógica inadecuada.

Así, la lectura de Eric se sostiene en tres afirmaciones de distinta fuerza: es **exacto** que el oráculo invierte la relación entre mayor y menor; es **aproximado** decir que «abundante» traduce todo el alcance de _rav_; y es **pedagógico** aplicar el episodio a quienes cambian una herencia recibida por una satisfacción inmediata. El texto no promete que la astucia produzca elección. Enseña que la palabra de יהוה precede al conflicto, que el apetito puede llevar a despreciar un don y que la bendición pactual no convierte el engaño en modelo.

## Créditos

- Expositor: **hermano Eric de Jesús Rodríguez Mendoza**.
- Video: [Parashat Toldot - Génesis 25:19-28:9 Español- Spanish](https://www.youtube.com/watch?v=nOrCP8wDipM) (`source_id`: `youtube:nOrCP8wDipM`).
