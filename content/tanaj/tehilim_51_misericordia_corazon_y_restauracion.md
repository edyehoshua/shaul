...
Eric comienza por la inscripción y pide mantener abierto #shemuel_bet_12_1-15: Natán confronta a David después del adulterio y del homicidio. Su punto no es usar el contexto como adorno, sino impedir una confesión abstracta. El texto local nombra a Natán, a David y a Bat-Sheva; por tanto, el salmo puede leerse como súplica nacida de una falta determinada.
...
| --- | --- | --- | --- |
| Inscripción y confesión | Leer el encabezado junto con la confrontación de Natán para no abstraer la falta de David. | #tehilim_51_1-6; #shemuel_bet_12_1-15 | Respaldado por la inscripción local; se preserva el marco narrativo. |
...
| Lo secreto y la muerte | El deseo no confrontado produce pecado; «madre» puede ser una imagen de muerte. | #tehilim_51_5-8; #santiago_1_14-15; #shemuel_bet_12_5 | La aplicación a Yaacov se distingue del salmo; la lectura simbólica de «madre» queda pendiente. |
...
- [ ] Verificar la propuesta de leer la «madre» de #tehilim_51_5 como muerte y su vínculo con «hijo de muerte» en #shemuel_bet_12_5.
...
- [[tehilim_29_voz_gloria_y_shalom]]
- [[tehilim_67_bendicion_naciones_y_justicia]]
