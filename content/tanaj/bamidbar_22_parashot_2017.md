...
La primera delegación permite precisar la lectura de Eric sobre el lucro sin convertirla en una psicología no demostrada. Los enviados llegan con **(קסמים)**, _qesamim_, «adivinaciones» o prácticas de sortilegio (#bamidbar_22_7), y Balaq pide que Bilam pronuncie **(ארה)**, _arah_, «maldecir». El sentido normal de _qesamim_ pertenece al campo de la adivinación; su fuerza contextual es el marco religioso desde el que Moav busca una palabra eficaz. «Ministerio profético» sería una equivalencia inexacta. _Arah_ nombra el acto de maldecir; «cortar al pueblo de la bendición» es una inferencia aproximada que puede conectarse con otros textos, no la traducción completa del verbo.
