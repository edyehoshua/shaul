---
title: "Tehilim 105: memoria del pacto, Yosef y el éxodo"
description: "Lectura ordenada de Tehilim 105 sobre recordar las maravillas, la promesa a Abraham y la salida de Mitzráim."
date: 2026-07-28
tags:
  - tehilim
  - tehilim_105
...
Tehilim 105 transforma la memoria de la historia de Israel en una convocatoria presente: confesar el nombre, cantar, buscar el rostro de יהוה y guardar sus instrucciones. La clase del hermano Eric propone leerlo como complemento de Tehilim 104: después de contemplar la creación ordenada, el salmo recuerda cómo la misma fidelidad se manifiesta en el pacto, la preservación de los patriarcas, Yosef, Moshéh, Aharón y la salida de Mitzráim. El texto local confirma ese movimiento, pero también obliga a distinguir entre lo que el salmo narra y las extensiones doctrinales que la clase relaciona con él.
...
## Confesar, cantar y recordar — 105:1-7 #tehilim_105_1-7
...
## Pacto, herencia y protección — 105:8-15 #tehilim_105_8-15
...
## Yosef: hambre, palabra y elevación — 105:16-22 #tehilim_105_16-22
...
## Mitzráim, Moshéh y las señales — 105:23-38 #tehilim_105_23-38
...
## Salida, provisión y propósito — 105:37-45 #tehilim_105_37-45
...
El cierre es decisivo: la tierra se da «con el fin de que guardaran sus estatutos, y sus instrucciones vigilaran» (105:44-45). **תּוֹרָה** (_torah_) significa normalmente instrucción, enseñanza o dirección; aquí el TTH traduce «instrucciones» y el contexto final le da fuerza práctica: la herencia y la liberación tienen un propósito obediente. La relación entre Torah y «doctrina sanadora» que Eric desarrolla en la clase es pedagógica y pastoral; el salmo sí afirma guardar estatutos e instrucciones, pero no usa en este verso la expresión técnica «doctrina sanadora».

## Hoja léxica

| Término        | Transliteración | Sentido normal                    | Fuerza contextual y relación                                                                                                    |
| -------------- | --------------- | --------------------------------- | ------------------------------------------------------------------------------------------------------------------------------- |
| **הוֹדוּ**     | _hodu_          | den gracias, alaben, reconozcan   | En 105:1 abre una proclamación pública; «confesar» recoge una fuerza aproximada, no excluye «dar gracias».                      |
| **נִפְלָאוֹת** | _niflaot_       | maravillas, actos extraordinarios | En 105:2 y 5 designa las obras que deben ser recordadas y anunciadas; sostiene la memoria narrativa.                            |
| **בְּרִית**    | _berit_         | pacto, alianza                    | En 105:8-10 une palabra, juramento, generaciones y promesa; su fuerza es explícitamente relacional e histórica.                 |
| **דָּבָר**     | _davar_         | palabra, dicho, asunto            | En 105:19 la palabra de יהוה prueba a Yosef; la aplicación a una «palabra puesta en marcha» es contextual y pedagógica.         |
| **תּוֹרָה**    | _torah_         | instrucción, enseñanza, dirección | En 105:45 es el contenido que los liberados deben guardar; la correspondencia con «doctrina sanadora» es pedagógica, no exacta. |

## Mapa de la enseñanza de Eric

| Unidad textual | Observación concreta de la clase                                                                                                                     | Tratamiento en esta nota                                                                                                                     |
| -------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------- |
| 105:1-7        | Eric distingue reconocimiento objetivo de una gratitud meramente subjetiva y observa el llamado a toda la creación/pueblos junto al papel de Israel. | Clarificación léxica y apoyo textual: _hodu_ admite reconocer/alabar; el salmo anuncia a los pueblos y nombra a la simiente de Abraham.      |
| 105:8-15       | Eric presenta creación y éxodo como ejes de la Torah, y la promesa como palabra puesta en marcha para el pueblo.                                     | Apoyo textual para pacto, palabra y pueblo; la conexión con creación y «regeneración» queda como marco pedagógico calificado.                |
| 105:16-22      | Eric lee la prisión de Yosef y la llegada de la palabra como una prueba delimitada por el propósito de יהוה.                                         | Apoyo textual y aclaración de _davar_: el verso vincula palabra, prueba y liberación sin borrar la narración de Yosef.                       |
| 105:23-38      | Eric subraya que las señales del éxodo manifiestan orden y victoria sobre el desorden, no una lucha entre dioses iguales.                            | Apoyo textual para las señales atribuidas a יהוה; la comparación amplia entre culturas queda como inferencia no necesaria para el salmo.     |
| 105:39-45      | Eric conecta la provisión, la promesa a Abraham y la obediencia final, relacionando Torah con una enseñanza que sana.                                | Apoyo textual para provisión, memoria y guardar instrucciones; «doctrina sanadora» se marca como aplicación pastoral, no traducción literal. |

## Conclusión

Tehilim 105 enseña a recordar de manera activa: confesar, cantar, buscar, anunciar, reconocer el pacto y guardar sus instrucciones. El salmo enlaza la promesa con Yosef, el éxodo con la provisión y la herencia con la obediencia. Así complementa la contemplación cósmica de Tehilim 104 con una memoria histórica: el mismo יהוה que ordena la creación sostiene a su pueblo y cumple su palabra.

## Créditos

- Expositor: **hermano Eric de Jesús Rodríguez Mendoza**.
- Video: [Tehilim/Himnos/Salmo Cap 105](https://www.youtube.com/watch?v=cWyHPZ34DE8) (`source_id`: `youtube:cWyHPZ34DE8`).
