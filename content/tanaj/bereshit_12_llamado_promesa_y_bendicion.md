---
title: "Bereshit 12: llamado, promesa y bendición"
description: "Lectura de Bereshit 12 sobre el llamado de Abram, la promesa de יהוה, la tierra y la bendición para las familias de la tierra."
date: 2026-07-27
tags:
  - "bereshit"
  - "bereshit_12"
...
Bereshit 12 presenta el llamado de יהוה a Abram como una salida confiada hacia la tierra que él mostrará. La promesa une descendencia, nombre y bendición, y abre su horizonte hacia todas las familias de la tierra; Abram responde caminando y levantando altar ante יהוה.

## Alcance de la nota

Esta es la nota canónica de Bereshit 12 y organiza la clase sobre Lej-lejá en lo que concierne a este capítulo. La sesión también recorre Bereshit 6–17 y propone conexiones con el descanso, Babel, la tierra y la esperanza futura. Aquí se conserva como centro el argumento explícito de Bereshit 12. La transcripción automática sirve para localizar los énfasis de la exposición; no es una cita literal ni prueba por sí sola una conclusión histórica, léxica o doctrinal.
...
## Promesa recibida y bendición compartida

Los vv. 2–3 no reducen la promesa a prestigio personal. יהוה promete hacer de Abram una nación grande, bendecirlo y engrandecer su nombre; luego expresa que por medio de él serán bendecidas todas las familias de la tierra. La secuencia mantiene a יהוה como quien actúa y a la bendición como don que alcanza más allá del clan de Abram.

La exposición relaciona este horizonte con la restauración de la creación y con Yehoshua. Es una línea de lectura que debe examinarse junto con los textos posteriores que la desarrollan. En este capítulo, la afirmación segura es la promesa de bendición para las familias de la tierra y el llamado a Abram.

## La respuesta de Abram: caminar, invocar y atravesar crisis

La clase de la serie pública _Parashat Lej-lejá_ presenta el llamado como un movimiento hacia lo que יהוה mostrará, no como una posesión fabricada por Abram. El texto sostiene esa dirección con verbos concretos: Abram «se fue» conforme a la palabra recibida, cruza la tierra, levanta altares y «llama en el Nombre de יהוה» (12:4–8). La correspondencia entre «caminar» y obedecer es **pedagógica**, no una equivalencia mecánica: el capítulo también narra decisiones ambiguas y una bajada a Egipto.

El hambre de 12:10 impide una lectura triunfalista. Abram desciende para residir, teme por su vida y presenta a Sarai como su hermana. El narrador no llama buena a toda su estrategia; deja que la intervención de יהוה y el reproche de Faraón expongan la tensión entre la promesa y el temor. «Ser bendición» tampoco significa inmunidad frente a la prueba: significa que el don recibido se orienta hacia otros, mientras la historia examina la fidelidad del portador.

## Hoja léxica

| Forma         | Transliteración | Sentido normal         | Fuerza contextual                                                             | Equivalencia                                                              |
| ------------- | --------------- | ---------------------- | ----------------------------------------------------------------------------- | ------------------------------------------------------------------------- |
| **(לך לך)**   | _lekh lekha_    | Ve para ti; sal        | Orden de separarse de tierra, parentesco y casa paterna                       | «Vete» es aproximada; «para ti» conserva el matiz que el TTH explicita    |
| **(ברך)**     | _barakh_        | Bendecir, otorgar bien | יהוה bendice a Abram y hace que la bendición alcance a las familias           | «Bendición» es aproximada; no equivale automáticamente a prosperidad      |
| **(זרע)**     | _zera_          | Semilla, descendencia  | Futuro colectivo al que se promete la tierra                                  | «Descendencia» es contextual y aproximada; no agota la imagen de semilla  |
| **(גור)**     | _gur_           | Residir como forastero | Abram baja a Egipto sin que el texto describa una transferencia de la promesa | «Vivir» sería demasiado general; «residir» es la opción más cercana       |
| **(קרא בשם)** | _qara beshem_   | Llamar en el nombre    | Culto público e invocación de יהוה en el camino                               | «Adorar» es pedagógica; la forma incluye la acción de proclamar o invocar |
...
## Bendición universal y prueba de la vulnerabilidad

En 12:2-3, **(גוי)**, _goy_, significa nación o pueblo; **(משפחה)**, _mishpajah_, significa familia o clan. יהוה promete hacer de Abram un **גוי גדול**, _goy gadol_, «nación grande», y anuncia que en él serán benditas **כל משפחת האדמה**, _kol mishpejot ha-adamah_, «todas las familias de la tierra». «Todas las naciones» puede ser una equivalencia canónica posterior, pero la forma local conserva el lenguaje de familias. Eric acierta al destacar la amplitud del horizonte: la elección de Abram no termina en privilegio cerrado. La bendición recibida tiene una dirección hacia otros.

El verbo **(ברך)**, _barakh_, significa bendecir, arrodillarse o conceder bien según el contexto. En **ואברכך**, _vaavarekha_, יהוה promete bendecir a Abram; en **והיה ברכה**, _vehyeh berakhah_, «sé bendición», la frase puede leerse como resultado y vocación. «Sé una fuente automática de prosperidad» sería una equivalencia incorrecta. El capítulo inmediatamente introduce hambre y riesgo en Egipto. La clase conserva bien el principio de que el portador debe caminar bajo la promesa; el relato corrige cualquier lectura en la que bendición signifique inmunidad ante decisiones temerosas.

La bajada a Egipto usa **(גור)**, _gur_, residir como forastero, y **(ירד)**, _yarad_, bajar o descender. Estas formas describen la crisis sin declarar que Abram salió del pacto. El narrador tampoco presenta su estrategia respecto de Sarai como una victoria transparente. Faraón reprende, יהוה interviene y Abram sale con bienes. La misericordia preserva la promesa, pero no convierte el temor en obediencia ejemplar. Eric relaciona el camino con una esperanza de retorno; esa conexión debe permanecer como lectura canónica, mientras el capítulo permite afirmar con seguridad que la promesa atraviesa una prueba y sigue siendo iniciativa de יהוה.

## Altar, Nombre y respuesta pública

En 12:7-8, Abram edifica un altar y llama en el Nombre de יהוה. **(בנה)**, _banah_, significa construir o edificar; **(קרא)**, _qara_, significa llamar, proclamar o invocar. La expresión **ויקרא בשם יהוה**, _vayiqra veshem YHWH_, no equivale simplemente a «tuvo una experiencia privada»: el altar y la invocación hacen visible una respuesta pública en el trayecto. «Adorar» es una equivalencia pedagógica válida en sentido amplio, pero puede ocultar la acción verbal de proclamar o invocar el Nombre.

La relación entre promesa y altar debe mantenerse en su orden. Primero יהוה aparece y dice «a tu simiente daré esta tierra»; después Abram edifica. **(זרע)**, _zera_, significa semilla, simiente o descendencia, y su fuerza contextual permite una referencia colectiva sin fijar por sí sola una lectura individual. Eric conecta la simiente con desarrollos mesiánicos posteriores; la nota conserva esa recepción, pero no la introduce como definición morfológica de la forma. El altar responde a la palabra; no la compra ni la activa.
...
- [ ] Cotejar la transcripción completa del video de JqAnsH6Coq0 para distinguir sus observaciones específicas sobre «la promesa del retorno» de las conexiones canónicas formuladas aquí.
