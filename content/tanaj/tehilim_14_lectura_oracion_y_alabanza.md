---
title: "Tehilim 14: el naval, la mirada desde los cielos y la salvación de Sión"
description: "Lectura ordenada de Tehilim 14 a partir de la enseñanza de Eric: el naval que niega Elohim, la corrupción de las obras, el remanente y la yeshuá desde Sión, contrastada con el texto hebreo local."
date: 2026-07-27
tags:
  - tehilim
  - tehilim_14
...
Tehilim 14 expone la voz interior del **נבל** que dice «no hay Elohim», la mirada de יהוה desde los cielos sobre los hijos de Adam, la corrupción general de las obras y la esperanza de que la salvación de Israel salga de Sión cuando יהוה haga volver el cautiverio de su pueblo. La clase del hermano Eric lee el salmo junto a Romanos 3, distingue el «no hay Elohim» no como mero ateísmo abstracto sino como negación del amor y del rescate divinos, y distingue obras corruptibles o abominables del «hacer el bien» que solo cabe cuando Elohim está presente en el corazón. Esta nota conserva esas observaciones concretas y las mide con el texto local, sin dar por demostradas las identificaciones con Nabucodonosor, el príncipe de este mundo o la lectura mesiánica de **עני** y Sión que la clase propone.

## Alcance de la nota

La enseñanza «Tehilim/Hymnos/Salmo Chap 14» recorre el capítulo completo. La transcripción automática sirve para reconstruir el argumento de Eric; no se cita como texto autoritativo ni como prueba filológica autónoma. El hebreo se toma del corpus OE local, normalizado sin barras de segmentación. La TTH local aporta el castellano de apoyo. Cuando Eric apela a comentaristas, a Macabeos, a Zacarías 9 o a cartas apostólicas, la nota lo registra como propuesta de la clase y lo marca para verificación si no queda asentado en el propio salmo.
...
La afirmación interior **אין אלהים** no la reduce Eric a un ateísmo de manual. Distingue, en continuidad con su enseñanza sobre Yojanán, el peso de **אלהים** como nombre que concentra atributos y, en su lectura, el gesto del amor divino. Negar Elohim sería, entonces, negar no solo «que haya dios», sino que haya amor eficaz capaz de rescatar. Esa precisión es el nervio de la clase y se coteja con Romanos 3 y 5 como marco canónico que él mismo invoca; Tehilim 14, por sí solo, registra la negación en el corazón y sus frutos en la acción.

Eric menciona la opinión de comentaristas que situarían el himno en relación con Nabucodonosor como primer gran rey de dominio amplio que diría «no hay Elohim». Lleva esa línea más lejos al identificar la mentira arquetípica con el príncipe de este mundo. El salmo no nombra a Nabucodonosor ni a Satanán; ambas identificaciones quedan como propuestas históricas y teológicas pendientes de verificar.
...
En el v. 6, **עצת עני תבישו** —avergonzarán el consejo del ani— pero **יהוה מחסהו**, «יהוה es su refugio». Eric corrige o reorienta la lectura hacia el **עני** como título del Mesías, citando Zacarías 9:9 donde el rey viene **צדיק** y **עני**. El OE local dice **עני**; la identificación exclusiva con el Mesías es una lectura tipológica de la clase, plausible en su marco canónico pero no demostrada solo por Tehilim 14. El refugio en יהוה sí es textual.

El cierre anhela: **מי יתן מציון ישועת ישראל** —quién diera desde Sión la salvación de Israel— y anuncia gozo cuando יהוה haga volver el cautiverio de su pueblo. Eric lee Sión también hacia la Yerushaláim celestial de Hebreos y entiende la yeshuá como provisión de refugio. El salmo nombra Sión, Israel, Yaakov y el retorno del cautiverio; la proyección celestial es conexión canónica cualificada.

## Hoja léxica

| Término | Transliteración | Sentido ordinario | Fuerza en el contexto | Relación |
| --- | --- | --- | --- | --- |
| **(נבל)** | naval | necio, ruin; raíz de desgaste | Sujeto que niega Elohim en el corazón | Aproximada la red con nevilá/cadáver; el sentido moral de insensatez es contextual |
| **(אלהים)** | Elohim | Dios / jueces / potencia divina | Objeto de la negación y de la búsqueda | Exacta como forma; la reducción a «amor incondicional» es pedagógica de Eric |
| **(עלילה)** | alilah | acción, hazaña, causa | Acciones corrompidas y abominables | Aproximada la oposición técnica a maasé |
| **(עשה טוב)** | oseh tov | hacedor de bien | Ausente entre los hijos de Adam sin más | Exacta en la frase; «bien» como solo lo que emana de Elohim es precisión teológica de la clase |
| **(השקיף)** | hishkif | miró hacia abajo | Escrutinio de יהוה desde los cielos | Exacta |
| **(משכיל)** | maskil | prudente, que discierne | Quien busca a Elohim | Exacta en el salmo; ampliar a «mente del Mesías» es extensión |
| **(פעלי און)** | poalei aven | hacedores de iniquidad/vanidad | Depredadores del pueblo | Exacta; «activistas» es glosa contemporánea |
| **(קרא)** | kara | llamar, invocar, leer, nombrar | Lo que no hacen respecto de יהוה | Aproximada la inclusión de «leer» junto a invocar |
| **(דור צדיק)** | dor tsadiq | generación del justo | Ámbito donde Elohim está y hay terror | Aproximada la lectura de dor como «habitantes» |
| **(עני)** | ani | pobre, afligido | Dueño del consejo que intentan avergonzar | Pedagógica/tipológica la identificación mesiánica vía Zacarías 9 |
| **(ישועה)** | yeshuá | salvación | Esperada desde Sión para Israel | Exacta |
...
- [ ] Documentar los comentaristas que vinculan Tehilim 14 con Nabucodonosor y evaluar esa tradición.
- [ ] Cotejar la red léxica de **נבל** / **נבלה** / desgaste y su uso en la Torah antes de fijar una sola etimología de enseñanza.
- [ ] Verificar la distinción técnica que Eric traza entre **עלילה** y **מעשה** con diccionarios y usos bíblicos.
- [ ] Revisar Zacarías 9:9 y el uso de **עני** como título antes de identificar de modo exclusivo el ani de Tehilim 14:6 con el Mesías.
- [ ] Separar el uso paulino de Tehilim 14 en Romanos 3 de la exégesis histórica del salmo en su propio horizonte.

## Conclusión

Tehilim 14 no describe solo un ateo de ocasión: muestra un interior que niega Elohim, unas acciones que se corrompen, una mirada divina que no halla maskil entre los hijos de Adam y, aun así, un horizonte de terror para los malvados, refugio para el ani y salvación que se anhela desde Sión. La enseñanza de Eric aporta el contraste decisivo entre obras que perecen y el «hacer el bien» ligado a Elohim, y lee el salmo en diálogo con Romanos sin borrar la voz del poema. Esta nota retiene esa exigencia y deja abiertas las extensiones históricas y mesiánicas que el texto local no resuelve por sí solo.
...
- Video: [Tehilim/Hymnos/Salmo Chap 14](https://www.youtube.com/watch?v=EC-nI5OxfZw) (`source_id`: `youtube:EC-nI5OxfZw`).
