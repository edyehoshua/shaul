---
title: "Tehilim 8: nombre sublime, humillación y corona del Ben Adam"
description: "Lectura ordenada de Tehilim 8 a partir de la enseñanza de Eric: al-hagittit, el nombre poderoso, la boca de los sencillos, la disminución del Ben Adam y la corona de kavod y hadar, contrastadas con el texto hebreo local."
date: 2026-07-27
tags:
  - tehilim
  - tehilim_8
...
Tehilim 8 enmarca entre dos aclamaciones —**יהוה אדנינו מה אדיר שמך בכל הארץ**— la visión de un **הוד** puesto sobre los cielos, la fortaleza fundada en boca de **עוללים וינקים**, la pregunta por el **אנוש** / **בן אדם** y la secuencia de disminución, corona y dominio. La clase del hermano Eric lee el himno en clave futura y mesiánica: no como crónica pasada del «hombre en general», sino como profecía de la humillación y coronación del Ben Adam, confirmada por el uso del salmo en el Evangelio y en Hebreos. Esta nota retiene esa observación concreta, la prueba contra el hebreo local normalizado y distingue con cuidado lo textual de las propuestas sobre **גתית**, vocalización y teología del nombre de Israel.

## Alcance de la nota

La enseñanza «Tehillim/Hymns/Psalm Ch. 8» combina un marco histórico de fuentes (Torah, Ketuvim, LXX, Qumrán, Evangelio, Targum, midrash y comentaristas medievales) con el recorrido versículo a versículo del mizmor. La transcripción automática es ruidosa en nombres propios y términos técnicos; orienta el argumento de la clase, pero no se usa como cita literal. El hebreo de la hoja de comparación procede del corpus OE local sin barras de segmentación. La TTH local aporta castellano; su numeración de versos no coincide del todo con la del OE (el OE incluye el encabezado como v. 1).
...
## Encabezado, **גתית** y tiempo del himno: Tehilim 8:1–2a #tehilim_8_1-2
...
1. **Instrumento musical** — la opción más tradicional en comentaristas judíos medievales.
2. **Gentilicio de Gat** — arpa o dedicación ligada a Gat / familia de Obed-Edom, según otras glosas medievales.
3. **Prensa** — la LXX traduce hacia *lēnos* (prensa de uva o aceite).

La clase no oculta el peso de la tradición del instrumento, pero se detiene en la tercera vía: si la LXX (s. III a.e.c.) no eligió «lira/arpa», quizá no operaba aún la glosa instrumental medieval. Eric asocia la prensa con Getsemaní (**גת שמני**, prensa de aceite) y con la humillación del Mesías estrujado en el monte de los Olivos. El OE confirma **על הגתית**; la conexión mesiánica con Getsemaní es propuesta pedagógica e intertextual, no una etimología única demostrada por el solo encabezado.

**מזמור לדוד** lo lee, como en otros salmos, como composición para el amado: el dedicatario ya inclina el himno hacia un horizonte mesiánico. Esa dualidad David/amado es marco de la clase.
...
## Nombre, Adonenu y hod sobre los cielos: Tehilim 8:2 #tehilim_8_2
...
## Boca de sencillos y fortaleza: Tehilim 8:3 #tehilim_8_3
...
La clase ancla esta lectura en Mattityahu 21:10–16: Yehoshua en el templo-montaña, sanación de ciegos y cojos, muchachos que gritan «¡Hoshana al Ben David!» y la cita explícita de este verso frente a sacerdotes y escribas indignados. También evoca Mattityahu 11:25: lo escondido a sabios y revelado a niños. Conclusión de Eric: la revelación del poder del Nombre no está atada a la erudición; pasa por la boca de los sencillos, los discapacitados y los poco letrados —perfil que acerca también a los discípulos pescadores—.

Sobre la tensión hebreo/griego (*ainos* «alabanza» frente a **עז** «poder»), Eric sostiene que en el universo hebreo de **הלל** la alabanza verdadera son los hechos maravillosos; por eso poder y alabanza no distan como en castellano. Cita 2 Crónicas como ejemplo de solapamiento léxico en la tradición. El OE confirma **עז**; la armonización con «alabanza» evangélica es argumentación de la clase, útil y discutible a la vez.
...
## Cielos, enosh y ben adam: Tehilim 8:4–5 #tehilim_8_4-5
...
## Disminución, corona y dominio: Tehilim 8:6–9 #tehilim_8_6-9
...
## Inclusio final: Tehilim 8:10 #tehilim_8_10
...
| --- | --- | --- | --- | --- |
| **(גתית)** | gittit | designación del encabezado (instrumento / Gat / prensa) | Marco del himno; Eric prioriza la vía de la prensa (LXX) hacia Getsemaní | No establecida; tres glosas en competencia |
| **(שם)** | shem | nombre, fama, renombre | Aclamado en toda la tierra; puerta al Nombre revelado | Exacta como fama/nombre; identificación con Yehoshua es pedagógica/canónica |
| **(הוד)** | hod | esplendor, majestad, vigor admirable | Puesto/dado sobre los cielos | Aproximada; «virtud + potencia» es glosa densa de la clase |
| **(עוללים)** | olalim | niños pequeños; glosa de Eric: etapa muy temprana | Boca desde la que se funda la fortaleza | Aproximada la extensión a «feto» |
| **(ינקים)** | yoneqim | lactantes | Pareja de olalim: los más simples | Exacta |
| **(עז)** | oz | fuerza, poder | Objeto de **יסדת**; Eric lo acerca a prodigios/alabanza-poder | Exacta como poder; = «alabanza» es correspondencia pedagógica griego/hebreo |
| **(אנוש)** | enosh | hombre (matiz de fragilidad) | Sujeto de la pregunta y del recuerdo divino | Exacta; debilidad etimológica es matiz discutido |
| **(בן אדם)** | ben adam | hijo de hombre / humano | Pareja de enosh; puerta al Ben Adam mesiánico | Exacta como forma; título mesiánico es lectura canónica cualificada |
| **(חסר)** | jasar / tajserehu | disminuir, hacer faltar | No «crear menor», sino rebajar en dignidad respecto de elohim | Exacta la raíz de falta/disminución |
| **(אלהים)** | elohim | Dios / dioses / autoridades | Término de comparación de la disminución | Exacta la forma; rango ángeles/autoridades es contextual |
| **(כבוד / הדר)** | kavod / hadar | gloria-peso / esplendor | Doble corona del coronado | Exactas como formas; secuencia sacerdotal/real es elaboración |
| **(תחת רגליו)** | tajat raglav | debajo de sus pies | Dominio; Eric: cuidado, no pisoteo | Exacta la locución; matiz de cariño es pedagógico |
...
- [ ] Cotejar en LXX, Targum y comentaristas medievales (Rashi, Ibn Ezra, Radak, etc.) las tres glosas de **גתית** y el peso real de la lectura *lēnos*.
- [ ] Revisar aparatos y masora sobre **תנה** / lectura alternativa de «pondrás» el hod sobre los cielos.
- [ ] Documentar el argumento de Eric que vincula **עז** hebreo con *ainos* griego y con el campo de **הלל** como prodigios.
- [ ] Separar la exégesis de Hebreos 2 y Mattityahu 21 de la voz del salmo en su horizonte de creación y realeza humana.
- [ ] Verificar en gramáticas la tesis sobre formas de **אדני** / artículo antiguo antes de usarla en controversias trinitarias o anti-trinitarias.

## Conclusión

Tehilim 8 no es, en la exposición de Eric, un simple himno de admiración cósmica cerrado en el pasado. Aclama el Nombre poderoso de יהוה, anuncia un hod sobre los cielos, funda fortaleza en la boca de los sencillos, pregunta por el enosh y el Ben Adam, y traza la vía de la disminución, la corona y el dominio hasta volver al mismo grito inicial. El Evangelio y Hebreos confirman, para la clase, que esa vía pasa por Yehoshua. Esta nota conserva ese hilo mesiánico como observación atribuible, lo mide con el hebreo local y deja abiertas las filologías de **גתית**, del tiempo verbal y del alcance exacto de cada corona.

## Ver también

- [[tehilim_2_naciones_rey_ungido_y_refugio|Tehilim 2: naciones, rey ungido y refugio]]
- [[tehilim_15_lectura_oracion_y_alabanza|Tehilim 15: ¿quién morará?, integridad y el hacedor inconmovible]]
- [[tehilim_1_dos_caminos_torah_y_fruto|Tehilim 1: dos caminos, Torah y fruto]]
- [[hebreos_2_sufrimiento_hermandad_y_auxilio|Hebreos 2: sufrimiento, hermandad y auxilio]]

## Créditos

- Expositor: **hermano Eric de Jesús Rodríguez Mendoza**.
- Video: [Tehillim/Hymns/Psalm Ch. 8](https://www.youtube.com/watch?v=a4aHzxIGIcY) (`source_id`: `youtube:a4aHzxIGIcY`).
