...
- La lectura comienza con el siervo y con la iniciativa de יהוה, no con una identidad impuesta desde fuera.
- El tema de luz y justicia requiere seguir el desarrollo del capítulo completo.

## Pendiente de verificar

- [ ] Distinguir en cada conexión entre una cita explícita del texto apostólico y una aplicación pedagógica posterior.

## Conclusión

El pasaje une elección, Ruaj y justicia. Esa secuencia debe gobernar cualquier lectura mesiánica o comunitaria.

## Ver también

- [[yeshayahu_40_consolacion_camino_y_confianza]]
