---
title: "Tehilim 125: seguridad, herencia y caminos rectos"
description: "Lectura de Tehilim 125 sobre confiar en יהוה, permanecer en la herencia y no ceder ante la iniquidad."
date: 2026-07-28
tags:
  - tehilim
  - tehilim_125
...
Tehilim 125 presenta la confianza en יהוה como una permanencia que resiste el movimiento de las amenazas. La exposición del hermano Eric de Jesús Rodríguez Mendoza subraya que **הבטחים** no describe una emoción pasiva, sino una seguridad que sigue caminando en obediencia; compara el monte de Sion estable con la protección que rodea al pueblo; y lee el cetro de la iniquidad, la herencia y los caminos torcidos como una advertencia contra abandonar lo recto por miedo. El texto sostiene la confianza y la petición de paz, mientras que las identificaciones celestiales, las conexiones con Zacarías y el desarrollo doctrinal de «suerte» deben conservar su alcance propio.

## Alcance de la nota

La fuente es una clase de Eric sobre el cántico de las ascensiones. La transcripción automática se usa para reconstruir el hilo de la enseñanza y no como cita literal. La nota sigue los cinco versos en orden y usa el texto hebreo del corpus OE local, normalizado sin barras de segmentación. Cuando Eric introduce Zacarías 14, Romanos, Apocalipsis o prácticas de sorteo bíblico, se registra la relación como conexión de la clase y se distingue de lo que afirma directamente Tehilim 125.
...
## Confiar es permanecer en movimiento fiel — Tehilim 125:1
...
Eric rechaza una idea de confianza como cerrar los ojos y esperar que nada ocurra. Para él, sentirse seguro en יהוה significa seguir haciendo lo que יהוה ha dicho aun cuando una amenaza laboral, social o familiar presione para mentir. La aplicación concreta no convierte el verso en una regla sobre cada empleo, pero conserva una observación material de la clase: la seguridad bíblica no es negar el peligro, sino no permitir que el peligro dicte una desobediencia.
...
## Jerusalén rodeada y la protección que no depende de geografía — Tehilim 125:2
...
La clase enlaza esta protección con Zacarías 14:3-5 y con su lectura de un Sion terrenal que será removido cuando el monte de los Olivos se parta. Desde ese contraste Eric concluye que el Sion que no será movido en Tehilim 125 no puede reducirse a la topografía presente, y lo acerca a una Jerusalén celestial. Zacarías 14 sí describe cambios escatológicos en el monte de los Olivos, pero Tehilim 125 no explica por sí solo cómo relacionar ambos montes. Por eso la conexión es intertextual y teológica, no una equivalencia exacta.
...
## El cetro, la herencia y la presión de la iniquidad — Tehilim 125:3
...
Eric dedica atención a **(גורל)** _goral_. Rechaza leerlo como azar sin dirección y recuerda los lotes para repartir la tierra y la selección del sucesor de Judas. En su explicación, un lote es una decisión asignada que no se manipula después de recibirla. El término puede significar lote, suerte o porción; el salmo usa la imagen de la herencia de los justos. La relación entre «lote» y una decisión divina es pedagógica e intertextual: el verso no está ordenando practicar sorteos en cada decisión.
...
## Bien para los buenos y rectitud del corazón — Tehilim 125:4
...
## Caminos torcidos, conducción y paz — Tehilim 125:5
...
La frase **יוליכם יהוה**, «יהוה los conducirá», es interpretada por Eric como una conducción judicial: יהוה no deja que el torcido permanezca indistinguible del justo, sino que lo lleva a su resultado. La gramática sí presenta a יהוה como sujeto de conducir; el matiz exacto de juicio o destino requiere leer el verso en conjunto con la oposición entre rectos y hacedores de iniquidad.
...
| ------------- | --------------- | ----------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------- |
| **(בטח)**     | bataj           | confiar, sentirse seguro                              | Participio en 125:1; la continuidad diaria es una aplicación pedagógica bien anclada.                                |
| **(מוט)**     | mot             | tambalearse, ser movido                               | Describe la estabilidad comparada con Sion; no promete ausencia de pérdidas externas.                                |
| **(סביב)**    | saviv           | alrededor, en derredor                                | Repetición espacial en 125:2; la protección personal es una extensión comunitaria.                                   |
| **(עולם)**    | olam            | tiempo remoto, duración prolongada, futuro indefinido | «Hasta siempre» es posible como traducción amplia; la indeterminación temporal de Eric es aproximada.                |
| **(שבט)**     | shevet          | vara, cetro, tribu                                    | En el verso funciona como autoridad de la maldad; la asociación tribal es secundaria.                                |
| **(גורל)**    | goral           | lote, suerte, porción                                 | El salmo habla de la herencia asignada de los justos; «decisión divina sin manipulación» es una conexión pedagógica. |
| **(עולה)**    | avlah           | injusticia, iniquidad                                 | Nombra lo que los justos no deben practicar bajo presión; relación directa con la advertencia moral.                 |
| **(עקלקלות)** | aqalqallot      | cosas torcidas, caminos tortuosos                     | Imagen del desvío; su aplicación a compromisos concretos es pastoral.                                                |
...
- [ ] Cotejar la semántica y la historia de la vocalización de **בטח**, **גורל**, **עולה** y **עקלקלות** con léxicos especializados.
- [ ] Estudiar con más precisión la relación entre Tehilim 125:1-2 y Zacarías 14:3-5 antes de formular una escatología del Sion celestial.
- [ ] Verificar las conexiones de **גורל** con la distribución de la tierra, Ester y Hechos 1 sin convertirlas en el sentido único del verso.
- [ ] Revisar las afirmaciones históricas de la clase sobre el monte de los Olivos, su geografía y las aguas de Zacarías 14.

## Conclusión

Tehilim 125 no ofrece seguridad mediante el control de los tiempos ni mediante una vida sin amenazas. Enseña a confiar en יהוה, a permanecer en la herencia y a no extender las manos hacia la injusticia cuando el cetro de la maldad presiona. Eric vuelve visible la dimensión activa de esa confianza; el salmo la encuadra con una promesa de protección, una petición de bien para los rectos, una conducción del torcido y una palabra final de paz sobre Israel.

## Ver también

- [[tehilim_123_ojos_gracia_y_servidumbre|Tehilim 123: ojos levantados, gracia y servidumbre]]
