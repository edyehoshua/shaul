---
title: "Tehilim 141: oración, guardia de la boca y santidad ante la trampa"
description: "Estudio canónico de Tehilim 141 sobre la oración como incienso, el juicio de la palabra y la protección frente a la seducción del mal."
date: 2026-07-29
tags:
  - tanaj
  - tehilim
...
Tehilim 141 presenta la oración como una súplica urgente que debe quedar establecida delante de יהוה, semejante al incienso, y une esa cercanía con una disciplina concreta: labios vigilados, corazón no inclinado al mal y rechazo de los banquetes de quienes practican iniquidad. La clase de Eric de Jesús Rodríguez Mendoza observa que el salmo no nombra una necesidad específica en el primer clamor, sino que pide que יהוה actúe y escuche; después relaciona el incienso con santidad, sal y pacto. El texto sostiene esa trayectoria, pero exige distinguir la imagen poética del salmo de las extensiones posteriores.

## Alcance de la nota

La exposición pública recorre Tehilim 141 en orden y dialoga especialmente con Shemot 30:34-38, Vayiqra 2:13 y Bemidbar 18:19. Se preservan las observaciones de Eric sobre la traducción de pequeñas partículas, el significado de presentar la oración ante el juicio divino, el incienso ofrecido por la mañana y la sal como signo de preservación. La transcripción automática orienta la atribución, no se trata como cita literal. El texto hebreo procede del corpus local OE y se presenta sin barras morfológicas; no hay aquí una edición local TTH o Delitzsch para este salmo.
...
## 141:1-2: clamor, atención e incienso
...
El v. 2 ofrece la imagen central: «Sea establecida mi oración como incienso delante de ti; el alzamiento de mis manos como ofrenda de la tarde». Eric vincula **תפלה**, _tefilah_, con presentarse ante el juicio de Elohim, confesando la justicia y la propia culpa antes de exponer necesidades. El sentido normal de _tefilah_ es oración o súplica; la escena judicial es una explicación pedagógica y contextual, no una equivalencia exacta para cada aparición. **קטרת**, _qetoret_, significa incienso; la correspondencia con la sustancia aromática es exacta. La oración no se vuelve literalmente incienso: el salmo usa una comparación cultual para pedir aceptación y orden.
...
## 141:3-4: la boca y el corazón bajo custodia
...
## 141:5-7: corrección recibida y juicio de los violentos
...
## 141:8-10: ojos puestos en יהוה y trampa invertida
...
El cierre espera que los malvados caigan en sus propias redes mientras el orante pasa. Eric conserva la cautela del salmo: la persona no fabrica venganza, sino que pide protección y deja el desenlace al juicio de יהוה. La imagen dialoga con la justicia retributiva de la poesía sapiencial, pero su fuerza contextual es que el mal fracase en su propia estrategia.

## Léxico clave

| Forma fuente | Transliteración | Sentido normal            | Fuerza contextual y equivalencia                                                |
| ------------ | --------------- | ------------------------- | ------------------------------------------------------------------------------- |
| **קראתי**    | _qarati_        | he llamado, he clamado    | Clamor dirigido a יהוה; exacta en v. 1.                                         |
| **חושה**     | _jushah_        | apresúrate, date prisa    | Urgencia de la respuesta; exacta, sin especificar la acción.                    |
| **תפלה**     | _tefilah_       | oración, súplica          | Presentación ante יהוה; la escena judicial de Eric es pedagógica.               |
| **קטרת**     | _qetoret_       | incienso                  | Comparación cultual de una oración aceptable; exacta como referente.            |
| **שמרה**     | _shomrah_       | guardia, custodia         | Guardar la boca; exacta en la metáfora de vigilancia.                           |
| **נצרה**     | _notsrah_       | preservar, vigilar        | Proteger la puerta de los labios; contextual directa.                           |
| **לב**       | _lev_           | corazón, mente, voluntad  | Centro de orientación moral; contextual, no solo emoción.                       |
| **חסד**      | _jesed_         | bondad leal, misericordia | La corrección del justo como beneficio; aproximada si se reduce a «amabilidad». |
| **חסה**      | _jasah_         | refugiarse, buscar amparo | Dependencia de יהוה frente a trampas; exacta en v. 8.                           |

## Mapa de la enseñanza de Eric

- **141:1:** Eric observa que una partícula pequeña puede leerse «por mí» o «para mí» y que el verbo de llamar puede sugerir que יהוה ha ocurrido dentro del orante. **Tratamiento:** se conserva la cuestión de traducción; la segunda sugerencia queda como meditación pedagógica, no como definición única de _qarah_.
- **141:2:** la clase entiende _tefilah_ como comparecer ante el juicio divino y compara la oración con el incienso. **Tratamiento:** la comparación y la oración son textuales; la escena judicial es una ampliación contextual.
- **Shemot 30:34-38:** Eric destaca cuatro elementos del incienso, su santidad y la necesidad de no inventar una doctrina para cada ingrediente. **Tratamiento:** apoyo intertextual y límite explícito de verificación.
- **141:3-4:** el expositor pide una boca vigilada y un corazón no inclinado a los deleites del mal. **Tratamiento:** apoyo directo del paralelismo y aplicación ética calificada.
...
- Video: «Tehilim/Himnos/Salmo Cap 141» — <https://www.youtube.com/watch?v=hPwnpHmmPBg> — source_id: `youtube:hPwnpHmmPBg`.
