...
Shemot 21 presenta _mishpatim_ concretos, no una licencia para que individuos impongan castigos. La clase incorporada sitúa #shemot_21_16 dentro de una conversación sobre juicio y penas capitales; la nota conserva esa observación, pero distingue el texto bíblico de reconstrucciones históricas o aplicaciones contemporáneas que requieren verificación adicional.

## Alcance de la nota

La fuente de trabajo es una clase de la serie «613 mitzvot» que trata las mitzvot 227–230. El expositor relaciona el secuestro y la venta de una persona con #shemot_21_16 y reflexiona sobre los límites de la autoridad judicial. La transcripción es automática: organiza el hilo de la exposición, pero no es una cita literal ni prueba por sí misma de sus afirmaciones históricas.
...
- **(משפטים)** — _mishpatim_: procesos, decisiones o normas judiciales. En #shemot_21_1 funciona como marco literario del capítulo; no equivale automáticamente a cada sistema jurídico posterior.
- **(כפר)** — _kofer_: rescate o compensación en el contexto de #shemot_21_30. Debe leerse en su caso legal concreto, sin convertirlo en una explicación total de la redención.
- **(פדיון)** — _pidion_: redención o rescate. El TTH local lo usa en #shemot_21_8 y #shemot_21_30.

## Juicio, responsabilidad y límites

La exposición recuerda que el secuestro no es un daño menor: #shemot_21_16 lo formula como una grave violación contra una persona. También propone que una lectura responsable debe atender al marco de jueces y procedimientos, en vez de trasladar de forma privada sanciones antiguas al presente.
...
| ------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------- |
| #shemot_21_1  | Y estos son los procesos legales que pondrás delante de ellos.                                                                                                   | El capítulo abre con _mishpatim_ como marco legal del pasaje.               |
| #shemot_21_8  | Si es mala en los ojos de su amo, quien para sí la había designado, él la dejará ser redimida; a pueblo extranjero no tendrá poder para venderla, por engañarla. | Conserva el vínculo entre designación y redención dentro del proceso legal. |
...
Finalmente, los capítulos 22–24 muestran qué clase de comunidad debe poner estos juicios delante de sí. «Al extranjero no oprimirás» (#shemot_22_21), y «no torcerás el juicio de tu pobre» (#shemot_23_6). **(גר)**, _ger_, significa extranjero residente; «forastero ocasional» es **inexacta** para este contexto de protección comunitaria. **(נטה)**, _natah_, significa inclinar o desviar; aquí su fuerza es torcer una decisión contra el vulnerable. La sesión puede resumirse públicamente como procedimientos, pero la evaluación textual exige añadir esta prueba: un procedimiento no es justo si se inclina por el fuerte. El pacto responde: «Haremos y escucharemos» (#shemot_24_7). **(שמע)**, _shama_, significa oír, escuchar y obedecer; «entender» es **pedagógica pero insuficiente**. El orden completo une autoridad limitada, prueba de hechos, reparación y cuidado del vulnerable.
...
Shemot 21 une normas concretas con responsabilidad pública. La lectura de #shemot_21_16 debe conservar la gravedad del secuestro y de la venta de una persona, así como los límites textuales: el pasaje no convierte al lector en juez ni justifica una aplicación violenta fuera de un marco legítimo.
