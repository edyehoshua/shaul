---
title: "Mishlei 1: daat, musar y reshit"
description: "Apuntes léxicos sobre Mishlei 1:2-14 con énfasis en daat, musar, sagacidad y temor de יהוה"
date: 2025-11-28
tags:
  - mishlei
  - mishlei_1
...
| ------------ | -------------------- | -------------------------------- | ---- | ----------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **(דעת)**    | daat                 | conocimiento vivencial, empírico | ידע  | conocer íntimamente           | En este texto se entiende como comprender desde experiencia.                                                                                                                        |
| **(ידע)**    | yadá                 | conocer                          | ידע  | conocer íntimamente           | Se usa también para el conocimiento íntimo entre esposo y esposa en #bereshit_4_1 y #hoshea_2_22; la nota también lo vincula con conocer el mal en #bereshit_19_8 y #shoftim_19_25. |
| **(מוסר)**   | musar                | disciplina, instrucción, consejo | יסר  | corregir, disciplinar         | La nota lo relaciona con la torá.                                                                                                                                                   |
| **(השכל)**   | haskel               | prudencia, inteligencia práctica | שכל  | obrar con entendimiento       | Parte del consejo que se recibe.                                                                                                                                                    |
| **(צדק)**    | tzedek               | justicia                         | צדק  | rectitud, justicia            | La nota lo ubica al inicio del orden tzedek -> mishpat -> mesharim.                                                                                                                 |
| **(משפט)**   | mishpat              | derecho, juicio                  | שפט  | juzgar                        | Segundo término del orden.                                                                                                                                                          |
| **(מישרים)** | mesharim             | equidad, rectitud                | ישר  | enderezar, ser recto          | Tercer término del orden.                                                                                                                                                           |
| **(ערמה)**   | orma                 | sagacidad                        | ערם  | astucia, agudeza              | Puede ser usada tanto para el bien como para el mal en #bereshit_3_1 y #mateo_10_16.                                                                                             |
| **(מזמה)**   | mezima               | discreción, propósito            | זמם  | planear, tramar               | Aparece junto con daat y orma.                                                                                                                                                      |
| **(ראשית)**  | reshit               | principio, primicia              | ראש  | cabeza, inicio                | Se presenta como lo que sale natural de recibir sabiduría de parte de Adonai.                                                                                                       |
| **(אויל)**   | evil                 | torpe, insensato                 | אול  | tambalearse, obrar torpemente | No se toma aquí como insulto sino como adjetivo; la nota lo relaciona con #iyov_6_18.                                                                                               |

## Escuchar la instrucción

### Mishlei 1:8-9

- shema bení **(שמע בני)** se conecta con shema Israel **(שמע ישראל)** en #devarim_6_4.
- La instrucción de tu padre, musar avija **(מוסר אביך)**:
  - musar = torá
  - av = Elohim
- Las enseñanzas de tu madre, torat imeja **(תורת אמך)**:
  - torat = torá = musar
  - imeja = Yerushalaim en relación con #galatas_4_26
- Nota relacionada: #tehilim_1_9.

## Alegoría sobre las potestades

- Figura: personas.
- Alegoría: potestades, demonios, espíritus impuros.
- Vigilan al inocente sin causa.
- Son ladrones.
- Obram hasta desbordar.
- Quieren que las personas entreguen su vida y recursos a sus obras.

### Desarrollo del pasaje

- #mishlei_1_10: "Hijo mío, si los pervertidos te quieren seducir, no consientas".
- #mishlei_1_11: "Ven con nosotros a tender trampas mortales; acechar, sin motivo, al inocente".
...
| Tanaj (TTH) | #galatas_4_26 | Yerushalaim como “madre” en la alegoría de 1:8 | Mención indirecta en la nota |
...
- [Romanim 10](../besorah/romanos_10.md) — שמע y emunah por el oír.
- [Galatim 5](../besorah/galatas_5.md) — obra del Espíritu frente a obras de la carne.
