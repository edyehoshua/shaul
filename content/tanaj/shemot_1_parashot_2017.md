---
title: "Shemot 1: Oposición, preservación y clamor de Israel"
description: "Nota canónica de Shemot 1, organizada a partir de la clase de Eric y contrastada con el capítulo local."
date: 2026-07-29
tags:
  - parashot
  - shemot
...
Shemot 1 no presenta la opresión como la derrota de una promesa, sino como el escenario en que la vida recibida se multiplica, la memoria de Yosef es desafiada y la reverencia a Elohim resiste una orden homicida. La clase de Eric lleva el título «Venced con el bien al mal»; la nota conserva ese énfasis como observación de la exposición y lo prueba en el orden concreto del capítulo: fecundidad, trabajo forzado, valentía de las parteras y amenaza final contra los niños.

## Alcance de la nota

Esta es la nota canónica para Shemot 1 y usa el único source ID asignado a este capítulo. El material de la clase se registra de forma atribuible, no como transcripción literal. El título público permite identificar el eje de vencer el mal, pero no autoriza inventar frases del audio. La evaluación principal procede del OE y del TTH locales; las aplicaciones pastorales se señalan como tales.

## Hoja de comparación: la vida que el poder intenta negar
...
Eric presenta el bien frente al mal; Shemot 1 da contenido narrativo a esa oposición. El nuevo rey «no había conocido a Yosef» (#shemot_1_8), y transforma el crecimiento de Israel en amenaza política: «He aquí, el pueblo… es más numeroso y más enorme que nosotros» (#shemot_1_9). El plan de Faraón es explícito: oprimir, controlar los nacimientos y finalmente lanzar al río a cada hijo (#shemot_1_10, 13–14, 22). No debe suavizarse la violencia llamándola únicamente «prueba espiritual».
...
| -------------- | ------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------ |
| Shemot 1:1–7   | El eje público «vencer con el bien al mal»                         | Apoyo textual cualificado: la vida se multiplica antes de la opresión; no se presenta como cita literal.                 |
| Shemot 1:8–14  | El poder convierte el crecimiento de Israel en amenaza y lo somete | Apoyo textual: se recorren en orden el olvido de Yosef, el temor político y el trabajo forzado.                          |
| Shemot 1:15–22 | La resistencia debe conservar la vida frente al decreto            | Evaluación textual y léxica: el temor de las parteras se explica como reverencia que produce desobediencia al homicidio. |

## Pendiente de verificar

- [ ] Confirmar mediante revisión humana del video los detalles orales que excedan el título y el eje general de la clase.
- [ ] No convertir «vencer con el bien» en una cita literal ni en una afirmación de que toda adversidad termina inmediatamente.

## Conclusión

Shemot 1 conserva nombres, familias y vida mientras un rey intenta borrarlos. La enseñanza atribuida a Eric encuentra un fundamento real si «vencer con el bien» se entiende pedagógicamente: el capítulo muestra que la opresión no tiene la última palabra y que la reverencia a Elohim se verifica en actos que protegen al vulnerable.

## Créditos

- Expositor: **hermano Eric de Jesús Rodríguez Mendoza**.
- Video: [Parashat Shmot (2017) Venced con el bien al mal.](https://www.youtube.com/watch?v=N-gt5PuJL-8) (`source_id`: `youtube:N-gt5PuJL-8`).
