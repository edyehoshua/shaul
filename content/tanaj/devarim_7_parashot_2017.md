---
title: "Devarim 7: Guardar el pacto y recordar la misericordia"
description: "Nota canónica de Devarim 7, organizada a partir de la clase de Eric y contrastada con el capítulo local."
date: 2026-07-29
tags:
  - parashot
  - devarim
...
Devarim 7 une separación, memoria y obediencia: Israel no debe atribuir la elección a su grandeza ni tratar la tierra como botín autónomo. La clase de Eric se identifica públicamente como «No perderán de vista la Mishméret»; **משמרת** (_mishmeret_) significa custodia, encargo o guardia. Esa formulación es un eje atribuible de la exposición, no una cita literal. El capítulo la examina mostrando que guardar el encargo incluye recordar el amor y el juramento de יהוה, obedecer sus mandamientos y rechazar los objetos que podrían volver la casa una abominación.

## Alcance de la nota

Esta es la nota canónica de Devarim 7 para el source ID `youtube:pBcHCtYt5-s`. La transcripción automática no se presenta como cita literal; el título y el marco de la clase orientan la trazabilidad, mientras el OE y el TTH locales gobiernan la evaluación. Se sigue el capítulo en orden, y se distingue entre apoyo textual, aclaración léxica e inferencia pedagógica.

## Hoja de comparación: elección que reclama custodia
...
## Recordar sin convertir el juicio en espectáculo
...
| --------------- | ----------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------ |
| Devarim 7:1–5   | El marco de la _mishméret_: no perder de vista el encargo   | Aclaración léxica y apoyo textual: guardar incluye separación y obediencia, no solo atención mental.                     |
| Devarim 7:6–12  | La elección debe recordarse junto con el amor y el pacto    | Apoyo textual: se contrasta la elección con la pequeñez de Israel y se explican _qadosh_, _segullah_ y _hesed_.          |
| Devarim 7:17–26 | La memoria vence el miedo y protege la casa de la idolatría | Evaluación cualificada: _zakhor tizkor_ apoya memoria activa; _tsirah_ se deja como término de interpretación pendiente. |

## Pendiente de verificar

- [ ] Revisar el video para precisar qué ejemplos orales desarrolló Eric alrededor de _mishméret_, sin convertirlos en citas.
- [ ] Mantener abierta la identificación histórica o simbólica de **צרעה**; el hebreo permite «avispa», pero no resuelve por sí solo todas las interpretaciones.

## Conclusión

Devarim 7 enseña una custodia humilde: guardar el pacto significa recordar quién liberó, obedecer lo recibido y no introducir la idolatría en la casa. La exposición de Eric ofrece un buen hilo pedagógico si «no perder de vista la Mishméret» se somete al recorrido del capítulo y no se separa del amor, la memoria y la práctica.

## Créditos

- Expositor: **hermano Eric de Jesús Rodríguez Mendoza**.
- Video: [Parashat 'Éqev (2017) No perderán de vista la Mishméret](https://www.youtube.com/watch?v=pBcHCtYt5-s) (`source_id`: `youtube:pBcHCtYt5-s`).
