---
title: "Tehilim 124: auxilio ante aguas y trampa"
description: "Lectura de Tehilim 124: la confesión de que יהוה estuvo con su pueblo ante agresión, inundación y asechanza."
date: 2026-07-27
tags:
  - tehilim
  - tehilim_124
...
Tehilim 124 no convierte la amenaza en una técnica de autodefensa: hace que Israel confiese que יהוה estuvo con él. El poema recorre la agresión humana, la inundación, los dientes y la trampa hasta llegar al auxilio en el nombre de quien hace cielos y tierra. La clase del hermano Eric conserva ese eje y lo aplica a no someterse a presión manipuladora ni a avalanchas de información; la nota distingue esa aplicación de las afirmaciones que el salmo formula directamente.

## Alcance de la nota

La fuente es una exposición del hermano Eric de Jesús Rodríguez Mendoza sobre el cántico de las ascensiones. La transcripción automática sirve para identificar el desarrollo de la clase, no como cita literal. Los versos hebreos proceden del corpus OE local y se han normalizado sin barras de segmentación. Las propuestas sobre acentuación, etimología, historia del Segundo Templo, Israel, Edom, el Mesías y conexiones apostólicas se conservan con su alcance explícitamente calificado.
...
## Presa no entregada y ave liberada — Tehilim 124:6-7
...
## El nombre como auxilio — Tehilim 124:8
...
- [ ] Cotejar la función exacta de **לדוד** en el encabezado de Tehilim 124 y la propuesta «para el amado» antes de usarla como traducción.
...
Tehilim 124 avanza de un «si no hubiera estado יהוה» a un «nuestro auxilio está en el nombre de יהוה». Eric hace visible que el peligro puede ser violento, saturante o capcioso, y llama a no normalizar lo que destruye la fidelidad. La nota conserva esa exhortación con sus imágenes concretas, mientras mantiene el texto local como medida de sus alcances.

## Ver también

- [[tehilim_11_refugio_violencia_y_juicio_recto|Tehilim 11: refugio, violencia y juicio recto]]
- [[tehilim_20_refugio_ofrenda_y_confianza|Tehilim 20: refugio, ofrenda y confianza]]
- [[tehilim_119_torah_y_camino|Tehilim 119: Torah y camino]]

## Créditos

- Expositor: **hermano Eric de Jesús Rodríguez Mendoza**.
- Video: [Tehilim /Himnos/Salmo Cap 124](https://www.youtube.com/watch?v=3Sikk_iOLz0) (`source_id`: `youtube:3Sikk_iOLz0`).
