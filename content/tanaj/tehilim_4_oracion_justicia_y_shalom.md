---
title: "Tehilim 4: oración, justicia y shalom"
description: "Lectura de Tehilim 4 sobre la oración en la estrechez, la confianza en יהוה y el descanso en shalom, atendiendo a su encabezado musical."
date: 2026-07-27
tags:
  - tehilim
  - tehilim_4
...
Tehilim 4 transforma la estrechez en oración, llama a una respuesta de justicia y confianza, y concluye en el descanso seguro que da יהוה. El encabezado sitúa el poema en un marco musical; la clase lo usa para abrir una reflexión sobre _neginot_, pero el sentido exacto de esa indicación no debe decidir por sí solo una regla contemporánea sobre instrumentos.
...
La clase explica el plural **(נגינות)**, _neginot_, en relación con tocar instrumentos de cuerda o melodías, y contrasta melodía con armonía. Esa explicación ayuda a observar que el encabezado pertenece al mundo musical de los Tehilim. Sin embargo, las equivalencias técnicas entre el término, una forma específica de ejecución y categorías musicales modernas son propuestas pedagógicas, no una conclusión establecida por el propio encabezado.
...
- [ ] Cotejar **(נגינות)** en léxicos hebreos y en traducciones antiguas antes de definirlo como «instrumentos de cuerda» o como una técnica de punteo.
- [ ] Verificar la afirmación de la clase sobre la ausencia de tambores en la instrumentación bíblica y su aplicación normativa a la alabanza congregacional.
- [ ] Distinguir los acentos masoréticos, su función de cantilación y cualquier reconstrucción de melodías antiguas con bibliografía especializada.

## Conclusión

La seguridad de Tehilim 4 no procede de controlar la angustia ni de poseer una técnica musical determinada. El salmo enseña a clamar a Elohim, a no pecar en la agitación, a practicar justicia y a descansar en la confianza de que יהוה hace habitar en seguridad.
