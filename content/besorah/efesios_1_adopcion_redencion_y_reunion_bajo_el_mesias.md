---
title: "Efesios 1: adopción, redención y reunión bajo el Mesías"
description: "Efesios 1:5-10 recorre la adopción, el favor, la redención, el perdón y el propósito de reunir todas las cosas en Yehoshua el Mesías."
date: 2026-08-05
tags:
  - efesios
  - adopcion
...
Efesios 1:5-10 presenta una sola progresión: Elohim determina un pueblo para adopción por medio de Yehoshua, lo recibe en su favor, concede redención y perdón, y da a conocer un propósito que reúne lo celestial y lo terrenal en el Mesías. La clase de Eric de Jesús Rodríguez Mendoza lee esa progresión como una obra que no termina en una declaración privada de salvación: todo converge en Yehoshua como centro y cabeza. El texto sostiene la centralidad del Mesías; las explicaciones etimológicas y las conclusiones sobre el orden exacto de la consumación deben mantenerse diferenciadas.

## Alcance de la nota

Esta nota organiza la clase pública «LETTER TO THE EPHESIANS | The MESSIAH as HEAD of EVERYTHING | Chapter 1 | #03 | Live». La exposición retoma Efesios 1:5 y avanza hasta el versículo 10, con énfasis en adopción, favor inmerecido, redención, transgresiones, misterio y reunión bajo el Mesías. La transcripción automática se usa para seguir la enseñanza y no se presenta como cita literal. Los argumentos del expositor se contrastan con el texto local de Delitzsch.
...
El verbo **ἀνακεφαλαιώσασθαι**, _anakephalaiōsasthai_, puede expresarse como reunir bajo una cabeza, recapitular o resumir. El texto fija el alcance: lo celestial y lo terrenal son reunidos en el Mesías en la plenitud de los tiempos. «Cabeza» conserva la imagen de dirección y centralidad, pero no debe usarse para construir una cosmología completa que el pasaje no explica. La enseñanza más firme es que la historia no queda fragmentada fuera del propósito de Elohim: su meta se concentra en Yehoshua.

## Hoja léxica

| Forma | Transliteración | Sentido normal | Fuerza en la nota | Relación |
| --- | --- | --- | --- | --- |
| **(προορίζω)** | _proorizō_ | determinar o destinar de antemano | Propósito de adopción | Directa en el contexto; no implica preexistencia |
| **(υἱοθεσία)** | _huiothesia_ | adopción, colocación como hijo | Identidad recibida por medio del Mesías | Directa; «injerto» es una aplicación pedagógica |
| **(ἀπολύτρωσις)** / **(פדיון)** | _apolytrosis_ / _pidyon_ | liberación mediante rescate; pago de liberación | Redención en el amado | Aproximada entre lenguas |
| **(παράπτωμα)** | _paraptoma_ | transgresión, paso en falso | Pecados nombrados como transgresiones | Directa en el campo léxico; no agota todo «pecado» |
| **(μυστήριον)** | _mystērion_ | misterio, propósito antes oculto | Propósito revelado en el Mesías | Directa; comparación con **(סוד)** es pedagógica |
| **(ἀνακεφαλαιόω)** | _anakephalaiō_ | reunir bajo una cabeza, recapitular | Convergencia de cielo y tierra en Yehoshua | Contextual; no fija una teoría cosmológica total |
...
Efesios 1:5-10 no separa adopción, favor, redención, perdón y propósito. Todo se recibe por medio del Mesías y todo se dirige a la alabanza de Elohim, hasta que lo celestial y lo terrenal sean reunidos en Yehoshua. La clase ayuda a ver esa unidad y a resistir una salvación reducida a privilegio individual; el texto exige, además, distinguir las afirmaciones explícitas de las aplicaciones léxicas y escatológicas.
...
- [[efesios_1_esperanza_poder_y_cuerpo|Efesios 1: esperanza, poder y cuerpo]]
