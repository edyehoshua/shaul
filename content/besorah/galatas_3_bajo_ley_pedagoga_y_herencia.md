---
title: "Gálatas 3: bajo sentencia, la Torá como pedagoga y la herencia en el Mesías"
description: "La enseñanza sobre Gálatas 3:22-29 distingue la sentencia del pecado de la función pedagógica de la Torá y sigue el paso hacia la filiación, la unidad y la promesa."
date: 2026-08-05
tags:
  - galatas
  - gálatas
...
Gálatas 3:22-29 no presenta la Torá como enemiga de la promesa. El pasaje distingue entre estar encerrados bajo pecado y recibir la Torá como **(παιδαγωγός)**, un guía encargado de conducir al niño hacia el Mesías. La clase de Eric de Jesús Rodríguez Mendoza centra esa diferencia en la expresión «bajo ley»: la sentencia que pesaba sobre el pecador no debe confundirse automáticamente con «bajo la Torá». El texto, leído en orden, lleva desde el confinamiento del pecado hasta la justificación por la fidelidad, la filiación, la unidad en el Mesías y la participación en la promesa dada a Abraham.

## Alcance de la nota

Esta nota organiza la clase pública «CARTA A LOS GÁLATAS | Estábamos BAJO SENTENCIA | Capítulo 3 | #07 | Live». Se sigue especialmente Gálatas 3:22-29, con la conexión que la exposición hace con Jeremías 31:33. La transcripción automática se usa para rastrear el argumento y no se presenta como cita literal. La nota contrasta las observaciones de la clase con el texto local; no resuelve aquí todas las cuestiones de crítica textual o de traducción histórica.
...
La conexión con Jeremías 31:33 refuerza esta lectura de internalización: «Pondré mi Torá dentro de ellos y sobre su corazón la escribiré». La cita pertenece al nuevo pacto y debe ser leída en su propio contexto; la clase la usa para explicar que madurez no significa desprecio de la Torá, sino que la voluntad de Elohim llega a gobernar el interior. La conexión es canónica y sugestiva, aunque no convierte Jeremías en una traducción de Gálatas.

## Hijos, unidad y herederos

Después de la metáfora pedagógica, Pablo no deja a la comunidad en una libertad abstracta. Gálatas 3:26 dice que todos son hijos de Elohim por medio de la fidelidad en el Mesías; 3:27 explica la imagen de «vestirse» del Mesías mediante la inmersión; y 3:28 enumera judío y griego, esclavo y libre, varón y mujer. La clase observa que el Mesías derriba jerarquías de pertenencia y que nadie puede convertir su origen en una barrera para la promesa. Esta observación recibe apoyo directo del texto, aunque las aplicaciones institucionales actuales deben formularse con cuidado y no inventarse a partir de una sola lista.

**(ἐνεδύσασθε)**, _enedysasthe_, significa «se vistieron» o «se revistieron». La imagen es exacta en su sentido verbal; decir que el creyente recibe una «máscara» que oculta toda conducta sería una ampliación no autorizada. El contexto mantiene juntas la nueva identidad y el caminar de la comunidad. Vestirse del Mesías significa pertenencia y una vida conformada a él, no una licencia para continuar en el pecado.

El cierre es decisivo: si pertenecen al Mesías, son simiente de Abraham y herederos según la promesa. **(κληρονόμοι)**, _klēronomoi_, son herederos, aquellos que reciben una herencia; no es sólo un título emocional. La causa de la herencia es la pertenencia al Mesías y el efecto visible es una comunidad que ya no clasifica a las personas por los muros que el pasaje acaba de relativizar. La clase acierta al insistir en que la obediencia no compra la herencia; la nota añade que el texto tampoco separa la filiación de una transformación concreta.

## Hoja léxica

| Forma | Transliteración | Sentido normal | Fuerza en la nota | Relación |
| --- | --- | --- | --- | --- |
| **(ὑπὸ νόμον)** | _hypo nomon_ | bajo ley; bajo autoridad o condición jurídica | Expresión discutida por la clase como «bajo sentencia» | La lectura contextual es cualificada; no se convierte en regla universal. |
| **(ὁ νόμος)** | _ho nomos_ | la ley, la norma o la instrucción en contexto | En 3:24, la Torá cumple función pedagógica | Correspondencia contextual, no definición de todos los usos de _nomos_. |
| **(παιδαγωγός)** | _paidagōgos_ | guía o tutor de un niño | Conduce hacia el Mesías | Equivalencia funcional; la comparación con **(אמן)** es pedagógica. |
| **(πίστις)** / **(אמונה)** | _pistis_ / _emunah_ | confianza, fidelidad; firmeza según contexto | Medio por el que se recibe la promesa | Aproximación contextual; no se reduce a una emoción ni se resuelve toda la semántica aquí. |
| **(κληρονόμος)** | _klēronomos_ | heredero | Participante de la promesa en el Mesías | Directa en el pasaje; la aplicación comunitaria es derivada. |
...
Gálatas 3 conduce de la prisión del pecado a la filiación en el Mesías. La Torá no es presentada como el agente que compra salvación, sino como la pedagoga que señala el camino; la justificación y la promesa se reciben por la fidelidad de Yehoshua. La madurez no transforma la gracia en mérito ni la libertad en anomia: hace visible una comunidad revestida del Mesías, unida y consciente de que su herencia depende de la promesa de Elohim.
...
- Video: [CARTA A LOS GÁLATAS | Estábamos BAJO SENTENCIA | Capítulo 3 | #07 | Live](https://www.youtube.com/watch?v=O3PzUB3Il_k) (`source_id`: `youtube:O3PzUB3Il_k`).
