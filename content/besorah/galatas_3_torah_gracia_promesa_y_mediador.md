---
title: "La Torah dada por gracia: promesa, mediación y vida"
description: "Gálatas 3:13-22 distingue la promesa de la función de la Torah y muestra cómo la redención del Mesías orienta a las naciones hacia la herencia y la vida obediente."
date: 2026-08-05
tags:
  - galatas
  - torah
...
Esta nota organiza la clase pública «CARTA A LOS GÁLATAS | La TORAH dada por GRACIA | Capítulo 3 | #06 | Live». El recorrido principal sigue Gálatas 3:13-22 y recoge las conexiones que la exposición hace con Bereshit 13:15, Devarim 21:23, Yehezqel 36:27 y Tehilim 105:7-11. La transcripción automática sirve como apoyo de seguimiento y no se publica como cita literal. La formulación de Eric sobre «desprecio» en lugar de «maldición», y sobre la Torah como manual o guía, se conserva como propuesta de la clase y se contrasta con la forma local Delitzsch.
...
La conclusión de Eric insiste en que no se guarda la Torah para ser salvo, sino porque la salvación recibida introduce al creyente en una vida de obediencia. El vínculo que la clase hace con Yehezqel 36:27 —el Ruaj haciendo andar en los estatutos y juicios— ilumina la aplicación, aunque el versículo de Yehezqel no sea una cita de Gálatas 3. El resultado pastoral que puede sostenerse es que una obediencia visible sin transformación puede convertirse en orgullo; una promesa recibida que no produce ningún fruto tampoco corresponde al camino descrito por la enseñanza.

La nota conserva asimismo la advertencia contra confundir confesión verbal, vocabulario hebreo o calendario con evidencia suficiente de un corazón renovado. No corresponde juzgar la interioridad de cada persona a partir de un solo hábito, pero sí examinar si la enseñanza convierte la gracia en mérito o si conduce a humildad, confesión y justicia. La clase usa «fruto» y «transformación» para llevar la discusión del debate abstracto a la conducta; esa aplicación debe permanecer subordinada al orden textual de promesa, pecado, redención y obediencia.

## Hoja léxica

| Forma | Transliteración | Sentido normal | Fuerza en la nota | Relación |
| --- | --- | --- | --- | --- |
| **(κατάρα)** / **(קללה)** | _katara_ / _qelalah_ | maldición, palabra de juicio | Condición de la que el Mesías redime según el texto local | Aproximada; «desprecio» es interpretación atribuida, no reemplazo automático. |
| **(ἐξαγοράζω)** | _exagorazō_ | comprar fuera, rescatar | Liberar de la condición condenatoria | «Redimir» es aproximación útil, no modelo completo por sí solo. |
| **(ἐπαγγελία)** / **(הבטחה)** | _epangelia_ / _havtahah_ | promesa, anuncio comprometedor | Base de la herencia dada antes de la Torah | Relación directa en el argumento, con matices entre lenguas. |
...
Gálatas 3:13-22 preserva dos verdades que no deben separarse: la herencia descansa en la promesa de Elohim y la Torah no es por eso despreciable. El Mesías redime, la promesa alcanza a las naciones y el Ruaj produce una vida capaz de caminar en obediencia; las obras no compran la herencia, pero la gracia tampoco es una invitación a permanecer sin fruto. La clase ofrece un lenguaje pastoral fuerte para distinguir mérito de obediencia, y el texto pide que cada explicación léxica, histórica y ontológica se mantenga en su nivel de evidencia.
...
- Video: [CARTA A LOS GÁLATAS | La TORAH dada por GRACIA | Capítulo 3 | #06 | Live](https://www.youtube.com/watch?v=wvW-2nLnKj8) (`source_id`: `youtube:wvW-2nLnKj8`).
