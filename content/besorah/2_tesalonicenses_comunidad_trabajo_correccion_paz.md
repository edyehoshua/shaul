...
Esta nota reúne las partes 6 y 7 del estudio de Eric de Jesús Rodríguez Mendoza sobre el capítulo 3. La primera recorre #2_tesalonicenses_3_1-13 y la segunda concluye con #2_tesalonicenses_3_12-18. Se conserva la secuencia de sus interpretaciones, pero se distingue entre lo que el pasaje afirma y las propuestas léxicas, históricas o de aplicación comunitaria del expositor.
...
En #2_tesalonicenses_3_6 Pablo ordena apartarse del hermano que camina desordenadamente y no según la tradición recibida. La clase destaca **(παράδοσις)** como transmisión o entrega recibida y la vincula con el anuncio apostólico. El texto no autoriza a tratar cualquier tradición humana como norma: en este caso se refiere a la enseñanza que los tesalonicenses recibieron de Pablo y sus colaboradores.

#2_tesalonicenses_3_7-9 explica el ejemplo: ellos no vivieron desordenadamente ni comieron el pan de nadie gratis, sino que trabajaron noche y día para no ser carga. Pablo aclara que no renunció al apoyo porque careciera de derecho, sino para ofrecer un modelo imitable. La clase aplica este patrón a una autoridad que debe ser verificable en su conducta; esa es una aplicación útil si no se transforma en una autorización para liderazgos sin rendición de cuentas.
...
#2_tesalonicenses_3_14 ordena tomar nota de quien no obedece la instrucción de la carta y no mezclarse con él, «para que se avergüence». El versículo siguiente establece el límite decisivo: «no lo tengáis por enemigo, sino amonestadle como a hermano» (#2_tesalonicenses_3_15). La finalidad textual de esta medida no es humillar ni expulsar arbitrariamente, sino una corrección que conserve la posibilidad de restauración fraterna.
...
- [[2_tesalonicenses_juicio_perseverancia_gloria|2 Tesalonicenses 1: perseverancia, juicio y gloria]]
