---
title: "Apocalipsis 15: copas, ira y justicia"
description: "La preparación y el derramamiento de las copas presentan el juicio como respuesta justa de Elohim; el esquema visionario no autoriza predicciones fechadas ni hostilidad contra personas."
date: 2026-07-27
tags:
  - apocalipsis
  - revelacion
...
Apocalipsis 15 presenta las siete copas como la preparación solemne de un juicio pleno, en continuidad con las plagas de Egipto, pero culmina primero en el cántico de quienes vencieron a la bestia. La enseñanza de Eric lee las imágenes como lenguaje simbólico contra las potestades y la apostasía; esta nota conserva esa observación y la contrasta con el orden textual, sin convertir sus correlaciones históricas o sus afirmaciones léxicas en hechos ya demostrados.

## Alcance de la nota

Esta nota reúne dos clases públicas del hermano Eric de Jesús Rodríguez Mendoza: un resumen de la arquitectura de Apocalipsis y una exposición que prepara el capítulo 16. La transcripción automática sirve para localizar argumentos, no se reproduce como cita literal. El capítulo 15 funciona como umbral: anuncia las plagas, muestra al remanente que venció y sitúa la salida de los siete mensajeros en el santuario celestial. Las conexiones con Egipto, las fiestas, las potestades antiguas y aplicaciones contemporáneas se presentan como lectura atribuida o como asuntos pendientes cuando exceden lo explícito del pasaje.
...
| --- | --- | --- | --- |
| **(מלאך)** / **(ἄγγελος)** | malakh / angelos | Mensajero; según el contexto puede referirse a un mensajero humano o celestial. En 15:6-7 designa a los siete portadores de las plagas. | La explicación amplia de Eric es una aclaración pedagógica; no prueba que aquí sean humanos ni elimina la lectura celestial. |
| **(קערה)** / **(φιάλη)** | qearah / phiale | Copa, recipiente o cuenco para contener y derramar. En 15:7 subraya la medida preparada del juicio. | Correspondencia aproximada entre el hebreo de Delitzsch y el griego; no debe confundirse con una copa litúrgica moderna por defecto. |
| **(חמה)** / **(θυμός)** | chemah / thymos | Ira, furor o indignación. En 15:7 califica el contenido de las copas. | El vínculo con el juicio es textual; las teorías de una «ira» como energía de una deidad particular quedan pendientes. |
| **(עדות)** | edut | Testimonio; en «tabernáculo del testimonio» señala la esfera del santuario abierto. | El valor contextual está respaldado por la frase; las identificaciones históricas del santuario requieren verificación. |
...
- [ ] Cotejar en el texto hebreo y griego la relación entre **(מלאך)**, **(ἄγγελος)** y «mensajero» en los pasajes usados por la clase.
- [ ] Verificar las conexiones exactas entre cada una de las siete copas y las plagas de Egipto; no asignar una deidad antigua a cada imagen sin fuentes.
- [ ] Examinar la relación entre las fiestas, la siega, la vendimia y Apocalipsis 14-16 antes de convertirla en una estructura calendárica establecida.
- [ ] Documentar las afirmaciones históricas sobre potestades, religiones antiguas, Israel y aplicaciones contemporáneas mencionadas durante la enseñanza.
- [ ] Cotejar si «todas las naciones vendrán» funciona aquí como horizonte futuro, promesa litúrgica o ambas cosas, sin fijar una fecha.

## Conclusión

Apocalipsis 15 dispone el escenario para el juicio: siete plagas anunciadas, vencedores que cantan, un santuario abierto y copas llenas de la ira de Elohim. Eric aporta una lectura concreta de continuidad con Egipto, símbolos de potestades y mensajeros como portadores de juicio. La nota conserva esas observaciones en el orden de la perícopa, pero deja que el texto distinga entre lo explícito, la analogía pedagógica y lo pendiente de investigar.

## Ver también

- [[apocalipsis_11_revelacion_testigos_reino_y_fidelidad|Apocalipsis 11: testigos, reino y fidelidad]]
- [[apocalipsis_13_revelacion_bestias_discernimiento_y_perseverancia|Apocalipsis 13: bestias, discernimiento y perseverancia]]

## Créditos

- Expositor: **hermano Eric de Jesús Rodríguez Mendoza**.
- Video: [Parte 24: Las 7 plagas postreras — resumen](https://www.youtube.com/watch?v=OlSFD4epPUA) (`source_id`: `youtube:OlSFD4epPUA`).
- Video: [Parte 25: Las 7 plagas postreras](https://www.youtube.com/watch?v=S-3xrfrhh_Q) (`source_id`: `youtube:S-3xrfrhh_Q`).
