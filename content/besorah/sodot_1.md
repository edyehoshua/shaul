...
- Referencias asociadas en esta nota: #joel_2_31 y #malaquias_4_5.
...
- Esta lectura se conecta con #salmos_2_12 y #isaias_26_20.
...
| -------------- | ----------- | -------------------- | ----------- | ---- | --------------------------- | -------------------------------------------- |
| Testigo        | **(עד)**    | ed                   | testigo     | —    | —                           | #isaias_55_4                              |
| Fiel           | **(נאמן)**  | neeman               | fiel        | אמן  | firmeza, fidelidad          | #deuteronomio_7_9                                 |
| Primogénito    | **(בכור)**  | bejor                | primogénito | בכר  | primacía, primer nacimiento | #salmos_16_10 #salmos_89_27 #salmos_88_11 |
| De los muertos | **(המתים)** | hametim              | los muertos | מות  | morir                       | #salmos_16_10 #salmos_89_27 #salmos_88_11 |
| Nos ama        | **(אהבנו)** | ohavenu              | nos ama     | אהב  | amar                        | #deuteronomio_23_6                                |

#### Observaciones

1. También se afirma que es soberano de los reyes de la tierra en relación con #salmos_2_8.
...
| --- | --- | --- | --- |
| Tanaj (TTH) | #joel_2_31, #malaquias_4_5 | Día de יהוה y envío de Eliyah antes del día grande | Pendiente de verificar (OE local) |
| Tanaj (TTH/OE) | #isaias_55_4, #deuteronomio_7_9, #salmos_16_10, #salmos_89_27 | Atributos: testigo, fiel, primogénito | Pendiente de verificar |
| Tanaj (TTH/OE) | #salmos_2_8 | Soberanía sobre reyes de la tierra | Pendiente de verificar |
| Besorah (TTH/Delitzsch) | #apocalipsis_1_1, #apocalipsis_1_5-6 | Texto base del apunte | Cotejado |

## Pendiente de verificar

- [ ] Conexión explícita entre #apocalipsis_1_7 y #daniel_7_13 en la argumentación de la nota.
- [ ] OE local para #joel_2_31 y #malaquias_4_5.
- [ ] Referencia exacta de #deuteronomio_23_6 en la tabla de atributos (posible desfase versicular).

## Ver también

- [Sodot 7](./sodot_7.md) — sellados y remanente de Israel.
- [Sodot intro](./sodot_intro.md) — marco general del libro.
- [Vaikra 16](../tanaj/vaikra_16.md) — yom hakipurim y día de יהוה.
- [Romanim 11](./romanim_11.md) — primicia y raíz santa (#romanos_11_16).
