...
description: "Nota canónica sobre Efesios 4: caminar dignamente, guardar la unidad del cuerpo, recibir dones para la madurez y abandonar la mentira, la ira y las pasiones de la vida antigua."
date: 2026-07-29
tags:
  - efesios
  - unidad
...
Efesios 4 convierte la revelación de los tres primeros capítulos en una forma de caminar. Pablo, prisionero por causa del Señor, llama a la comunidad a vivir de acuerdo con su llamado mediante humildad, mansedumbre, paciencia y soportarse en amor. La unidad no significa borrar toda diferencia: hay un solo cuerpo y un solo Espíritu, pero la gracia se distribuye a cada miembro para edificar a todos hasta la madurez. Esa madurez se reconoce en una vida que deja la vanidad, la mentira, el robo, la palabra corrupta, la amargura y la malicia, y que aprende verdad, trabajo, generosidad, edificación y perdón.
...
| Forma                | Transliteración | Sentido y contexto                                                                                | Equivalencia                                                                                                                     |
| -------------------- | --------------- | ------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------- |
| **(παρακαλέω)**      | parakaleō       | llamar al lado, exhortar, animar o rogar; en 4:1 introduce la apelación de Pablo                  | «Exhortar» es cercana; «invitar» recoge el tono que Eric propone, pero no agota el verbo.                                        |
| **(ἀξίως)**          | axiōs           | dignamente, de manera correspondiente al valor de algo; en 4:1 califica el caminar                | No significa perfección ni superioridad moral automática.                                                                        |
| **(ταπεινοφροσύνη)** | tapeinophrosynē | humildad o disposición de baja estima de sí; en 4:2 limita el orgullo                             | La relación pedagógica con **(ענוה)**, _anavah_, es aproximada, no una identidad textual.                                        |
| **(πραΰτης)**        | prautēs         | mansedumbre, fuerza moderada y no agresiva; acompaña a humildad y paciencia                       | No equivale a pasividad ante toda injusticia.                                                                                    |
| **(μακροθυμία)**     | makrothymia     | largura de ánimo, paciencia ante personas o provocaciones                                         | La explicación de Eric sobre «largura de ánimo» conserva el compuesto y su fuerza relacional.                                    |
| **(ἑνότης)**         | henotēs         | unidad; en 4:3 y 4:13 describe una unidad que se guarda y se alcanza en la fe                     | No significa uniformidad institucional ni una sola opinión sobre todo asunto.                                                    |
| **(κατάρτισμος)**    | katartismos     | equipamiento, preparación o puesta en condiciones; en 4:12 describe el propósito de los servicios | «Perfeccionar» puede ser demasiado estático; el contexto señala capacitación para servir.                                        |
| **(καταντάω)**       | katantaō        | llegar, alcanzar un punto; en 4:13 apunta a llegar juntos a la madurez                            | El verbo conserva movimiento comunitario, no una cumbre individual.                                                              |
| **(κυβεύω)**         | kybeuō          | jugar a los dados, exponerse a la inestabilidad; en 4:14 describe el engaño cambiante             | La imagen de inconstancia es directa; no autoriza sospecha contra todo maestro.                                                  |
| **(ἀλήθεια)**        | alētheia        | verdad, realidad manifestada y fidelidad al hablar; en 4:15 se dice en amor                       | La correspondencia con **(אמת)**, _emet_, es temática y aproximada.                                                              |
| **(ματαιότης)**      | mataiotēs       | vanidad, inutilidad o falta de propósito; en 4:17 califica el pensamiento gentil                  | Eric relaciona la palabra con lo que no produce; es una aplicación contextual, no una definición de toda actividad no religiosa. |
| **(ἀνανεόω)**        | ananeoō         | renovar, hacer nuevo otra vez; en 4:23 modifica el espíritu de la mente                           | No describe una técnica instantánea de autosugestión.                                                                            |
| **(κλέπτω)**         | kleptō          | robar; en 4:28 contrasta el viejo modo de obtener con trabajo y generosidad                       | La salida del robo incluye compartir, no solo dejar de tomar.                                                                    |
| **(σαπρός)**         | sapros          | podrido, inútil o corrupto; en 4:29 califica la palabra que daña                                  | La palabra edificante se mide por el efecto en quien escucha.                                                                    |
...
## Un llamado que se camina al lado (4:1-3)
...
Pablo pide que anden **ἀξίως**, _axiōs_, «dignamente» o «de manera correspondiente», de la vocación recibida. Eric insiste en que la excelencia no es una palabra decorativa y que debe preguntarse qué la concreta. La respuesta está en los versos siguientes: humildad, mansedumbre, paciencia, soportarse en amor y diligencia para guardar la unidad del Espíritu en el vínculo de la paz. No se trata de una excelencia de visibilidad o influencia. El texto mide el llamado por la forma en que la comunidad trata a otros.

La clase desarrolla la «largura de ánimo» como un componente de la excelencia. **μακροθυμία**, _makrothymia_, une la idea de largo con **θυμός**, ánimo, impulso o ira; en contexto describe paciencia ante personas, no una aceptación de toda enseñanza falsa. **πραΰτης**, _prautēs_, «mansedumbre», tampoco significa falta de convicción. El orden mantiene juntas firmeza y cuidado: la unidad se guarda con paz, pero la verdad no se abandona. La comparación con **(ענוה)**, _anavah_, humildad o mansedumbre, puede ayudar al lector semítico; es una analogía de campo semántico, no una equivalencia griega demostrada.

## Un cuerpo, una fe, una esperanza (4:4-6)
...
La aplicación de Eric a las divisiones contemporáneas debe conservarse como aplicación, no como borrado de todo desacuerdo. **ἑνότης**, _henotēs_, «unidad», aparece en 4:3 como algo que se guarda y en 4:13 como algo a lo que se llega. La unidad ya es un don que debe custodiarse y también una meta de madurez que requiere crecimiento. No equivale a que cada comunidad tenga idéntica organización ni a que toda diferencia sea indiferente a la verdad. La afirmación más segura es que ninguna facción puede usar su don para negar el cuerpo que el pasaje declara uno.
...
## Gracia medida para edificar, no para competir (4:7-16)
...
La cita sobre el que subió a lo alto y dio dones introduce una lectura del Salmo 68. Eric observa la diferencia entre «recibiste dones» del salmo y «dio dones» en Efesios, y la usa para destacar al Mesías como dador. La comparación es textual en la forma de la cita, pero el alcance de la relación entre ambos pasajes requiere seguir el argumento de Efesios. Lo seguro en 4:7 es que el don es gracia recibida y distribuida; no es propiedad que autorice a dominar al cuerpo.

Los servicios nombrados en 4:11 tienen una función explícita: equipar a los santos para la obra del servicio, para edificación del cuerpo del Mesías. **κατάρτισμος**, _katartismos_, «equipamiento o preparación», en 4:12 explica el propósito. La clase relaciona «plenitud» con **מלאים**, _miluim_, llenura o consagración, y propone que la comunidad se completa cuando cada miembro aporta su medida. El paralelo semítico es pedagógico; la sintaxis griega afirma que los santos son equipados, que el cuerpo es edificado y que todos avanzan hacia la madurez.

La meta no es dependencia infantil. **καταντήσωμεν**, _katantēsōmen_, «lleguemos», **ἄνδρα τέλειον**, _andra teleion_, «varón/persona madura», y **μέτρον ἡλικίας**, _metron hēlikias_, «medida de madurez», describen un proceso común. Eric critica que una sola voz pretenda abarcar la medida de todos; el texto confirma que la edificación es obra del cuerpo entero. En 4:14, Pablo contrasta la madurez con niños llevados por todo viento de enseñanza y por la astucia del engaño. La advertencia no autoriza a etiquetar a quien discrepa; llama a crecer en conocimiento, verdad y amor.
...
## La vida antigua: vanidad y discernimiento oscurecido (4:17-19)
...
En 4:18 aparece **ἐσκοτωμένοι**, _eskotōmenoi_, «habiendo sido oscurecidos», junto con **διάνοια**, _dianoia_, «entendimiento, pensamiento o discernimiento». Eric traduce la imagen como discernimiento o conciencia oscurecida y distingue entre no comprender naturalmente la perspectiva ajena y endurecerse ante la evidencia. Esa distinción ayuda pastoralmente, pero el texto añade causas concretas: alienación de la vida de Elohim por ignorancia y dureza de corazón. No permite diagnosticar la mente de otra persona desde una impresión privada.
...
## Aprender al Mesías y vestirse de la nueva humanidad (4:20-24)
...
**ἀνανεοῦσθαι**, _ananeousthai_, «ser renovados», es un infinitivo pasivo: la renovación se recibe y se sostiene, no se fabrica mediante una fórmula de autoafirmación. **πνεῦμα τοῦ νοός**, _pneuma tou noos_, «espíritu/disposición de la mente», no autoriza a reemplazar automáticamente «Rúaj» por «mente» en todos los textos. La clase puede relacionar Rúaj, pensamiento y formación; el contexto de Efesios 4 limita la relación a la renovación de la disposición mental.
...
## Verdad, ira, trabajo y palabra que edifica (4:25-32)
...
«Aírense y no pequen» coloca un límite a la ira, no una negación de toda reacción ante el mal. **παροργισμός**, _parorgismos_, provocación o irritación, y **δύω**, _dyō_, «ponerse» en la expresión «no se ponga el sol», forman una advertencia contra alojar la ira. «No den lugar al diablo» no convierte a toda disputa en una explicación demonológica: el texto muestra que la ira retenida abre un espacio destructivo dentro de la comunidad.

El ladrón debe dejar de robar, trabajar con sus manos en lo bueno y tener para compartir con quien tiene necesidad. Eric observa que la vida nueva no se define solo por abstenerse de tomar; cambia el propósito de los recursos. **κοπιάω**, _kopiaō_, «trabajar con fatiga», y **μεταδίδωμι**, _metadidōmi_, «compartir o impartir», sostienen esa progresión. La equivalencia con **(עבד)**, _avad_, trabajar o servir, puede orientar una comparación, pero no sustituye el griego.

La palabra corrupta debe ser reemplazada por la que edifica según la necesidad y da gracia a quienes escuchan. **σαπρός**, _sapros_, «podrido o inútil», no describe únicamente lenguaje vulgar; califica una palabra que corrompe o no sirve para edificar. Eric conecta habla, enseñanza y responsabilidad. El criterio textual es el bien del oyente, no la impresión de autoridad del hablante.

El cierre enumera amargura, enojo, ira, gritería, blasfemia y malicia, y los contrasta con bondad, compasión y perdón. **χαρίζεσθε**, _charizesthe_, «perdónense o concédanse gracia», se funda en que Elohim perdonó en el Mesías. **εὔσπλαγχνοι**, _eusplanchnoi_, «tiernos, compasivos», conserva la imagen de afecto profundo. La enseñanza de Eric sobre unidad recibe aquí su prueba final: el cuerpo uno no se guarda mediante control, sino por verdad, trabajo generoso, palabra que edifica y perdón.
...
Efesios 4 no yuxtapone una lista de virtudes y otra de prohibiciones. Primero, Pablo llama a caminar de manera correspondiente al llamado (4:1); luego define el modo de guardar la unidad (4:2-6); después explica cómo los dones equipan al cuerpo para crecer hacia la cabeza (4:7-16). Solo entonces contrasta el andar antiguo con el aprendizaje del Mesías (4:17-24) y muestra cómo la nueva humanidad habla, trabaja, controla la ira, edifica y perdona (4:25-32).

La forma verbal refuerza la dependencia. **περιπατῆσαι**, _peripatēsai_, «caminar», en 4:1 recibe como medida la vocación; **τηρεῖν**, _tērein_, «guardar», en 4:3 recibe como objeto la unidad del Espíritu; **καταρτισμόν**, _katartismon_, «equipamiento», en 4:12 da la finalidad de los servicios; y **αὐξήσει**, _auxēsei_, «hará crecer», en 4:16 atribuye el crecimiento al funcionamiento del cuerpo bajo la cabeza. La comunidad no produce unidad por propaganda ni madurez por la grandeza de un portavoz.

El cambio ético también es corporal. **ἀποθέσθαι**, _apothesthai_, «quitarse o despojarse», y **ἐνδύσασθαι**, _endysasthai_, «vestirse», en 4:22-24 forman la imagen de abandonar al viejo ser y recibir al nuevo. Luego **λαλεῖτε**, _laleite_, «hablen», **κλεπτών**, _kleptōn_, «robando», **ἐργαζόμενος**, _ergazomenos_, «trabajando», y **μεταδιδόναι**, _metadidonai_, «compartir», convierten la nueva identidad en hábitos verificables. La unidad confesada en 4:4-6 se prueba en la relación con el prójimo de 4:25.
...
## Control final: la madurez se verifica en la reparación del vínculo (4:25-32)
...
El mandato sobre la ira muestra que la madurez no consiste en negar toda reacción. **ὀργίζεσθε**, _orgizesthe_, «airarse», aparece junto a «no pequen», mientras **παροργισμός**, _parorgismos_, «irritación o provocación», y **τόπος**, _topos_, «lugar u oportunidad», advierten contra convertir una emoción en alojamiento permanente del resentimiento. Después, **μηκέτι κλεπτέτω**, _mēketi kleptetō_, «que ya no robe», no termina en abstención: **ἐργαζόμενος**, _ergazomenos_, «trabajando», y **μεταδιδόναι**, _metadidonai_, «compartir», reorientan el fruto hacia quien tiene necesidad. Eric presenta la libertad como una vida que deja de dañar; el orden textual la hace comprobable por reparación y generosidad.

El cierre lleva la prueba al habla y al perdón. **σαπρός**, _sapros_, «podrido, inútil o corrupto», califica la palabra según su capacidad de dañar, mientras **οἰκοδομή**, _oikodomē_, «edificación», mide la alternativa por el bien que comunica al oyente. **λυπεῖτε**, _lypeite_, «entristezcan», recuerda que el sello del Espíritu no es una licencia para conservar la malicia; **χαρίζεσθε**, _charizesthe_, «concédanse gracia o perdón», recibe su fuerza de que Elohim perdonó en el Mesías. La equivalencia con **(סלח)**, _salaj_, «perdonar», es comparativa, no una retroversión del griego. Así la unidad de 4:4-6 llega a su prueba concreta: verdad que protege al prójimo, trabajo que comparte, palabra que edifica y perdón que restaura.
...
- [ ] Verificar los usos paulinos de **παρακαλέω**, **κατάρτισμος** y **ἑνότης** antes de fijar una sola traducción doctrinal para cada forma.
- [ ] Estudiar la reconstrucción histórica que Eric propone sobre circulación de cartas y estructura comunitaria en Éfeso; el texto de 4:1-16 no describe por sí solo toda la organización.
- [ ] Cotejar la propuesta semítica sobre **יחוד**, **מלאים**, **ענוה** y **רוח** sin presentarla como retroversión original del griego.
...
La advertencia sobre el Espíritu confirma esa dependencia. **λυπεῖτε**, _lypeite_, «entristezcan», muestra que la conducta repetida puede contradecir el sello recibido; **σφραγίζω**, _sphragizō_, «sellar o marcar como perteneciente», señala identidad y pertenencia, no permiso para conservar amargura. Por eso **αἴρω**, _airō_, «quitar», y **χαρίζομαι**, _charizomai_, «conceder gracia o perdonar», llevan la unidad a acciones concretas: remover la malicia y perdonar como Elohim perdonó en el Mesías.
...
## Verificación dirigida: la unidad se prueba en el prójimo (4:25-32)
...
La cadena ética tampoco autoriza a confundir toda emoción con pecado. **ὀργίζεσθε**, _orgizesthe_, «airarse», aparece junto a «no pequen», mientras **παροργισμός**, _parorgismos_, «provocación o irritación», y **τόπος**, _topos_, «lugar u oportunidad», advierten contra alojar la ira y abrirle espacio al adversario. Después **κλεπτών**, _kleptōn_, «robando», contrasta con **ἐργαζόμενος**, _ergazomenos_, «trabajando», y **μεταδιδόναι**, _metadidonai_, «compartir». Eric acierta al presentar la vida nueva como cambio de propósito, no solo como abstención: Efesios exige que el trabajo termine en provisión para quien tiene necesidad.
...
## Reparación dirigida: una sola unidad, muchos servicios y una vida comprobable

La secuencia de Efesios 4 impide convertir la unidad en uniformidad o los dones en propiedad. **ἑνὶ δὲ ἑκάστῳ**, _heni de hekastō_, «pero a cada uno», sigue a la confesión de un solo cuerpo y muestra que la gracia distribuida no compite con la unidad. **καταρτίσαι**, _katartisai_, «preparar o equipar», y **οἰκοδομήν**, _oikodomēn_, «edificación», fijan el propósito de los servicios: capacitar a los santos para que el cuerpo crezca, no concentrar toda función en una voz. La comparación con **(אחד)**, _ejad_, «uno», es semítica y pedagógica, no una retroversión del griego.
...
## Verificación dirigida: madurez, verdad y reparación del vínculo (4:7-32)
...
La vida nueva se prueba en el prójimo porque el cuerpo ya ha sido definido como uno. **ἀποθέσθαι**, _apothesthai_, «quitarse o dejar a un lado», y **ἐνδύσασθαι**, _endysasthai_, «vestirse», marcan la transición; después **λαλεῖτε**, _laleite_, «hablen», dirige la verdad al prójimo, **μεταδιδόναι**, _metadidonai_, «compartir», da al trabajo un destino solidario, y **οἰκοδομή**, _oikodomē_, «edificación», regula la palabra. La comparación con **אמת**, _emet_, «verdad», y **בנה**, _banah_, «construir», es semítica y pedagógica; no sustituye las formas griegas ni convierte una intuición de Eric en una etimología.
