---
title: "Marcos 16: resurrección, envío y testimonio"
description: "Estudio canónico de Marcos 16: el sepulcro abierto, los testigos de la resurrección, la proclamación y el cierre público del Evangelio."
date: 2026-07-29
tags:
  - markos
  - markos_16
...
Marcos 16 comienza después del Shabat y termina con una noticia que obliga a la comunidad a responder: Yehoshua, el que fue colgado, se levantó y va delante de sus discípulos a Galil. El video de Eric identificado públicamente como «Cap 16 - FIN - El Domingo no es el día del Señor» aporta un foco explícito sobre la relación entre el cierre del capítulo y el primer día de la semana. Como la transcripción de esa fuente no estuvo disponible para este ciclo, no atribuyo a Eric una argumentación detallada; pruebo el título únicamente contra la secuencia del texto local y mantengo separadas resurrección, calendario y mandato misionero.
...
La piedra ya está girada. Dentro ven un joven vestido de blanco que les dice que buscan a Yehoshua Notzrí, el que fue colgado, y que él se levantó. **(ἠγέρθη)**, _ēgerthē_, es una forma pasiva de «levantar» o «despertar»; en el contexto de 16:6 anuncia que Yehoshua ha sido levantado de entre los muertos. No es exacto convertirla sin más en una consigna sobre un día semanal: la forma declara el acontecimiento, mientras el calendario aparece en el marco temporal de la visita.
...
## Apariciones, incredulidad y comisión (16:9-18)
...
La orden es ir a todo el _olam_ y proclamar la _Besorah_ a toda la creación. **(εὐαγγέλιον)**, _euangelion_, es buena noticia o anuncio favorable; la relación con _Besorah_ es una equivalencia de traducción heredada y útil, no una prueba de que cada uso tenga idéntico matiz semítico. **(κηρύξατε)**, _kēryxate_, es un imperativo plural: proclamen o anuncien públicamente. La comisión no se formula como veneración de un día, sino como proclamación a toda criatura.
...
## Recepción en los cielos y palabra anunciada (16:19-20)
...
El video de Eric pone el domingo en el título, pero Marcos 16:20 pone el peso final en anuncio, fortalecimiento y señales. La primera mención del día de la semana establece cuándo las mujeres fueron al sepulcro; no dice «el día del Señor». La nota conserva por ello la crítica del título como foco atribuible, no como una cita reconstruida. La cuestión doctrinal sobre calendarios requiere otros textos y no debe imponerse al orden de este capítulo.
...
| **(ὀψὲ σαββάτων)**     | _opse sabbatōn_    | después del Shabat; en 16:1 sitúa la visita posterior al reposo y no nombra una celebración semanal nueva.    | Traducción contextual exacta del marco temporal; no equivale a «día del Señor».                                                                                                                    |
| **(μιᾷ τῶν σαββάτων)** | _mia tōn sabbatōn_ | uno/primero de los Shabat; en 16:2 ubica el amanecer de la visita dentro de la cuenta narrativa del capítulo. | Aproximada como «primer día de la semana»; la frase por sí sola no establece una doctrina calendárica.                                                                                             |
...
| --------------- | ----------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------- |
| Marcos 16:1-8   | El título público de la clase afirma que el domingo no es «el día del Señor».                   | Foco atribuido por el título; el texto confirma solo que la visita ocurre después del Shabat y al amanecer del primer día. |
| Marcos 16:6-8   | La noticia central es que el que fue colgado se levantó y va delante de los discípulos a Galil. | Apoyo textual; **ἠγέρθη** y **προάγει** se explican por su forma y contexto.                                               |
| Marcos 16:9-14  | El anuncio de los testigos encuentra incredulidad y luego reprensión.                           | Apoyo textual; no se atribuyen a Eric detalles no disponibles de la transcripción.                                         |
...
La observación pública asociada con la clase de Eric debe probarse sin hacer que el calendario cargue con lo que el capítulo atribuye a la resurrección. Marcos comienza con **μετὰ τὸ σάββατον**, _meta to sabbaton_, «después del Shabat», y continúa con **λίαν πρωῒ τῇ μιᾷ τῶν σαββάτων**, _lian prōi tē mia tōn sabbatōn_, «muy temprano, el primero de los Shabat». **σάββατον**, _sabbaton_, puede designar el reposo o, según construcción, una cuenta semanal; en este pasaje el contexto temporal es seguro, pero no convierte la frase en el título «día del Señor». La comparación con **(שבת)**, _shabbat_, «cesar o reposar», es semítica y pedagógica, no una prueba de que Marcos esté formulando aquí una nueva legislación.

El centro de 16:6-7 es verbal y direccional. **ἠγέρθη**, _ēgerthē_, «fue levantado», es un pasivo narrativo que anuncia la acción recibida por Yehoshua; **ἴδε**, _ide_, «mira», llama a verificar el sepulcro; y **ὄψεσθε**, _opsesthe_, «verán», orienta a un encuentro prometido. **προάγει**, _proagei_, «va delante», no solo informa de una ubicación futura: presenta al resucitado como quien conduce a la comunidad. Así, el título del video puede conservarse como foco sobre el primer día, pero el argumento local impide que la discusión calendárica eclipse el acontecimiento, la palabra previa y el seguimiento.

El silencio temeroso de 16:8 y la proclamación de 16:15-20 forman una tensión que debe permanecer visible. **ἔκστασις**, _ekstasis_, «asombro, conmoción o sobrecogimiento», describe la reacción de las mujeres; no es una autorización para llamar a su temor una comisión completa ni para negar el mandato posterior. Desde 16:9, **ἀπήγγειλεν**, _apēngeilen_, «anunció», y **ἠπίστησαν**, _ēpistēsan_, «no creyeron», muestran que el testimonio es comunicado antes de ser aceptado. La comisión **πορευθέντες**, _poreuthentes_, «habiendo ido», junto con **κηρύξατε**, _kēryxate_, «proclamen», transforma el anuncio recibido en misión pública. La equivalencia con **(בשר)**, _basar_, «anunciar buenas noticias», ayuda a explicar _Besorah_, pero es aproximada y no reemplaza la sintaxis griega.
...
## Control del envío: el acontecimiento precede a la señal (16:6-20)
...
La comisión también tiene una secuencia que limita cualquier lectura de señales aisladas. **(πορευθέντες)**, _poreuthentes_, «habiendo ido» o «vayan», introduce el desplazamiento; **(κηρύξατε)**, _kēryxate_, «proclamen públicamente», define el acto central; y **(πιστεύσας)**, _pisteusas_, «el que cree o confía», nombra la respuesta al anuncio. Eric vincula la fe con una fidelidad que se muestra en obras; el orden textual sostiene una respuesta pública al mensaje, pero la equivalencia entre **(πίστις)**, _pistis_, y **(אמונה)**, _emunah_, es aproximada y no permite convertir cada señal en una prueba universal para todo tiempo.

El final vuelve a poner la autoridad fuera del mensajero humano. Los discípulos **(ἐκήρυξαν)**, _ekēryxan_, «proclamaron», mientras יהוה actuaba **(συνεργοῦντος)**, _synergountos_, «obrando juntamente», y confirmaba la palabra mediante señales. **(βεβαιόω)**, _bebaioō_, significa hacer firme, confirmar o garantizar; la forma no significa que el prodigio reemplace la proclamación. Así, la propuesta de Eric queda probada en su límite útil: cuestionar un título calendárico puede abrir una conversación, pero Marcos 16 dirige la comunidad hacia testimonio, obediencia y confirmación divina.

La relación con Marcos 15 es de continuidad narrativa y no de fusión de capítulos. Allí el cuerpo fue envuelto y puesto en un sepulcro antes del Shabat; aquí el sepulcro es revisado después del Shabat y el resucitado va delante de los discípulos. **(μνημεῖον)**, _mnēmeion_, «sepulcro o lugar de memoria», designa el sitio que ya no contiene al que buscan. La equivalencia con **(קבר)**, _kever_, «sepulcro», es contextual; el término no convierte la visita en una celebración del primer día. La secuencia segura es reposo concluido, sepulcro vacío, anuncio recibido y palabra enviada.

## Prueba de dependencia: memoria del sepulcro y autoridad del anuncio

Marcos 16 conecta la memoria corporal de Marcos 15 con una comisión pública, sin hacer del calendario la fuente de autoridad. **μνημεῖον**, _mnēmeion_, «sepulcro o lugar de memoria», y **λίθος**, _lithos_, «piedra», pertenecen a la escena verificable de 16:3-4; la piedra removida permite comprobar que el lugar ya no contiene a Yehoshua. El mensajero ordena **ἴδετε**, _idete_, «miren o vean», y luego anuncia **ἠγέρθη**, _ēgerthē_, «fue levantado». La relación con **(ראה)**, _raah_, «ver», y **(קום)**, _qum_, «levantarse», es semítica y aproximada: ayuda a comparar campos bíblicos, pero no sustituye la forma griega.

El anuncio recibe una dirección antes de convertirse en misión. **ὑπάγετε**, _hypagete_, «vayan», y **ἀπαγγείλατε**, _apangeilate_, «anuncien o informen», ordenan comunicar a los discípulos y a Kefa; **προάγει**, _proagei_, «va delante», mantiene la iniciativa en Yehoshua. El primer día de la semana aparece como marco de esa visita, no como fuente léxica del mandato. Por eso el foco público del video sobre «el día del Señor» puede conservarse como pregunta atribuible, mientras la evidencia segura de Marcos es que el resucitado precede a la comunidad y la llama a responder.

La segunda mitad transforma el testimonio en proclamación sin borrar la incredulidad inicial. **ἀπιστία**, _apistia_, «falta de confianza o incredulidad», describe el problema que Yehoshua reprende; **κηρύσσω**, _kēryssō_, «proclamar públicamente», nombra la tarea que encomienda. El participio **βαπτισθείς**, _baptistheis_, «habiendo sido sumergido», y **πιστεύσας**, _pisteusas_, «habiendo creído», presentan la respuesta al anuncio, no una señal autónoma. Finalmente **βεβαιόω**, _bebaioō_, «confirmar o hacer firme», explica que las señales acompañan la palabra. La equivalencia con **(אמונה)**, _emunah_, «confianza o fidelidad», es pedagógica y aproximada; la secuencia local mantiene el centro en anuncio, respuesta y confirmación.

## Control de lectura: del silencio al anuncio

Marcos 16:8 y 16:9 deben mantenerse como dos momentos consecutivos del texto recibido, no como una razón para borrar uno de ellos. **(ἔφυγον)**, _ephygon_, «huyeron», y **(εἶχεν αὐτὰς τρόμος)**, _eichen autas tromos_, «las tenía el temblor», describen la reacción de las mujeres ante el sepulcro abierto y el anuncio del joven. El texto añade que no dijeron nada a nadie porque tenían miedo; esa observación narra una reacción inmediata y no define por sí sola la misión posterior. La equivalencia de **(φόβος)**, _phobos_, con **(יראה)**, _yirah_, es contextual: ambos pueden expresar temor o reverencia, pero la forma griega gobierna aquí.

Desde 16:9 el capítulo vuelve a presentar testigos y respuestas. **(ἐφανερώθη)**, _ephanerōthē_, «se manifestó» o «apareció», es pasivo y señala una aparición recibida por Miriam; **(ἀπήγγειλεν)**, _apēngeilen_, «anunció» o «reportó», describe su comunicación a quienes estaban de duelo. La repetición del anuncio y la incredulidad de los discípulos preparan la reprensión de 16:14 y la comisión de 16:15. Por eso no es responsable usar el silencio de 16:8 para cancelar el envío del tramo siguiente, ni usar el envío para fingir que el miedo no aparece en la primera escena.
...
## Control añadido: el marco temporal no sustituye la comisión (16:1-20)
...
En 16:9-14, **ἐφανερώθη**, _ephanerōthē_, «se manifestó o apareció», y **ἠπίστησαν**, _ēpistēsan_, «no creyeron», mantienen la secuencia de testimonio recibido, incredulidad y reprensión. Después **κηρύξατε**, _kēryxate_, «proclamen», convierte el anuncio en comisión pública. En 16:19-20, **ἐκήρυξαν**, _ekēryxan_, «proclamaron», y **βεβαιοῦντος**, _bebaiountos_, «confirmando o haciendo firme», cierran con palabra anunciada y confirmada. La observación atribuible de Eric sobre no llamar al domingo «el día del Señor» queda, por tanto, respaldada solo en su límite textual: Marcos no usa ese título aquí; tampoco permite que la cuestión calendárica absorba el envío.

## Control de dependencia: sepulcro, testigos y palabra enviada
...
## Control ampliado: anuncio recibido, misión comunicada y palabra confirmada

El cierre largo conserva una cadena de autoridad que va del anuncio al testimonio y del testimonio a la confirmación. En 16:1-8, **(ἴδετε)**, _idete_, «miren o vean», no es una invitación a especular sobre el sepulcro: pide comprobar el lugar donde Yehoshua había sido puesto. **(ἀπαγγείλατε)**, _apangeilate_, «anuncien o informen», convierte esa comprobación en una responsabilidad hacia los discípulos y Kefa, mientras **(προάγει)**, _proagei_, «va delante», mantiene la iniciativa en el resucitado. La relación con **(ראה)**, _raah_, «ver», es una comparación semítica aproximada; no reemplaza la forma griega ni demuestra una retroversión.

En 16:9-14 la autoridad del anuncio se prueba precisamente por la resistencia que encuentra. **(ἀπήγγειλεν)**, _apēngeilen_, «anunció», describe la comunicación de Miriam; **(ἠπίστησαν)**, _ēpistēsan_, «no creyeron», muestra que el mensaje no se vuelve verdadero por la recepción humana; y **(ὠνείδισεν)**, _ōneidisen_, «reprendió», señala que Yehoshua corrige la incredulidad antes de enviar. Eric concentra la clase en la cuestión del día, pero el orden local obliga a mantener esta mediación de testigos, incredulidad y corrección.

La comisión de 16:15-18 tampoco entrega una autoridad autónoma al mensajero. **(πορευθέντες)**, _poreuthentes_, «habiendo ido» o «vayan», introduce el movimiento; **(κηρύξατε)**, _kēryxate_, «proclamen públicamente», define la tarea; y **(βαπτισθείς)**, _baptistheis_, «habiendo sido sumergido», describe una respuesta asociada al anuncio. **(πιστεύσας)**, _pisteusas_, «el que cree o confía», puede compararse de modo pedagógico con **(אמונה)**, _emunah_, pero no reduce la fe a una fórmula ni convierte las señales en espectáculo independiente.
...
## Control final: del día nombrado al testimonio confirmado

El título público de Eric cuestiona llamar al domingo «el día del Señor», pero el capítulo ofrece una prueba más estrecha. **διαγενομένου**, _diagenomenou_, «habiendo pasado», sitúa la llegada después del Shabat; **μιᾷ**, _mia_, «uno o primero», y **σαββάτων**, _sabbatōn_, «Shabat o cuenta semanal», forman el marco temporal de 16:1-2. Ninguna de estas formas funciona como un mandato de trasladar el reposo. La comparación con **(שבת)**, _shabbat_, «reposo o cesación», es contextual y no convierte la frase griega en un título litúrgico.
...
## Control de transmisión: de la piedra removida a la palabra confirmada (16:1-20)
...
El anuncio se apoya en una ausencia comprobable y en una dirección recibida. **ἀποκεκύλισται**, _apokekylistai_, «ha sido rodada fuera», describe la piedra ya retirada; **ἴδετε**, _idete_, «miren», llama a verificar el lugar; **ἠγέρθη**, _ēgerthē_, «fue levantado», interpreta la ausencia de Yehoshua; y **προάγει**, _proagei_, «va delante», mantiene la iniciativa en el resucitado. La comparación con **(קום)**, _qum_, «levantarse», ayuda a situar el campo bíblico, pero no demuestra una retroversión hebrea. El orden es decisivo: el día enmarca la visita, la piedra ofrece el signo, el mensajero interpreta y Yehoshua conduce el encuentro prometido.

La comisión conserva la misma dependencia. **ἀπαγγείλατε**, _apangeilate_, «anuncien o informen», envía a las mujeres hacia los discípulos y Kefa; **κηρύξατε**, _kēryxate_, «proclamen públicamente», extiende la tarea a toda la creación; y **ἐκήρυξαν**, _ekēryxan_, «proclamaron», muestra la salida efectiva. **πιστεύσας**, _pisteusas_, «el que cree o confía», y **βαπτισθείς**, _baptistheis_, «el que fue sumergido», describen la respuesta al anuncio dentro del texto recibido; no convierten las señales en autoridad autónoma. Finalmente, **συνεργοῦντος**, _synergountos_, «obrando juntamente», y **βεβαιοῦντος**, _bebaiountos_, «confirmando o haciendo firme», atribuyen a יהוה el acompañamiento y la confirmación de la palabra. Así, el foco calendárico queda reparado por la secuencia completa: reposo concluido, sepulcro comprobado, testimonio comunicado, incredulidad corregida, misión proclamada y palabra confirmada.

## Créditos

- Expositor: **hermano Eric de Jesús Rodríguez Mendoza**.
- Video: [Evangelio según Marcos — Parte 45: capítulo 16, final](https://www.youtube.com/watch?v=nddC-xoPguU) (`source_id`: `youtube:nddC-xoPguU`).
- Esta nota usa el foco del título público y lo contrasta con el corpus TTH local; no presenta una transcripción automática como cita literal.
