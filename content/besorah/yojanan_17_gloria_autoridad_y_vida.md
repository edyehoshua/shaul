...
El relato abre con una transición: Yehoshua ha dicho estas cosas, alza los ojos hacia lo alto y habla de «la hora» en #iojanan_17_1. La clase insiste en que la «hora» debe leerse como el momento en que se hace manifiesto lo anunciado, no solamente como una medida de sesenta minutos. Esa observación puede ser útil para investigar el uso joánico de **(ὥρα)**, pero el texto de este versículo no define por sí solo toda la carga conceptual que la exposición le atribuye.
...
El expositor lee Salmo 91 como un marco profético para la glorificación y el sacrificio, y propone una lectura con varios interlocutores en el salmo. Esa comparación puede orientar una investigación temática sobre protección, vida y vindicación; sin embargo, #iojanan_17_1-2 no cita explícitamente Salmo 91. Tampoco la clase aporta aquí una referencia textual suficiente para establecer que cada elemento del salmo describe directamente el pasaje joánico.

Conviene, por tanto, distinguir entre la comparación canónica propuesta y una alusión demostrable. La autoridad y la vida de #iojanan_17_2 pueden estudiarse junto al Salmo 91, pero la relación debe sostenerse mediante texto, contexto y fuentes verificables.
...
| **(ἐξουσία)**     | autoridad, dominio        | #iojanan_17_2 vincula la autoridad con dar vida; el alcance de «toda carne» requiere atención contextual.                 |
...
- #iojanan_16_32-33: la declaración de que Yehoshua no está solo y su palabra de paz preceden el paso al capítulo 17.
- #iojanan_17_1-2: hora, glorificación, autoridad y vida aparecen unidos en la apertura del capítulo.
- #iojanan_17_3: el versículo siguiente desarrolla qué llama el texto «vida olam»; se tratará con su fuente correspondiente.
...
- [ ] Revisar por qué el corpus TTH local omite #iojanan_17_1 antes de usar la ausencia como dato textual.
