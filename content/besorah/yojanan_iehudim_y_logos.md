...
Esta nota resume un transcript que propone dos claves de lectura para Yojanan. La primera es que **(יהודים)** en el evangelio no siempre debe oírse como un nombre indiferenciado de toda la nación, sino que con frecuencia carga un matiz geográfico, político o social ligado a Judea y a Ierushaláim. La segunda es que el prólogo de #iojanan_1_1-3 se presenta en la exposición como un choque deliberado con lecturas helenistas del logos, no como simple adopción de ellas.
...
- El apoyo inmediato para esa tesis es la forma local de #iojanan_1_1-2, donde la TTH traduce "era para Elohim", fórmula que el expositor lee en clave de pertenencia y no de simple compañía.
