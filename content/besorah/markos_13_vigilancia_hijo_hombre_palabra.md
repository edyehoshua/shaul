...
- Fuentes de Eric: *El Evangelio según Marcos — Parte 41: las 70 semanas ya se cumplieron* y, como conexión temática, *Parte 13: la divinidad de Mashíaj*, clases del **hermano Eric de Jesús Rodríguez Mendoza**. La nota organiza su exposición sin reproducir la transcripción automática como cita literal.
...
| Marcos 13:32-37 | Eric conserva el centro pastoral: el día y la hora no se entregan para el cálculo. La lectura de **(אָב)** (*av*, padre/origen) y **(אַבָּא)** (*abba*, padre) como palabra/fuente inamovible se presenta como desarrollo teológico, no como traducción suficiente del verso. | TTH y Delitzsch difieren sobre «ni el Hijo», pero ambas versiones terminan ordenando velar; Salmo 119:89-90 respalda la permanencia de la palabra y la fidelidad. | Centro directamente verificable; desarrollo semítico pendiente. |
| Relación con Lucas 21:20 | Eric identifica **(שִׁקּוּץ)** (*shiqquṣ*, cosa abominable) y su acción con la presencia gentil/romana que desola; advierte contra construir una escatología desconectada de la señal dada por Yehoshua. | Lucas 21:20 dice que Jerusalén rodeada de ejércitos anuncia su desolación; Marcos 13:14 mantiene la señal dentro del discurso. La etimología y la identificación de estandartes romanos requieren fuentes adicionales. | Conexión textual fuerte; detalles históricos pendientes. |
