---
title: "Apocalipsis 3: vigilancia, fidelidad y una puerta abierta"
description: "Los mensajes a Sardis, Filadelfia y Laodicea confrontan la apariencia sin vida, sostienen la fidelidad ante la prueba y llaman a una respuesta sincera al Mesías."
date: 2026-07-28
tags:
  - apocalipsis
  - revelacion
...
Apocalipsis 3 no ofrece una etiqueta histórica para tres comunidades aisladas, sino una secuencia de llamados que debe seguirse en el orden del capítulo: despertar de una vida sólo aparente, guardar la palabra con poca fuerza, y abandonar la autosuficiencia tibia para escuchar al Mesías. Eric lee estos mensajes como representaciones simbólicas cuyo centro es la fidelidad a la Escritura, el testimonio de Yehoshua y una vida que confirme lo que la boca confiesa. Esa lectura conserva observaciones concretas de sus clases, pero distingue el apoyo textual de las conexiones históricas, lingüísticas o doctrinales que requieren verificación.

## Alcance de la nota

Esta nota reúne las clases 9–12 de la serie de Eric de Jesús Rodríguez Mendoza sobre Apocalipsis 3. La transcripción automática sirve para localizar el desarrollo de la enseñanza y no se presenta como cita literal. La exposición se contrasta con el texto local de Delitzsch, conservando en español los argumentos atribuibles a Eric y marcando como inferencia aquello que el pasaje no afirma directamente.
...
| ----------- | --------------- | --------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------- |
| **(רוּחַ)** | _ruaj_          | Viento, aliento o espíritu; en 3:1 forma parte de las siete expresiones asociadas con Elohim. | La aplicación de Eric a “poder” puede ser pedagógica; no se debe imponer como único sentido léxico.                                           |
| **(ὄνομα)** | _onoma_         | Nombre, reputación o designación; en 3:1 la fama de vida queda enfrentada con la muerte real. | Apoyo contextual para hablar de reputación; no prueba por sí solo una teoría de nombres múltiples.                                            |
| **(ἀρχή)**  | _archē_         | Principio, comienzo, autoridad o fuente según el contexto; aparece en 3:14.                   | La lectura “origen/primacía” es una interpretación plausible; la afirmación “no significa primer creado” requiere cotejo contextual completo. |
| **(אָמֵן)** | _amen_          | Fórmula de afirmación y firmeza; 3:14 la conecta con el testigo fiel y verdadero.             | Aproximación funcional útil; no equivale sin resto a toda la semántica de **(אמן)**.                                                          |
| **(עֵד)**   | _ed_            | Testigo; el texto local usa **(הָעֵד הַנֶּאֱמָן)**, “el testigo fiel”.                        | Apoyo textual para el énfasis de Eric en fidelidad y testimonio.                                                                              |

## Mapa de la enseñanza de Eric

| Punto concreto tomado de Eric                                                                                                                                             | Versículos o perícopa                                      | Cómo se evaluó en esta nota                                                                                                                                                                                          |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Sardis representa una vida de apariencia: tiene nombre de viva, pero sus obras y su vigilancia revelan otra condición.                                                    | Apocalipsis 3:1-6                                          | **Apoyo textual y aplicación calificada**: la fama, la muerte, las obras incompletas y el llamado a recordar y volver están explícitos; la extensión a toda comunidad contemporánea es aplicación.                   |
| La fidelidad se reconoce por estudiar y guardar la Escritura, no sólo por declarar que se cree; Filadelfia conserva poca fuerza pero no niega el nombre.                  | Apocalipsis 3:7-13                                         | **Apoyo textual parcial**: guardar la palabra, perseverar y no negar el nombre aparecen en el pasaje; la identificación de esa palabra con un programa completo de estudio de Torá es desarrollo pedagógico de Eric. |
| La expresión “mi Dios” no debe leerse como prueba simple de que Yehoshua sea una criatura subordinada; los términos divinos requieren atención a sus lenguas y contextos. | Apocalipsis 3:12; clase sobre 3:12-13                      | **Aclaración lexical y pendiente histórica**: se conserva la preocupación de Eric y se distinguen Elohim y Alaha, pero no se presenta una sola traducción como solución exhaustiva del debate.                       |
| “Amén” y “principio de la creación” describen fidelidad y primacía/origen, no necesariamente un primer ser creado.                                                        | Apocalipsis 3:14; Salmo 89:27-38 como conexión de la clase | **Inferencia calificada**: el contexto inmediato permite relacionar amén con testigo fiel; la lectura de _archē_ y el vínculo completo con Salmo 89 requieren cotejo griego-hebreo.                                  |
| Laodicea exhibe autosuficiencia religiosa, mientras Yehoshua llama a una respuesta que produzca fruto, comunión y perseverancia.                                          | Apocalipsis 3:14-22                                        | **Apoyo textual**: riqueza, ceguera, reprensión amorosa, puerta, mesa y trono siguen el orden del capítulo; las aplicaciones a líderes o movimientos actuales quedan sin convertir en hechos históricos.             |

## Pendiente de verificar

- [ ] Cotejar en el griego de Apocalipsis 3:12-14 los valores de **(θεός)**, **(ἀρχή)** y **(ἀμήν)** junto con sus antecedentes semíticos, sin afirmar equivalencias perfectas.
- [ ] Verificar las afirmaciones históricas de la clase sobre Sardis, Filadelfia, Laodicea, “judíos” y la llamada doctrina de Balaam o de Jezabel; esta nota no las presenta como datos comprobados.
- [ ] Revisar la relación propuesta por Eric entre Apocalipsis 3:14 y Salmo 89:27-38 en los textos hebreo y griego, incluyendo el sentido de primogénito y testigo.
- [ ] Distinguir la aplicación pastoral de la enseñanza —confesión, obras y estudio— de una identificación exhaustiva de las comunidades simbólicas con grupos actuales.

## Conclusión

Apocalipsis 3 conduce al lector desde el despertar de Sardis hasta la puerta abierta de Filadelfia y la mesa ofrecida a Laodicea. La enseñanza de Eric insiste en que el nombre, la doctrina y la confesión deben mostrar una vida guardada y fiel. El texto respalda el llamado a velar, perseverar, escuchar y vencer; las propuestas sobre cronología, historia y equivalencias lingüísticas deben seguir marcadas como inferencias o pendientes. El resultado no es una cobertura de cada frase pronunciada en las cuatro clases, sino un registro trazable de los argumentos concretos incorporados y de su evaluación.
...
- [Parte 9: El mensaje a Sardis](https://www.youtube.com/watch?v=QsVyKoYFghg) (`source_id`: `youtube:QsVyKoYFghg`).
- [Parte 10: El mensaje a Filadelfia](https://www.youtube.com/watch?v=VzUpWkv8BCQ) (`source_id`: `youtube:VzUpWkv8BCQ`).
- [Parte 11: Cómo entender “mi Dios” en 3:12](https://www.youtube.com/watch?v=baKHb9CzU7Q) (`source_id`: `youtube:baKHb9CzU7Q`).
- [Parte 12: El mensaje a Laodicea](https://www.youtube.com/watch?v=lr8Oyu-2mhA) (`source_id`: `youtube:lr8Oyu-2mhA`).
