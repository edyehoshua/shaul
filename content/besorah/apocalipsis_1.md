---
title: "Apocalipsis 1: Lo que debe suceder en breve"
description: "Apuntes sobre Apocalipsis 1:1 y 1:5-6 en torno a la brevedad del tiempo y los atributos confesados del Mesías"
date: 2025-12-20
tags:
  - apocalipsis
  - yom_yhvh
...
- Esta lectura se conecta con #tehilim_2_12 y #yeshayahu_26_20.
...
| -------------- | ----------- | -------------------- | ----------- | ---- | --------------------------- | -------------------------------------------- |
| Testigo        | **(עד)**    | ed                   | testigo     | —    | —                           | #yeshayahu_55_4                              |
...
| --- | --- | --- | --- |
| Tanaj (TTH) | #yoel_2_31, #malaji_4_5 | Día de יהוה y envío de Eliyah antes del día grande | Pendiente de verificar (OE local) |
| Tanaj (TTH/OE) | #yeshayahu_55_4, #devarim_7_9, #tehilim_16_10, #tehilim_89_27 | Atributos: testigo, fiel, primogénito | Pendiente de verificar |
| Tanaj (TTH/OE) | #tehilim_2_8 | Soberanía sobre reyes de la tierra | Pendiente de verificar |
...
- [Sodot 7](./apocalipsis_7.md) — sellados y remanente de Israel.
- [Sodot intro](./apocalipsis_intro.md) — marco general del libro.
- [Vaikra 16](../tanaj/vayikra_16.md) — yom hakipurim y día de יהוה.
- [Romanim 11](./romanos_11.md) — primicia y raíz santa (#romanos_11_16).
