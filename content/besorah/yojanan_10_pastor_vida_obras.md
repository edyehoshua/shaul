---
title: "Yojanán 10: el pastor, la vida y las obras"
description: "Panorama canónico de Yojanán 10: la puerta, el pastor, la entrega de la vida, Janucá, las obras y el testimonio."
date: 2026-07-26
tags:
  - yojanan
  - yojanan_10
...
| Forma fuente | Transliteración | Sentido normal           | Fuerza contextual en Yojanán 10                                                                                                                       | Relación con la lectura de Eric                                                                                       |
| ------------ | --------------- | ------------------------ | ----------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------- |
| **(θύρα)**   | thyra           | puerta                   | En 10:7-9 nombra el acceso al rebaño y el lugar por el que la oveja entra, sale y encuentra pasto.                                                    | Correspondencia exacta con «puerta»; la aplicación al liderazgo sectario es pedagógica, no una definición léxica.     |
| **(ποιμήν)** | poimēn          | pastor                   | En 10:11-16 describe al que conoce, protege y pone su vida por las ovejas, en contraste con el asalariado.                                            | Correspondencia exacta con «pastor»; la aplicación a dirigentes actuales es una inferencia pastoral.                  |
| **(ψυχή)**   | psychē          | vida, alma, ser viviente | En 10:11, 15, 17-18 es la vida que el buen pastor pone y vuelve a tomar; el contexto destaca acción voluntaria, no una definición abstracta del alma. | Relación aproximada y pedagógica con **(נפש)**; no son identidades léxicas automáticas.                               |
| **(ἐντολή)** | entolē          | mandamiento, encargo     | En 10:18 comunica la instrucción recibida del Padre dentro de la autoridad para poner y retomar la vida.                                              | «Mandamiento» es exacto en el pasaje; «competencia» es una interpretación atribuible pendiente, no el sentido normal. |
| **(ἀκούω)**  | akouō           | oír, escuchar            | En 10:3, 16, 27 la escucha de la voz del pastor distingue a las ovejas y precede al seguimiento.                                                      | Correspondencia exacta con «escuchar»; la formación de emunah a partir del oír es una conexión canónica cualificada.  |
| **(ἕν)**     | hen             | uno, una sola cosa       | En 10:30 aparece en «Yo y el Padre uno somos»; la forma neutra requiere leer la frase completa y no resolver por sí sola toda la teología.            | Correspondencia exacta con «uno»; las conclusiones doctrinales posteriores son inferencias, no glosas léxicas.        |
