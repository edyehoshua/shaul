---
title: "Apocalipsis 9: trompetas, ay y llamado"
description: "Las trompetas intensifican una advertencia sobre el mal y la falta de arrepentimiento; su lenguaje visionario exige una lectura atenta a la secuencia literaria."
date: 2026-07-28
tags:
  - apocalipsis
  - revelacion
...
Apocalipsis 9 presenta el quinto y el sexto toque como dos ayes encadenados: primero, una aflicción limitada sobre quienes no tienen el sello de Elohim; después, una mortandad descrita con imágenes de juicio. La nota conserva el énfasis de la clase de Eric en las trompetas 5, 6 y 7 y comprueba cada movimiento contra el orden del capítulo; el desenlace textual no es una cronología moderna, sino la persistencia de la idolatría, el homicidio, la hechicería, la inmoralidad y el robo sin arrepentimiento.

## Alcance de la nota

Esta nota canónica organiza la enseñanza del **hermano Eric de Jesús Rodríguez Mendoza** sobre Apocalipsis 9. El título público de la clase identifica las trompetas 5, 6 y 7; las observaciones atribuidas abajo se limitan a los énfasis que la nota puede rastrear al pasaje. La transcripción automática sirve para localizar la exposición y no se presenta como cita literal. Las identificaciones históricas de las figuras y cualquier calendario profético que vaya más allá del capítulo quedan pendientes de verificar.
...
| Forma | Transliteración | Sentido y fuerza | Tipo de relación |
| --- | --- | --- | --- |
| **(σάλπιγξ)** | _salpinx_ | trompeta, señal sonora que marca el movimiento de la visión | Aproximación funcional; no define por sí sola el calendario. |
...
- [ ] Cotejar las identificaciones históricas y militares propuestas para el Éufrates, los jinetes y las cifras con fuentes primarias y la historia de interpretación.
- [ ] Verificar las alusiones del capítulo a Tanaj antes de afirmar que una imagen es una cita directa.
- [ ] Examinar en léxicos griegos y hebreos el alcance de Abadón, Apolión, sello y arrepentimiento; las relaciones anteriores son aproximaciones contextuales.

## Conclusión

Apocalipsis 9 avanza del tormento restringido a la muerte extensa y termina mostrando que el juicio, por sí solo, no produce arrepentimiento. La enseñanza de Eric ayuda a seguir los tres ayes en su orden; el texto local obliga a conservar los límites de cada imagen y a no convertir inferencias proféticas en hechos comprobados.
...
- Video: [Parte 19: Las trompetas 5, 6 y 7](https://www.youtube.com/watch?v=u7-1n3mFap4) (`source_id`: `youtube:u7-1n3mFap4`).
