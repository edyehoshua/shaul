...
El texto llama a Caná «comienzo de sus señales» (#iojanan_2_11). Por eso la nota no reduce la escena a la cantidad de vino ni usa el relato para derivar una regla general sobre bodas. El resultado que el versículo expresa es la manifestación de gloria y la afirmación de los discípulos.

La clase atiende al contraste narrativo entre la petición por falta de vino y la valoración final del maestresala: el vino guardado «hasta ahora» es bueno (#iojanan_2_3-10). Eric propone leer ese contraste como una figura pedagógica del Mesías, sin separarlo en dos mesías rivales. Esa es una lectura teológica de la clase, no una glosa explícita del narrador; el ancla verificable de la nota sigue siendo que la señal manifiesta gloria y produce una respuesta de los discípulos.
...
- [ ] Verificar de forma independiente la aplicación de #ieshaiahu_11_3 al discernimiento que la clase asocia con #iojanan_2_23-25.
