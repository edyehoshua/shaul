---
title: "Yojanán 19: madero, rey y testimonio"
description: "Estudio canónico de Yojanán 19:1-30 sobre la flagelación, la corona, el madero, la túnica y la entrega consciente de Yehoshua."
date: 2026-07-30
tags:
  - yojanan
  - yojanan_19
...
references:
  ...
  - "#iojanan_19_23-30"
sources:
  - "https://www.youtube.com/watch?v=v4yv8dpfnqo"
source_ids:
  - "youtube:v4yv8dpfnqo"
...
Yojanán 19:1-30 no presenta la cruz como un accidente sin interpretación: el gobernador entrega a Yehoshua después de un juicio que lo declara sin causa, mientras la corona, el manto, el título y la Escritura siguen diciendo que el acusado es Rey. La primera clase de Eric sobre el capítulo observa la humillación pública, la realeza que Pilatos no puede borrar y la obediencia con que Yehoshua sale al lugar del madero. Esta nota conserva esas observaciones en prosa atribuible y las prueba con el texto local, sin convertir cada detalle de la clase en una afirmación del evangelista.
...
| ----------------- | ------------------------------------------------------------------- | ----------------------------------------------------------------- |
| #iojanan_19_1-7   | «וַיִּקַּח פִּילָטוֹס אֶת־יֵשׁוּעַ וַיַּלְקֵהוּ»; «הִנֵּה הָאִישׁ»  | El inocente aparece golpeado y vestido como rey.                  |
| #iojanan_19_8-16  | «לֹא־הָיָה לִי שִׁלְטוֹן»; «הִנֵּה מַלְכְּכֶם»                      | La autoridad de Pilatos queda limitada y la entrega se formaliza. |
...
**(τελέω)** (_teleo_) significa terminar, completar o llevar a cabo; **τετέλεσται** (_tetelestai_) es «está cumplido». La fuerza contextual es la conclusión de la obra y del cumplimiento narrado, no una explicación automática de cada doctrina posterior. **(παραδίδωμι)** (_paradidomi_) significa entregar o poner en manos de otro; «entregó su espíritu» es una traducción cercana, y la lectura de entrega voluntaria es una inferencia narrativa apoyada por el orden, no una definición aislada del verbo.

## Mapa de la enseñanza de Eric

| Perícopa          | Observación concreta de la clase                                                               | Tratamiento contra el texto local                                                                     |
| ----------------- | ---------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------- |
| #iojanan_19_1-7   | La burla de los soldados conserva irónicamente la realeza de Yehoshua.                         | Apoyo textual: corona, manto, saludo y «he aquí el hombre» aparecen juntos.                           |
| #iojanan_19_8-16  | Pilatos ejerce poder limitado y la entrega revela una realeza que el tribunal no puede anular. | Apoyo textual y calificación: «de arriba» limita la autoridad; la responsabilidad política permanece. |
| #iojanan_19_17-22 | El Rey carga el madero y el título se publica en varias lenguas.                               | Apoyo textual; la relación entre madera y árbol queda como conexión intertextual aproximada.          |
| #iojanan_19_23-30 | Vestiduras, sed y «está cumplido» muestran cuidado, Escritura y entrega consciente.            | Apoyo textual; la voluntariedad es inferencia narrativa controlada.                                   |

## Hoja léxica

| Forma fuente     | Transliteración | Sentido normal                        | Fuerza contextual                                    | Relación                                           |
| ---------------- | --------------- | ------------------------------------- | ---------------------------------------------------- | -------------------------------------------------- |
| **(βασιλεύς)**   | _basileus_      | rey                                   | Título disputado y proclamado                        | Aproximada con **(מלך)**                           |
| **(στέφανος)**   | _stephanos_     | corona, guirnalda                     | Corona de espinas en una escena regia                | Directa en la glosa; aplicación irónica contextual |
| **(σταυρός)**    | _stauros_       | poste, cruz, instrumento de ejecución | Madero que Yehoshua carga y donde es ejecutado       | Aproximada con **(עץ)**                            |
| **(τελέω)**      | _teleo_         | completar, terminar                   | «Está cumplido» al cierre de la escena               | Directa; la teología amplia es inferencial         |
| **(παραδίδωμι)** | _paradidomi_    | entregar, poner en manos              | Entrega del espíritu y del acusado según el contexto | Contextual y aproximada                            |

## Pendiente de verificar

- [ ] Cotejar la práctica romana de flagelación y los títulos trilingües con fuentes históricas independientes.
- [ ] Verificar los paralelos de Tehilim 22 sin convertir la cita de 19:24 en una alegoría exhaustiva.
- [ ] Estudiar la relación entre **(עץ)**, madero y los paralelos apostólicos como conexión intertextual.

## Conclusión

La primera mitad de Yojanán 19 muestra una paradoja controlada por el relato: soldados, gobernador y acusadores humillan a Yehoshua, pero cada gesto vuelve a poner delante su realeza. La corona, el título escrito, el madero cargado y la palabra final no borran la violencia; la interpretan como una entrega que el poder administra sin dominar su sentido. La clase de Eric hace visible esa tensión y el texto local fija sus límites.

## Ver también

- [[yojanan_18_estudio_canonico_kidron_huerto_y_juicio|Yojanán 18: Kidrón, huerto, copa y juicio]]
- [[yojanan_19_muerte_sepultura_y_testimonio|Yojanán 19: muerte, sepultura y testimonio]]

## Créditos

- Expositor: **hermano Eric de Jesús Rodríguez Mendoza**.
- Video: [El Evangelio Según Yojanán/Juan Parte 71 Cap 19](https://www.youtube.com/watch?v=v4yv8dpfnqo) (`source_id`: `youtube:v4yv8dpfnqo`).
