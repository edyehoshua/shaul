---
title: "Janukáh: casa, asamblea y formación en la verdad"
description: "Estudio canónico sobre Juan 10:22, la dedicación, la casa de Elohim y la formación perseverante de una comunidad que discierne y obedece."
date: 2026-07-29
tags:
  - janukah
  - dedicacion
...
references:
  ...
  - "#1_timoteo_3_15"
sources:
  - "https://www.youtube.com/watch?v=qzr_u89uzUk"
  - "docs/scriptures/delitzsch/json/john.json"
  - "docs/scriptures/tth/json/tehilim.json"
  - "docs/scriptures/delitzsch/json/timothy2.json"
  - "docs/scriptures/delitzsch/json/timothy1.json"
source_ids:
  - "youtube:qzr_u89uzUk"
...
La exposición pública de Eric de Jesús Rodríguez Mendoza presenta Janukáh como una ocasión para recordar la dedicación de la casa, pero también como una escuela: la comunidad debe ser formada, afirmada y capacitada para distinguir la verdad. Juan 10:22 sitúa a Yehoshua en la fiesta de la dedicación durante el invierno; el texto no convierte esa mención en una orden universal de celebrar la fiesta, pero sí ofrece un marco canónico para preguntar qué significa dedicar una casa y escuchar al Pastor. La observación de Eric recibe apoyo textual cualificado cuando conecta templo, educación y conciencia: la Escritura afirma formación mediante la palabra y la asamblea, aunque no identifica automáticamente un edificio con la presencia de Elohim.

## Alcance y mapa de la enseñanza

En `youtube:qzr_u89uzUk`, Eric explica aproximadamente entre 00:00:48 y 00:02:43 que la «fiesta de la dedicación» de Juan 10:22 recuerda la renovación o puesta en servicio de algo que había sido profanado. Después, entre 00:06:30 y 00:08:18, describe el templo como centro de consulta, aprendizaje y formación de la conciencia. Relaciona esa función con el crecimiento de Yehoshua en el templo y con 2 Timoteo 3:16-17, y aplica el proceso educativo a una obediencia que se vuelve práctica mediante constancia. Esta nota conserva esas observaciones como paráfrasis atribuible, no como cita literal, y las evalúa siguiendo las perícopas en orden.
...
| ------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------- |
| Juan 10:22; `youtube:qzr_u89uzUk` (00:00:48–00:02:43)              | Eric explica la dedicación como renovación o puesta en servicio, no como un nombre vacío.               | Apoyo textual directo para la fiesta; la aplicación a toda celebración posterior es aproximada.                               |
...
1 Timoteo 3:15 llama a la comunidad «casa de Elohim» y «columna y baluarte de la verdad». **(στῦλος)**, _stylos_, significa columna o soporte, y **(ἑδραίωμα)**, _hedraiōma_, significa fundamento, sostén o apoyo firme. Sus glosas son **directas**; su fuerza contextual es comunitaria y pública. No autorizan a una asamblea a declararse infalible: la comunidad sostiene y manifiesta la verdad recibida, bajo el testimonio apostólico y el Mesías.

## Evaluación y conclusión

Eric acierta al tratar la dedicación como llamado a renovar el servicio y a formar la conciencia mediante la palabra. Romanos 12:2 y Efesios 4:20-24 confirman canónicamente que la renovación debe producir discernimiento y vida nueva. La calificación necesaria es textual: Juan 10 centra la dedicación en la identidad y voz del Mesías; Salmo 30 centra la casa en la gratitud por el rescate; las cartas pastorales centran la formación en la Escritura y la conducta de la comunidad. La casa puede ser dedicada, pero la asamblea debe seguir siendo formada.
...
- [Janukáh (2017): La casa, la asamblea, pilar y baluarte de la verdad](https://www.youtube.com/watch?v=qzr_u89uzUk) (`source_id`: `youtube:qzr_u89uzUk`).
