---
title: "Israel no reemplazado: un pueblo y un olivo"
description: "Estudio de la enseñanza que contrasta la teología del reemplazo con la elección de Israel, la incorporación de las naciones y la advertencia del olivo"
date: 2026-08-04
tags:
  - israel
  - naciones
  - teologia_del_reemplazo
  - olivo
  - tora
references:
  - "#exodo_3_10"
...
La clase rechaza que la congregación de las naciones haya sustituido a Israel. Su propuesta es continuidad con transformación: יהוה mantiene su palabra acerca de Israel, acerca en el Mesías a quienes estaban lejos y reúne a ambos en un solo pueblo. La imagen decisiva no es la de una institución nueva que ocupa el lugar de otra, sino la de ramas sostenidas por una misma raíz; por eso la incorporación de las naciones exige gratitud, fidelidad y temor, nunca jactancia contra las ramas naturales.

## Alcance de la nota

Esta nota organiza las dos partes de la clase «Teología del reemplazo». Sigue su argumento textual desde la elección de Israel hasta la unidad de Efesios 2 y la advertencia de Romanos 11. Las observaciones se atribuyen a la enseñanza de Eric y se cotejan con OE, TTH y Delitzsch locales. Las afirmaciones históricas y algunas propuestas léxicas que la transcripción no documenta con una referencia verificable quedan expresamente pendientes; no se presentan como citas literales de la transcripción automática.
...
| Forma            | Transliteración | Sentido normal            | Fuerza contextual en la nota                                                                             | Relación                                                                                                     |
| ---------------- | --------------- | ------------------------- | -------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------ |
| **(ישראל)**      | Israel          | Israel, nombre del pueblo | Sujeto de la elección en Shemot y Devarim; comunidad de la cual las naciones estaban alejadas en Efesios | Exacta en los textos citados                                                                                 |
| **(גוים)**       | goyim           | naciones, pueblos         | La clase lo aplica a quienes son acercados desde fuera y a las ramas de acebuche                         | Aproximada respecto de «gentiles»                                                                            |
| **(קהל)**        | qahal           | asamblea, congregación    | Eric lo usa para cuestionar una ruptura conceptual rígida entre «asamblea» e «iglesia»                   | Pedagógica; requiere cotejo terminológico completo                                                           |
| **(אמונה)**      | emunah          | firmeza, fidelidad        | TTH la conserva en Romanos 11:20, 23; estar en pie no da lugar a arrogancia                              | Aproximada respecto de «fe»                                                                                  |
| **(חסד)**        | jesed           | bondad leal, favor        | La clase insiste en que la bondad de יהוה no comienza en los escritos apostólicos                        | Aproximada respecto de «gracia»                                                                              |
...
| Unidad y ruta                                                                         | Observación concreta de la clase                                                                                       | Tratamiento en la nota                                                                                            |
| ------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------- |
| Shemot 3:10; Devarim 7:6 — parte 1, 00:08:07-00:22:07                                 | Israel es llamado pueblo de יהוה y escogido entre los pueblos; elección no equivale a superioridad de sangre.          | Apoyo textual local y calificación de la imagen pedagógica del nacimiento nacional.                               |
| Efesios 2:12-14; Gálatas 6:15-16 — parte 1, 00:22:15-00:27:45                         | Los antes excluidos son acercados; de judío y gentil el Mesías hace uno, no un pueblo gentil separado.                 | Apoyo textual para acercamiento y unidad; inferencia sintáctica sobre «Israel de Elohim» expresamente calificada. |
| Hoshea 2:23 — parte 1, 00:32:43-00:37:32                                              | «No mi pueblo» vuelve a ser llamado «pueblo mío» por acción de Elohim.                                                 | Texto OE/TTH cotejado, incluida la diferencia de numeración; condiciones ampliadas distinguidas del verso exacto. |
| Marción, gnosticismo y Filón — parte 1, 00:39:22-00:43:14; parte 2, 00:11:37-00:29:37 | La ruptura con Israel se presenta como fruto de una larga desidentificación de la Escritura hebrea.                    | Contexto atribuible conservado; cadena histórica pendiente por falta de referencias primarias en la clase.        |
| Romanos 11:17-24 — parte 2, 00:32:05-00:36:10                                         | El acebuche participa de la raíz, no debe jactarse y las ramas naturales pueden volver.                                | Apoyo textual TTH; aclaración léxica de **ἐγκεντρίζω** y reserva sobre «plantar» frente a «injertar».             |
| Conclusión — parte 2, 00:36:10-00:40:32                                               | Un solo pueblo es reunido en el Mesías; el retorno se orienta al corazón del Mesías, no meramente a un Estado moderno. | Síntesis atribuida sin convertir la dispersión de todas las naciones en una genealogía demostrada.                |

## Referencias históricas y fuentes externas

| Fuente mencionada                 | Referencia disponible                           | Uso en la clase                                                                 | Estado                 |
| --------------------------------- | ----------------------------------------------- | ------------------------------------------------------------------------------- | ---------------------- |
| Marción                           | Sin obra o pasaje preciso en la transcripción   | Contraste entre el Elohim del Tanaj y el de los escritos apostólicos            | Pendiente de verificar |
| Tertuliano                        | Refutación de Marción, sin libro/pasaje preciso | Testimonio de que Marción fue rechazado incluso por autores cristianos antiguos | Pendiente de verificar |
| Filón de Alejandría               | Sin obra o pasaje preciso                       | Alegoría, filosofía griega y concepto de logos como antecedentes                | Pendiente de verificar |
| Clemente de Alejandría y Orígenes | Sin obra o pasaje preciso                       | Recepción cristiana de Filón                                                    | Pendiente de verificar |
| Talmud / tradición rabínica       | Sin tratado, daf o pasaje preciso               | Expresión de Israel como «ombligo del mundo» y valoración posterior de Filón    | Pendiente de verificar |
| Concilio de Nicea                 | Sin canon o acta precisa                        | Parte de la cadena institucional señalada por la clase                          | Pendiente de verificar |

## Pendiente de verificar

- [ ] Localizar obras y pasajes exactos de Marción o de sus refutadores que documenten la oposición entre el dios del Tanaj y el de los escritos apostólicos.
- [ ] Verificar en fuentes primarias la recepción de Filón por Clemente de Alejandría y Orígenes, incluida la cifra de citas mencionada en la clase.
- [ ] Identificar la referencia talmúdica exacta de la expresión «ombligo del mundo» y comprobar si se aplica a Israel, a Yerushaláyim o al santuario.
- [ ] Cotejar **(ἐγκεντρίζω)** en Romanos 11 con un léxico crítico y explicar por qué TTH prefiere «plantar».
- [ ] Desarrollar por separado la relación propuesta entre Efraim, las tribus dispersas y la plenitud de las naciones; estas dos clases la afirman, pero no recorren todos los textos necesarios.
- [ ] Verificar la cronología y las conexiones históricas propuestas entre gnosticismo, religiones orientales, cábala, Filón y los concilios.

## Conclusión

Las dos clases sostienen su crítica del reemplazo con una secuencia reconocible: יהוה llama y escoge a Israel; el Mesías acerca a quienes estaban fuera y hace de los dos uno; Hoshea anuncia que «no mi pueblo» vuelve a ser llamado «pueblo mío»; y Romanos prohíbe que las ramas incorporadas se exalten contra las naturales. El resultado no es un permiso para despreciar a las naciones ni para idealizar una genealogía, sino una comunidad reunida en el Mesías bajo la fidelidad de יהוה. Allí la pertenencia recibida produce responsabilidad y humildad: la rama vive de la raíz, no la reemplaza.

## Ver también

- [Elohim emet: unidad, fidelidad y vida](elohim_emet_unidad_fidelidad_y_vida)
- [Purim: pueblo uno, memoria y responsabilidad](purim_pueblo_uno_memoria_y_responsabilidad)
- [Sukot: llamado de las naciones](sukot_levitico_22_numeros_29_llamado_de_las_naciones)
- [El Shemá: oír, amar y guardar la palabra](shema_oír_amar_y_guardar_la_palabra)

## Créditos

- Expositor: **hermano Eric de Jesús Rodríguez Mendoza**.
- Video: [DOCTRINES OF HA-SATAN | REPLACEMENT THEOLOGY - PART 1 | #02 | Live](https://www.youtube.com/watch?v=jAmhhsLJil8) (`source_id`: `youtube:jAmhhsLJil8`).
- Video: [DOCTRINAS DE HA'SATÁN | TEOLOGÍA del REEMPLAZO - PARTE 2 | #03 | Live](https://www.youtube.com/watch?v=iDuvm4VTAJg) (`source_id`: `youtube:iDuvm4VTAJg`).
