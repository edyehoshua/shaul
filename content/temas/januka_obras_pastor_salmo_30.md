---
title: "Janucá: obras, voz del pastor y la enseñanza de la casa"
description: "Lectura de Iojanán 10:22-39 y Tehilim 30 a partir de una enseñanza de Eric de Jesús Rodríguez Mendoza para distinguir memoria, testimonio y gratitud."
date: 2026-07-27
tags:
  - januca
  - iojanan
...
Janucá sitúa Iojanán 10 dentro de una memoria de dedicación, pero la respuesta de Yehoshua no descansa en una conmemoración ni en una consigna pública: sus obras, su voz y la permanencia de sus ovejas son el testimonio que el pasaje ofrece. La lectura final de Tehilim 30 lleva esa memoria a la casa que canta: quien ha sido levantado por יהוה no convierte la liberación en autosuficiencia, sino en gratitud y confesión.

## Alcance de la nota

Esta nota organiza la clase **Despedida de Janukáh (2018) Análisis de Jn 10:22ss y lectura del Himno 30**. Eric lee Iojanán 10:22-39 en el marco de Janucá y concluye con Tehilim 30, cuyo encabezado menciona la dedicación de la casa. Se conservan sus observaciones concretas sobre las obras, las ovejas y el canto; cuando la clase propone etimologías, reconstrucciones amplias sobre Israel o inferencias doctrinales que exceden el versículo, la nota las distingue de lo que el texto dice directamente. La transcripción automática no se usa como cita literal.

## Hoja de comparación

| Referencia        | Texto local                                                                                                                                                                                               | Función en el desarrollo                                                                |
| ----------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------- |
| #iojanan_10_22-25 | **TTH:** «Y era Janucá en Ierushaláim, y era invierno… Si Tú eres el Mesías, dínoslo con confianza… las obras que Yo hago en nombre de mi Padre, estas testifican acerca de Mí».                          | La fiesta es el escenario; las obras responden a la exigencia de una declaración.       |
| #iojanan_10_27-30 | **Delitzsch:** צאני שמעות את קולי ואני יודע אתן והנה הלכות אחרי׃ וחיי עולם אתן להן לא תאבדנה לנצח ולא יחטף אתן איש מידי׃ אבי אשר נתנן לי אדיר הוא מכל ואין איש אשר יוכל לחטף אתהן מיד האב׃ ואני והאב אחד׃ | Voz, conocimiento, seguimiento y seguridad aparecen antes de la afirmación de unidad.   |
| #iojanan_10_32-38 | **TTH:** «Muchas buenas obras les he dado a conocer de mi Padre… Si no hago las obras de mi Padre, no se afirmen por Mí; pero si las hago… afírmense por las obras».                                      | Yehoshua dirige a sus oyentes al carácter verificable de sus obras y cita la Escritura. |
...
Los vv. 34-36 introducen la cita «ustedes son elohim» y el argumento sobre aquellos a quienes vino la palabra de Elohim. Eric la relaciona con portadores de la palabra en Israel. La cita existe y el razonamiento de Yehoshua explícitamente insiste en que la Escritura no puede ser anulada; pero una explicación completa de Tehilim 82 exige estudiar su propio contexto. Por eso esta nota no reduce el pasaje a una definición general de cada profeta ni usa el v. 34 para decidir una doctrina sin la argumentación completa de Iojanán 10.

## Tehilim 30: la dedicación que termina en gratitud

Al concluir, Eric lee Tehilim 30 como «cántico de dedicación de la casa» y aplica la casa a una comunidad que aprende a alabar. El encabezado local sí contiene **(חנכת)**, dedicación, junto con **(הבית)**, la casa. La conexión con Janucá es lingüística y pedagógica: ambos términos pertenecen al campo de dedicar. No es necesario afirmar que el salmo fuera compuesto para la fiesta posterior; el título del salmo nombra la dedicación de una casa, mientras Iojanán sitúa la conversación en Janucá.
...
| ----------- | --------------- | ------------------------ | ----------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| **(חנכת)**  | janukat         | dedicación               | חנך         | El título de Tehilim 30 habla de dedicación de la casa. Su relación con Janucá es léxica y pedagógica; no prueba por sí sola una identificación histórica exacta.        |
| **(הבית)**  | habáyit         | la casa                  | בית         | En el salmo designa «la casa» del título. Aplicarla directamente a una congregación es una extensión homilética, no una equivalencia automática.                         |
| **(צאני)**  | tsoní           | mis ovejas               | צאן         | Delitzsch emplea la imagen pastoral de Iojanán 10:27; el seguimiento forma parte de la descripción, junto a oír y ser conocido.                                          |
| **(מעשים)** | maasim          | obras, hechos realizados | עשה         | En Iojanán 10:32 y 37-38 las obras son el testimonio al que Yehoshua remite. La clase las aproxima a promesas realizadas; esa relación debe cotejarse pasaje por pasaje. |
| **(רנה)**   | riná            | grito de júbilo          | רנן         | En Tehilim 30:6 contrasta con el llanto nocturno; no promete una cronología simple para todo sufrimiento.                                                                |

## Mapa de la enseñanza de Eric

| Unidad textual      | Observación concreta de la clase                                                                                                 | Tratamiento en esta nota                                                                                                                      |
| ------------------- | -------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------- |
| #iojanan_10_22-25   | Janucá ya era una conmemoración conocida y la pregunta por el Mesías recibe como respuesta las obras hechas en nombre del Padre. | Apoyo textual: se mantiene el marco de la fiesta y se explica que el v. 25 remite a obras, no solo a una declaración pública.                 |
| #iojanan_10_27-30   | Las ovejas oyen, son conocidas, siguen, reciben vida y no son arrebatadas; Eric une esto a la acción del Padre.                  | Apoyo textual y matiz: se conserva la secuencia de escuchar-seguir antes de la seguridad, y la inferencia se limita a lo que el texto afirma. |
| #iojanan_10_32-38   | Las obras son «créditos» visibles de la identidad de Yehoshua y muestran que el Padre está en él.                                | Apoyo textual: se desarrolla la apelación explícita a las obras y se reserva el estudio de Tehilim 82 para su contexto.                       |
...
- [ ] Cotejar el uso histórico y litúrgico de Tehilim 30 en Janucá con una fuente judía identificable antes de presentarlo como práctica antigua establecida.
- [ ] Estudiar Tehilim 82 completo antes de ampliar la explicación de #iojanan_10_34-36.
- [ ] Verificar de forma independiente las propuestas etimológicas de la clase sobre Israel y sus conexiones amplias con «semilla»; no se usan como base de esta nota.

## Conexiones principales

- #iojanan_10_22-25 con #iojanan_10_37-38: la identidad se discierne en la coherencia entre palabra y obras.
- #iojanan_10_27-29 con #tehilim_30_8-9: la seguridad se describe dentro de una relación de dependencia, escucha y clamor.
- #tehilim_30_12-13 con #iojanan_10_32: la obra reconocida de יהוה conduce a un testimonio agradecido.

## Ver también

- [[../besorah/yojanan_10_janukah_senales_mesias|Janucá y las señales del Mesías]]
- [[../besorah/yojanan_10_pastor_vida_obras|El pastor, la vida y las obras en Iojanán 10]]
- [[janukah|Janucá]]

## Créditos

- Expositor: **hermano Eric de Jesús Rodríguez Mendoza**.
- Video: [Despedida de Janukáh (2018) Análisis de Jn 10:22ss y lectura del Himno 30](https://www.youtube.com/watch?v=7uBEYFbUy2A) (`source_id`: `youtube:7uBEYFbUy2A`).
