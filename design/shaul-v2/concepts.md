...
| --: | ------------------- | -------------------------------------------- | --------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
|   1 | `ben-hadam`         | Ben-Hadam / Hijo del Hombre                  | Identidad del Mesías  | `content/besorah/marcos_ben_adam_metamorfosis_glosario.md`; `content/besorah/juan_9_ben_adam_y_el_ciego.md`; `content/temas/ben_hijo_titulos_mesias.md`               |
|   2 | `palabra`           | La Palabra que crea, revela y permanece      | Revelación            | `content/besorah/marcos_palabra_trono_semilla_identidad.md`; `content/besorah/juan_introduccion.md`                                                                  |
|   3 | `hijo-elohim`       | Hijo de Elohim y herencia                    | Identidad y filiación | `content/besorah/marcos_hijo_elohim_hijo_hombre_herencia.md`; `content/temas/ben_hijo_titulos_mesias.md`                                                                |
|   4 | `abba`              | Abá: fuente, envío y obediencia              | Relación con Elohim   | `content/temas/elohim_aba.md`; `content/besorah/marcos_abba_ruaj_mente_mashiaj.md`; `content/besorah/juan_oracion_dos_tronos_emunah.md`                               |
...
|   8 | `reino`             | Reino, autoridad y servicio                  | Gobierno              | `content/besorah/marcos_10_pacto_reino_riqueza_servicio_camino.md`; `content/besorah/juan_17_gloria_autoridad_y_vida.md`                                             |
|   9 | `vida`              | Vida que vence la muerte                     | Vida                  | `content/besorah/juan_5_hijo_juicio_vida.md`; `content/besorah/romanos_8_vida_en_el_Ruaj_filiacion_sufrimiento_esperanza.md`                                         |
|  10 | `luz`               | Luz, testimonio y discernimiento             | Testimonio            | `content/besorah/juan_8_luz_testimonio_y_abraham.md`; `content/besorah/efesios_5_amor_luz_y_sabiduria.md`                                                            |
|  11 | `pan-de-vida`       | Pan, sustento y palabras de vida             | Provisión             | `content/besorah/juan_6_pan_de_vida_y_palabras_de_vida.md`; `content/besorah/juan_6_pan_vida_senales.md`                                                          |
|  12 | `agua-viva`         | Agua viva, purificación y adoración          | Renovación            | `content/besorah/juan_4_estudio_canonico_agua_viva_adoracion_y_confianza.md`; `content/besorah/juan_7_sucot_agua_y_discernimiento.md`                             |
|  13 | `morada`            | Morada, presencia y regreso                  | Presencia             | `content/besorah/juan_14_moradas_camino_retorno.md`; `content/besorah/juan_14_morada_palabra_memoria.md`                                                          |
|  14 | `puerta`            | La puerta, el acceso y el cuidado            | Comunidad             | `content/besorah/juan_10_puerta_pastor_abba.md`; `content/besorah/juan_9_10_ceguera_puerta_ovejas.md`                                                             |
|  15 | `pastor`            | Pastor, ovejas y cuidado del rebaño          | Comunidad             | `content/temas/pastor_ovejas_discernimiento_y_cuidado_del_rebano.md`; `content/besorah/juan_10_pastor_vida_obras.md`                                                 |
|  16 | `ovejas`            | Escucha, reconocimiento y seguimiento        | Discipulado           | `content/besorah/juan_10_emunah_obras_ovejas.md`; `content/temas/pastor_ovejas_discernimiento_y_cuidado_del_rebano.md`                                               |
...
|  21 | `semilla`           | Semilla, palabra e identidad                 | Crecimiento           | `content/besorah/marcos_palabra_trono_semilla_identidad.md`; `content/besorah/marcos_4_palabra_tormenta_fidelidad.md`                                                   |
|  22 | `fruto`             | Fruto, permanencia y obediencia              | Formación             | `content/besorah/juan_15_vid_fruto_amor_discipulado.md`; `content/besorah/colosenses_3_vida_renovada_amor_y_servicio.md`                                             |
|  23 | `poda`              | Poda, corrección y permanencia               | Madurez               | `content/besorah/juan_15_vid_labrador_poda_permanecer.md`; `content/besorah/hebreos_12_disciplina_santidad_y_monte_tziyon.md`                                        |
...
|  25 | `pesaj`             | Pésaj, memoria, liberación y mesa            | Fiestas               | `content/temas/pesaj_memoria_liberacion_y_mesa.md`; `content/besorah/juan_13_pesaj_seuda_lavado_pies.md`                                                             |
|  26 | `shabat`            | Shabat, reposo y límites de la obra          | Fiestas               | `content/temas/shabat.md`; `content/besorah/juan_5_bet_jesda_shabat.md`                                                                                              |
|  27 | `sukot`             | Sucot, morada, cosecha y gozo                | Fiestas               | `content/temas/sukot_habitar_gozo_y_memoria.md`; `content/besorah/juan_7_sucot_agua_y_discernimiento.md`                                                             |
...
|  29 | `janukah`           | Janukah, dedicación y memoria                | Fiestas               | `content/temas/janukah.md`; `content/besorah/juan_10_janukah_senales_mesias.md`                                                                                      |
|  30 | `nombre`            | Nombre, autoridad y salvación                | Identidad             | `content/temas/nombre_de_יהוה_escritura_pronunciacion_y_fidelidad.md`; `content/temas/nombre_salvacion_sacerdocio_mesias.md`; `content/besorah/juan_14_abba_menajem_nombre.md` |
|  31 | `shema`             | Escuchar, amar y guardar                     | Obediencia            | `content/temas/cantos_hebreos_shema_memoria_y_discernimiento.md`; `content/besorah/marcos_12_shema_senor_david_vida_entregada.md`                                       |
...
|  33 | `justicia`          | Justicia, misericordia y fidelidad           | Ética                 | `content/tanaj/mijah_6_justicia_bondad_y_caminar.md`; `content/besorah/romanos_12_culto_vivo_dones_amor_practico.md`                                                    |
|  34 | `emunah`            | Emunah: don de Elohim, el único neeman       | Discipulado           | `content/besorah/juan_oracion_dos_tronos_emunah.md`; `content/tanaj/devarim_7_recordar_pacto_y_dependencia.md`; `content/tanaj/devarim_32_haazinu_roca_fidelidad.md` |
...
|  36 | `testimonio`        | Testimonio, palabra y perseverancia          | Misión                | `content/besorah/apocalipsis_1_revelacion_mensaje_testimonio_y_esperanza.md`; `content/besorah/juan_1_testigo_cordero.md`                                            |
...
|  42 | `trono`             | Trono, adoración y autoridad                 | Reino                 | `content/besorah/apocalipsis_4_trono_redencion_y_adoracion.md`; `content/besorah/juan_17_gloria_autoridad_y_vida.md`                                                 |
...
|  45 | `oracion`           | Oración, vigilancia y confianza              | Comunión              | `content/besorah/juan_oracion_dos_tronos_emunah.md`; `content/besorah/efesios_6_firmeza_oracion_y_servicio.md`                                                       |
|  46 | `camino`            | Camino, seguimiento y retorno                | Discipulado           | `content/besorah/juan_12_camino_hora_luz_palabra.md`; `content/besorah/juan_14_moradas_camino_retorno.md`                                                         |
|  47 | `madero`            | Entrega, juicio y testimonio                 | Redención             | `content/besorah/juan_19_madero_costado_y_testimonio.md`; `content/besorah/marcos_15_juicio_cruz_velo_confesion.md`                                                  |
|  48 | `resurreccion`      | Resurrección, vida y envío                   | Esperanza             | `content/besorah/juan_11_eleazar_resurreccion_vida.md`; `content/besorah/marcos_16_resurreccion_envio_y_testimonio.md`                                               |
...
|  50 | `permanecer`        | Permanecer en la palabra y dar fruto         | Perseverancia         | `content/besorah/juan_8_permanecer_en_la_palabra_y_ser_libres.md`; `content/besorah/juan_15_vid_fruto_amor_discipulado.md`                                        |
