...
|   4 | `abba`              | Abba: relación, envío y obediencia           | Relación con Elohim   | `content/besorah/markos_abba_ruaj_mente_mashiaj.md`; `content/temas/elohim_aba.md`                                                                                      |
...
|  34 | `emunah`            | Emunah como confianza, fidelidad y obra      | Discipulado           | `content/besorah/hebreos_11_emunah_testimonio_y_esperanza.md`; `content/besorah/galatim_2_gracia_unidad_y_verdad_del_evangelio.md`                                      |
